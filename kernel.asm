...
80100046:	e8 f9 3b 00 00       	call   80103c44 <acquire>
...
8010007c:	e8 28 3c 00 00       	call   80103ca9 <release>
      acquiresleep(&b->lock);
80100081:	8d 43 0c             	lea    0xc(%ebx),%eax
80100084:	89 04 24             	mov    %eax,(%esp)
80100087:	e8 a4 39 00 00       	call   80103a30 <acquiresleep>
      return b;
...
801000ca:	e8 da 3b 00 00       	call   80103ca9 <release>
      acquiresleep(&b->lock);
801000cf:	8d 43 0c             	lea    0xc(%ebx),%eax
801000d2:	89 04 24             	mov    %eax,(%esp)
801000d5:	e8 56 39 00 00       	call   80103a30 <acquiresleep>
      return b;
...
80100105:	e8 fe 39 00 00       	call   80103b08 <initlock>
...
80100143:	e8 b5 38 00 00       	call   801039fd <initsleeplock>
...
801001a8:	e8 0d 39 00 00       	call   80103aba <holdingsleep>
...
801001e4:	e8 d1 38 00 00       	call   80103aba <holdingsleep>
...
801001f4:	e8 86 38 00 00       	call   80103a7f <releasesleep>

  acquire(&bcache.lock);
801001f9:	c7 04 24 c0 a5 10 80 	movl   $0x8010a5c0,(%esp)
80100200:	e8 3f 3a 00 00       	call   80103c44 <acquire>
  b->refcnt--;
...
8010024c:	e8 58 3a 00 00       	call   80103ca9 <release>
}
...
8010028a:	e8 b5 39 00 00       	call   80103c44 <acquire>
  while(n > 0){
...
801002d1:	e8 d3 39 00 00       	call   80103ca9 <release>
        ilock(ip);
...
80100331:	e8 73 39 00 00       	call   80103ca9 <release>
  ilock(ip);
...
8010038f:	e8 8f 37 00 00       	call   80103b23 <getcallerpcs>
  for(i=0; i<10; i++)
...
801004ba:	e8 ac 38 00 00       	call   80103d6b <memmove>
    pos -= 80;
...
801004d9:	e8 12 38 00 00       	call   80103cf0 <memset>
...
80100506:	e8 19 4c 00 00       	call   80105124 <uartputc>
...
8010051f:	e8 00 4c 00 00       	call   80105124 <uartputc>
80100524:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
8010052b:	e8 f4 4b 00 00       	call   80105124 <uartputc>
80100530:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
80100537:	e8 e8 4b 00 00       	call   80105124 <uartputc>
...
801005ca:	e8 75 36 00 00       	call   80103c44 <acquire>
  for(i = 0; i < n; i++)
...
801005f1:	e8 b3 36 00 00       	call   80103ca9 <release>
  ilock(ip);
...
80100638:	e8 07 36 00 00       	call   80103c44 <acquire>
...
80100734:	e8 70 35 00 00       	call   80103ca9 <release>
...
8010074f:	e8 f0 34 00 00       	call   80103c44 <acquire>
  while((c = getc()) >= 0){
...
801007de:	e8 5b 30 00 00       	call   8010383e <wakeup>
...
80100873:	e8 31 34 00 00       	call   80103ca9 <release>
  if(doprocdump) {
...
80100887:	e8 bf 30 00 00       	call   8010394b <procdump>
}
...
8010089e:	e8 65 32 00 00       	call   80103b08 <initlock>
...
80100970:	75 b2                	jne    80100924 <exec+0x52>
  if((pgdir = setupkvm()) == 0)
80100972:	e8 6d 59 00 00       	call   801062e4 <setupkvm>
...
80100a06:	e8 7f 57 00 00       	call   8010618a <allocuvm>
...
80100a38:	e8 1b 56 00 00       	call   80106058 <loaduvm>
...
80100a74:	e8 11 57 00 00       	call   8010618a <allocuvm>
...
80100a9d:	e8 d2 57 00 00       	call   80106274 <freevm>
...
80100abc:	e8 a8 58 00 00       	call   80106369 <clearpteu>
...
80100ae2:	e8 ab 33 00 00       	call   80103e92 <strlen>
...
80100af4:	e8 99 33 00 00       	call   80103e92 <strlen>
80100af9:	83 c0 01             	add    $0x1,%eax
80100afc:	50                   	push   %eax
80100afd:	ff 36                	pushl  (%esi)
80100aff:	57                   	push   %edi
80100b00:	ff b5 ec fe ff ff    	pushl  -0x114(%ebp)
80100b06:	e8 ac 59 00 00       	call   801064b7 <copyout>
...
80100b66:	e8 4c 59 00 00       	call   801064b7 <copyout>
...
80100ba3:	e8 af 32 00 00       	call   80103e57 <safestrcpy>
...
80100bd1:	e8 01 53 00 00       	call   80105ed7 <switchuvm>
  freevm(oldpgdir);
80100bd6:	89 1c 24             	mov    %ebx,(%esp)
80100bd9:	e8 96 56 00 00       	call   80106274 <freevm>
  return 0;
...
80100c23:	e8 e0 2e 00 00       	call   80103b08 <initlock>
}
...
80100c39:	e8 06 30 00 00       	call   80103c44 <acquire>
...
80100c68:	e8 3c 30 00 00       	call   80103ca9 <release>
      return f;
...
80100c7f:	e8 25 30 00 00       	call   80103ca9 <release>
  return 0;
...
80100c9d:	e8 a2 2f 00 00       	call   80103c44 <acquire>
  if(f->ref < 1)
...
80100cba:	e8 ea 2f 00 00       	call   80103ca9 <release>
  return f;
}
...
80100ce2:	e8 5d 2f 00 00       	call   80103c44 <acquire>
  if(f->ref < 1)
...
80100d03:	e8 a1 2f 00 00       	call   80103ca9 <release>
    return;
...
80100d49:	e8 5b 2f 00 00       	call   80103ca9 <release>
  if(ff.type == FD_PIPE)
...
80100f8a:	e8 dc 2d 00 00       	call   80103d6b <memmove>
...
80100f9a:	e8 cc 2d 00 00       	call   80103d6b <memmove>
    name[len] = 0;
...
80100fdf:	e8 0c 2d 00 00       	call   80103cf0 <memset>
  log_write(bp);
...
8010119a:	e8 a5 2a 00 00       	call   80103c44 <acquire>
...
801011e1:	e8 c3 2a 00 00       	call   80103ca9 <release>
      return ip;
...
80101217:	e8 8d 2a 00 00       	call   80103ca9 <release>
  return ip;
...
80101255:	e8 11 2b 00 00       	call   80103d6b <memmove>
  brelse(bp);
...
801012fd:	e8 06 28 00 00       	call   80103b08 <initlock>
  for(i = 0; i < NINODE; i++) {
...
80101322:	e8 d6 26 00 00       	call   801039fd <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801013f1:	e8 fa 28 00 00       	call   80103cf0 <memset>
      dip->type = type;
...
80101480:	e8 e6 28 00 00       	call   80103d6b <memmove>
  log_write(bp);
...
80101560:	e8 df 26 00 00       	call   80103c44 <acquire>
  ip->ref++;
...
80101575:	e8 2f 27 00 00       	call   80103ca9 <release>
}
...
8010159a:	e8 91 24 00 00       	call   80103a30 <acquiresleep>
  if(ip->valid == 0){
...
80101614:	e8 52 27 00 00       	call   80103d6b <memmove>
    brelse(bp);
...
80101656:	e8 5f 24 00 00       	call   80103aba <holdingsleep>
...
8010166c:	e8 0e 24 00 00       	call   80103a7f <releasesleep>
}
...
80101698:	e8 93 23 00 00       	call   80103a30 <acquiresleep>
...
801016b1:	e8 c9 23 00 00       	call   80103a7f <releasesleep>
  acquire(&icache.lock);
801016b6:	c7 04 24 e0 f9 10 80 	movl   $0x8010f9e0,(%esp)
801016bd:	e8 82 25 00 00       	call   80103c44 <acquire>
  ip->ref--;
...
801016d2:	e8 d2 25 00 00       	call   80103ca9 <release>
}
...
801016ea:	e8 55 25 00 00       	call   80103c44 <acquire>
    int r = ip->ref;
801016ef:	8b 7b 08             	mov    0x8(%ebx),%edi
    release(&icache.lock);
801016f2:	c7 04 24 e0 f9 10 80 	movl   $0x8010f9e0,(%esp)
801016f9:	e8 ab 25 00 00       	call   80103ca9 <release>
    if(r == 1){
...
8010182a:	e8 3c 25 00 00       	call   80103d6b <memmove>
    brelse(bp);
...
80101926:	e8 40 24 00 00       	call   80103d6b <memmove>
    log_write(bp);
...
801019a9:	e8 24 24 00 00       	call   80103dd2 <strncmp>
}
801019ae:	c9                   	leave  
801019af:	c3                   	ret    
...
80101ba9:	e8 61 22 00 00       	call   80103e0f <strncpy>
  de.inum = inum;
...
80101d10:	e8 f3 1d 00 00       	call   80103b08 <initlock>
...
80101d80:	e8 bf 1e 00 00       	call   80103c44 <acquire>
...
80101dad:	e8 8c 1a 00 00       	call   8010383e <wakeup>
...
80101dcb:	e8 d9 1e 00 00       	call   80103ca9 <release>
...
80101de2:	e8 c2 1e 00 00       	call   80103ca9 <release>
    return;
...
80101e1a:	e8 9b 1c 00 00       	call   80103aba <holdingsleep>
...
80101e47:	e8 f8 1d 00 00       	call   80103c44 <acquire>
...
80101ea9:	e8 2b 18 00 00       	call   801036d9 <sleep>
...
80101ec3:	e8 e1 1d 00 00       	call   80103ca9 <release>
}
...
80101fb6:	81 fb a8 54 11 80    	cmp    $0x801154a8,%ebx
...
80101fd6:	e8 15 1d 00 00       	call   80103cf0 <memset>
...
80102017:	e8 28 1c 00 00       	call   80103c44 <acquire>
8010201c:	83 c4 10             	add    $0x10,%esp
8010201f:	eb c6                	jmp    80101fe7 <kfree+0x43>
    release(&kmem.lock);
80102021:	83 ec 0c             	sub    $0xc,%esp
80102024:	68 40 16 11 80       	push   $0x80111640
80102029:	e8 7b 1c 00 00       	call   80103ca9 <release>
...
80102079:	e8 8a 1a 00 00       	call   80103b08 <initlock>
  kmem.use_lock = 0;
...
80102150:	0f b6 8a e0 68 10 80 	movzbl -0x7fef9720(%edx),%ecx
80102157:	0b 0d b4 95 10 80    	or     0x801095b4,%ecx
  shift ^= togglecode[data];
8010215d:	0f b6 82 e0 67 10 80 	movzbl -0x7fef9820(%edx),%eax
...
80102171:	8b 04 85 c0 67 10 80 	mov    -0x7fef9840(,%eax,4),%eax
...
801021a9:	83 e2 7f             	and    $0x7f,%edx
    shift &= ~(shiftcode[data] | E0ESC);
801021ac:	0f b6 82 e0 68 10 80 	movzbl -0x7fef9720(%edx),%eax
...
80102497:	e8 9a 18 00 00       	call   80103d36 <memcmp>
...
80102602:	e8 64 17 00 00       	call   80103d6b <memmove>
...
80102701:	e8 65 16 00 00       	call   80103d6b <memmove>
...
8010276f:	68 e0 69 10 80       	push   $0x801069e0
80102774:	68 80 16 11 80       	push   $0x80111680
80102779:	e8 8a 13 00 00       	call   80103b08 <initlock>
  readsb(dev, &sb);
...
801027b9:	e8 86 14 00 00       	call   80103c44 <acquire>
...
801027d0:	e8 04 0f 00 00       	call   801036d9 <sleep>
...
80102807:	e8 cd 0e 00 00       	call   801036d9 <sleep>
...
8010281e:	e8 86 14 00 00       	call   80103ca9 <release>
}
...
80102834:	e8 0b 14 00 00       	call   80103c44 <acquire>
  log.outstanding -= 1;
...
8010286e:	e8 36 14 00 00       	call   80103ca9 <release>
  if(do_commit){
...
80102909:	e8 36 13 00 00       	call   80103c44 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102934:	68 f3 69 10 80       	push   $0x801069f3
80102939:	e8 0a da ff ff       	call   80100348 <panic>
    panic("log_write outside of trans");
8010293e:	83 ec 0c             	sub    $0xc,%esp
80102941:	68 09 6a 10 80       	push   $0x80106a09
...
80102964:	e8 40 13 00 00       	call   80103ca9 <release>
}
...
80102992:	e8 d4 13 00 00       	call   80103d6b <memmove>
...
80102a23:	68 24 6a 10 80       	push   $0x80106a24
80102a28:	e8 de db ff ff       	call   8010060b <cprintf>
  idtinit();       // load idt register
80102a2d:	e8 8a 24 00 00       	call   80104ebc <idtinit>
...
80102a4d:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102a50:	e8 70 34 00 00       	call   80105ec5 <switchkvm>
  seginit();
80102a55:	e8 1f 33 00 00       	call   80105d79 <seginit>
  lapicinit();
...
80102aa7:	e8 be 26 00 00       	call   8010516a <uartinit>
  pinit();         // process table
80102aac:	e8 b4 06 00 00       	call   80103165 <pinit>
  tvinit();        // trap vectors
80102ab1:	e8 55 23 00 00       	call   80104e0b <tvinit>
  binit();         // buffer cache
...
80102b27:	68 38 6a 10 80       	push   $0x80106a38
80102b2c:	53                   	push   %ebx
80102b2d:	e8 04 12 00 00       	call   80103d36 <memcmp>
...
80102bec:	68 3d 6a 10 80       	push   $0x80106a3d
80102bf1:	56                   	push   %esi
80102bf2:	e8 3f 11 00 00       	call   80103d36 <memcmp>
...
80102c88:	68 42 6a 10 80       	push   $0x80106a42
...
80102cc7:	ff 24 85 7c 6a 10 80 	jmp    *-0x7fef9584(,%eax,4)
      continue;
    case MPIOAPIC:
...
80102d15:	68 5c 6a 10 80       	push   $0x80106a5c
...
80102dd1:	68 90 6a 10 80       	push   $0x80106a90
80102dd6:	50                   	push   %eax
80102dd7:	e8 2c 0d 00 00       	call   80103b08 <initlock>
  (*f0)->type = FD_PIPE;
...
80102e2d:	e8 12 0e 00 00       	call   80103c44 <acquire>
  if(writable){
...
80102e4f:	e8 ea 09 00 00       	call   8010383e <wakeup>
...
80102e6d:	e8 37 0e 00 00       	call   80103ca9 <release>
...
80102e8e:	e8 ab 09 00 00       	call   8010383e <wakeup>
...
80102e9c:	e8 08 0e 00 00       	call   80103ca9 <release>
    kfree((char*)p);
...
80102ebd:	e8 82 0d 00 00       	call   80103c44 <acquire>
  for(i = 0; i < n; i++){
...
80102f06:	e8 33 09 00 00       	call   8010383e <wakeup>
...
80102f65:	e8 d4 08 00 00       	call   8010383e <wakeup>
  release(&p->lock);
80102f6a:	89 1c 24             	mov    %ebx,(%esp)
80102f6d:	e8 37 0d 00 00       	call   80103ca9 <release>
  return n;
...
80102f89:	e8 b6 0c 00 00       	call   80103c44 <acquire>
...
8010301c:	e8 1d 08 00 00       	call   8010383e <wakeup>
  release(&p->lock);
80103021:	89 1c 24             	mov    %ebx,(%esp)
80103024:	e8 80 0c 00 00       	call   80103ca9 <release>
  return i;
...
8010306d:	e8 d2 0b 00 00       	call   80103c44 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
...
80103095:	e8 0f 0c 00 00       	call   80103ca9 <release>
  return 0;
...
801030c4:	e8 e0 0b 00 00       	call   80103ca9 <release>
...
801030e1:	c7 80 b0 0f 00 00 00 	movl   $0x80104e00,0xfb0(%eax)
801030e8:	4e 10 80 
  sp -= sizeof *p->context;
...
801030fb:	e8 f0 0b 00 00       	call   80103cf0 <memset>
...
8010312d:	e8 77 0b 00 00       	call   80103ca9 <release>
  if (first) {
...
8010316b:	68 95 6a 10 80       	push   $0x80106a95
80103170:	68 20 1d 11 80       	push   $0x80111d20
80103175:	e8 8e 09 00 00       	call   80103b08 <initlock>
...
80103190:	c7 04 95 24 1d 11 80 	movl   $0xffffffff,-0x7feee2dc(,%edx,4)
...
801031cb:	39 15 00 1d 11 80    	cmp    %edx,0x80111d00
801031d1:	7e 23                	jle    801031f6 <mycpu+0x42>
    if (cpus[i].apicid == apicid)
801031d3:	69 ca b0 00 00 00    	imul   $0xb0,%edx,%ecx
801031d9:	0f b6 89 80 17 11 80 	movzbl -0x7feee880(%ecx),%ecx
...
8010321b:	2d 80 17 11 80       	sub    $0x80111780,%eax
...
8010322f:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103232:	e8 30 09 00 00       	call   80103b67 <pushcli>
  c = mycpu();
80103237:	e8 78 ff ff ff       	call   801031b4 <mycpu>
  p = c->proc;
8010323c:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103242:	e8 5d 09 00 00       	call   80103ba4 <popcli>
}
...
8010325b:	89 c3                	mov    %eax,%ebx
  initproc = p;
8010325d:	a3 b8 95 10 80       	mov    %eax,0x801095b8
  if((p->pgdir = setupkvm()) == 0)
80103262:	e8 7d 30 00 00       	call   801062e4 <setupkvm>
...
8010327a:	68 60 94 10 80       	push   $0x80109460
8010327f:	50                   	push   %eax
80103280:	e8 6a 2d 00 00       	call   80105fef <inituvm>
  p->sz = PGSIZE;
...
80103295:	e8 56 0a 00 00       	call   80103cf0 <memset>
...
801032e8:	68 c5 6a 10 80       	push   $0x80106ac5
801032ed:	50                   	push   %eax
801032ee:	e8 64 0b 00 00       	call   80103e57 <safestrcpy>
  p->cwd = namei("/");
801032f3:	c7 04 24 ce 6a 10 80 	movl   $0x80106ace,(%esp)
801032fa:	e8 e2 e8 ff ff       	call   80101be1 <namei>
801032ff:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
80103302:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103309:	e8 36 09 00 00       	call   80103c44 <acquire>
  p->state = RUNNABLE;
8010330e:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
80103315:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
8010331c:	e8 88 09 00 00       	call   80103ca9 <release>
}
...
8010332c:	68 ac 6a 10 80       	push   $0x80106aac
...
80103359:	e8 9a 2d 00 00       	call   801060f8 <deallocuvm>
...
80103376:	e8 0f 2e 00 00       	call   8010618a <allocuvm>
...
80103388:	e8 4a 2b 00 00       	call   80105ed7 <switchuvm>
  return 0;
...
801033cd:	e8 c3 2f 00 00       	call   80106395 <copyuvm>
...
8010346f:	e8 e3 09 00 00       	call   80103e57 <safestrcpy>
  pid = np->pid;
80103474:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103477:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
8010347e:	e8 c1 07 00 00       	call   80103c44 <acquire>
  np->state = RUNNABLE;
80103483:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
8010348a:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103491:	e8 13 08 00 00       	call   80103ca9 <release>
  return pid;
...
801034bd:	00 00 00 
801034c0:	eb 64                	jmp    80103526 <scheduler+0x7c>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801034c2:	83 c3 7c             	add    $0x7c,%ebx
801034c5:	81 fb 54 3c 11 80    	cmp    $0x80113c54,%ebx
801034cb:	73 49                	jae    80103516 <scheduler+0x6c>
      if(p->state != RUNNABLE)
801034cd:	83 7b 0c 03          	cmpl   $0x3,0xc(%ebx)
801034d1:	75 ef                	jne    801034c2 <scheduler+0x18>
      c->proc = p;
801034d3:	89 9e ac 00 00 00    	mov    %ebx,0xac(%esi)
      switchuvm(p);
801034d9:	83 ec 0c             	sub    $0xc,%esp
801034dc:	53                   	push   %ebx
801034dd:	e8 f5 29 00 00       	call   80105ed7 <switchuvm>
      p->state = RUNNING;
801034e2:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      ptable.pstatus.inuse[3] = 1;
801034e9:	c7 05 60 40 11 80 01 	movl   $0x1,0x80114060
801034f0:	00 00 00 
      swtch(&(c->scheduler), p->context);
801034f3:	83 c4 08             	add    $0x8,%esp
801034f6:	ff 73 1c             	pushl  0x1c(%ebx)
801034f9:	8d 46 04             	lea    0x4(%esi),%eax
801034fc:	50                   	push   %eax
801034fd:	e8 a8 09 00 00       	call   80103eaa <swtch>
      switchkvm();
80103502:	e8 be 29 00 00       	call   80105ec5 <switchkvm>
      c->proc = 0;
80103507:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
8010350e:	00 00 00 
80103511:	83 c4 10             	add    $0x10,%esp
80103514:	eb ac                	jmp    801034c2 <scheduler+0x18>
    release(&ptable.lock);
80103516:	83 ec 0c             	sub    $0xc,%esp
80103519:	68 20 1d 11 80       	push   $0x80111d20
8010351e:	e8 86 07 00 00       	call   80103ca9 <release>
    sti();
...
8010352a:	68 20 1d 11 80       	push   $0x80111d20
8010352f:	e8 10 07 00 00       	call   80103c44 <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103534:	83 c4 10             	add    $0x10,%esp
80103537:	bb 54 1d 11 80       	mov    $0x80111d54,%ebx
8010353c:	eb 87                	jmp    801034c5 <scheduler+0x1b>
...
80103543:	e8 e3 fc ff ff       	call   8010322b <myproc>
80103548:	89 c3                	mov    %eax,%ebx
  if(!holding(&ptable.lock))
8010354a:	83 ec 0c             	sub    $0xc,%esp
8010354d:	68 20 1d 11 80       	push   $0x80111d20
80103552:	e8 ad 06 00 00       	call   80103c04 <holding>
80103557:	83 c4 10             	add    $0x10,%esp
8010355a:	85 c0                	test   %eax,%eax
8010355c:	74 4f                	je     801035ad <sched+0x6f>
  if(mycpu()->ncli != 1)
8010355e:	e8 51 fc ff ff       	call   801031b4 <mycpu>
80103563:	83 b8 a4 00 00 00 01 	cmpl   $0x1,0xa4(%eax)
8010356a:	75 4e                	jne    801035ba <sched+0x7c>
  if(p->state == RUNNING)
8010356c:	83 7b 0c 04          	cmpl   $0x4,0xc(%ebx)
80103570:	74 55                	je     801035c7 <sched+0x89>
  asm volatile("pushfl; popl %0" : "=r" (eflags));
80103572:	9c                   	pushf  
80103573:	58                   	pop    %eax
  if(readeflags()&FL_IF)
80103574:	f6 c4 02             	test   $0x2,%ah
80103577:	75 5b                	jne    801035d4 <sched+0x96>
  intena = mycpu()->intena;
80103579:	e8 36 fc ff ff       	call   801031b4 <mycpu>
8010357e:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103584:	e8 2b fc ff ff       	call   801031b4 <mycpu>
80103589:	83 ec 08             	sub    $0x8,%esp
8010358c:	ff 70 04             	pushl  0x4(%eax)
8010358f:	83 c3 1c             	add    $0x1c,%ebx
80103592:	53                   	push   %ebx
80103593:	e8 12 09 00 00       	call   80103eaa <swtch>
  mycpu()->intena = intena;
80103598:	e8 17 fc ff ff       	call   801031b4 <mycpu>
8010359d:	89 b0 a8 00 00 00    	mov    %esi,0xa8(%eax)
}
801035a3:	83 c4 10             	add    $0x10,%esp
801035a6:	8d 65 f8             	lea    -0x8(%ebp),%esp
801035a9:	5b                   	pop    %ebx
801035aa:	5e                   	pop    %esi
801035ab:	5d                   	pop    %ebp
801035ac:	c3                   	ret    
...
801035b0:	68 d0 6a 10 80       	push   $0x80106ad0
801035b5:	e8 8e cd ff ff       	call   80100348 <panic>
    panic("sched locks");
801035ba:	83 ec 0c             	sub    $0xc,%esp
801035bd:	68 e2 6a 10 80       	push   $0x80106ae2
801035c2:	e8 81 cd ff ff       	call   80100348 <panic>
    panic("sched running");
801035c7:	83 ec 0c             	sub    $0xc,%esp
801035ca:	68 ee 6a 10 80       	push   $0x80106aee
801035cf:	e8 74 cd ff ff       	call   80100348 <panic>
    panic("sched interruptible");
801035d4:	83 ec 0c             	sub    $0xc,%esp
801035d7:	68 fc 6a 10 80       	push   $0x80106afc
...
801035e5:	53                   	push   %ebx
  struct proc *curproc = myproc();
801035e6:	e8 40 fc ff ff       	call   8010322b <myproc>
  if(curproc == initproc)
801035eb:	39 05 b8 95 10 80    	cmp    %eax,0x801095b8
801035f1:	74 09                	je     801035fc <exit+0x1b>
801035f3:	89 c6                	mov    %eax,%esi
  for(fd = 0; fd < NOFILE; fd++){
801035f5:	bb 00 00 00 00       	mov    $0x0,%ebx
801035fa:	eb 10                	jmp    8010360c <exit+0x2b>
    panic("init exiting");
801035fc:	83 ec 0c             	sub    $0xc,%esp
801035ff:	68 10 6b 10 80       	push   $0x80106b10
80103604:	e8 3f cd ff ff       	call   80100348 <panic>
  for(fd = 0; fd < NOFILE; fd++){
80103609:	83 c3 01             	add    $0x1,%ebx
8010360c:	83 fb 0f             	cmp    $0xf,%ebx
8010360f:	7f 1e                	jg     8010362f <exit+0x4e>
    if(curproc->ofile[fd]){
80103611:	8b 44 9e 28          	mov    0x28(%esi,%ebx,4),%eax
80103615:	85 c0                	test   %eax,%eax
80103617:	74 f0                	je     80103609 <exit+0x28>
      fileclose(curproc->ofile[fd]);
80103619:	83 ec 0c             	sub    $0xc,%esp
8010361c:	50                   	push   %eax
8010361d:	e8 b1 d6 ff ff       	call   80100cd3 <fileclose>
      curproc->ofile[fd] = 0;
80103622:	c7 44 9e 28 00 00 00 	movl   $0x0,0x28(%esi,%ebx,4)
80103629:	00 
8010362a:	83 c4 10             	add    $0x10,%esp
8010362d:	eb da                	jmp    80103609 <exit+0x28>
  begin_op();
8010362f:	e8 7a f1 ff ff       	call   801027ae <begin_op>
  iput(curproc->cwd);
80103634:	83 ec 0c             	sub    $0xc,%esp
80103637:	ff 76 68             	pushl  0x68(%esi)
8010363a:	e8 49 e0 ff ff       	call   80101688 <iput>
  end_op();
8010363f:	e8 e4 f1 ff ff       	call   80102828 <end_op>
  curproc->cwd = 0;
80103644:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  acquire(&ptable.lock);
8010364b:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103652:	e8 ed 05 00 00       	call   80103c44 <acquire>
  wakeup1(curproc->parent);
80103657:	8b 46 14             	mov    0x14(%esi),%eax
8010365a:	e8 d7 f9 ff ff       	call   80103036 <wakeup1>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010365f:	83 c4 10             	add    $0x10,%esp
80103662:	bb 54 1d 11 80       	mov    $0x80111d54,%ebx
80103667:	eb 03                	jmp    8010366c <exit+0x8b>
80103669:	83 c3 7c             	add    $0x7c,%ebx
8010366c:	81 fb 54 3c 11 80    	cmp    $0x80113c54,%ebx
80103672:	73 1a                	jae    8010368e <exit+0xad>
    if(p->parent == curproc){
80103674:	39 73 14             	cmp    %esi,0x14(%ebx)
80103677:	75 f0                	jne    80103669 <exit+0x88>
      p->parent = initproc;
80103679:	a1 b8 95 10 80       	mov    0x801095b8,%eax
8010367e:	89 43 14             	mov    %eax,0x14(%ebx)
      if(p->state == ZOMBIE)
80103681:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
80103685:	75 e2                	jne    80103669 <exit+0x88>
        wakeup1(initproc);
80103687:	e8 aa f9 ff ff       	call   80103036 <wakeup1>
8010368c:	eb db                	jmp    80103669 <exit+0x88>
  curproc->state = ZOMBIE;
8010368e:	c7 46 0c 05 00 00 00 	movl   $0x5,0xc(%esi)
  sched();
80103695:	e8 a4 fe ff ff       	call   8010353e <sched>
  panic("zombie exit");
8010369a:	83 ec 0c             	sub    $0xc,%esp
8010369d:	68 1d 6b 10 80       	push   $0x80106b1d
...
801036b2:	e8 8d 05 00 00       	call   80103c44 <acquire>
  myproc()->state = RUNNABLE;
801036b7:	e8 6f fb ff ff       	call   8010322b <myproc>
801036bc:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  sched();
801036c3:	e8 76 fe ff ff       	call   8010353e <sched>
  release(&ptable.lock);
801036c8:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
801036cf:	e8 d5 05 00 00       	call   80103ca9 <release>
}
...
801036de:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  struct proc *p = myproc();
801036e1:	e8 45 fb ff ff       	call   8010322b <myproc>
  if(p == 0)
...
801036f0:	81 fb 20 1d 11 80    	cmp    $0x80111d20,%ebx
801036f6:	74 18                	je     80103710 <sleep+0x37>
    acquire(&ptable.lock);  //DOC: sleeplock1
801036f8:	83 ec 0c             	sub    $0xc,%esp
801036fb:	68 20 1d 11 80       	push   $0x80111d20
80103700:	e8 3f 05 00 00       	call   80103c44 <acquire>
    release(lk);
80103705:	89 1c 24             	mov    %ebx,(%esp)
80103708:	e8 9c 05 00 00       	call   80103ca9 <release>
8010370d:	83 c4 10             	add    $0x10,%esp
  p->chan = chan;
80103710:	8b 45 08             	mov    0x8(%ebp),%eax
80103713:	89 46 20             	mov    %eax,0x20(%esi)
  p->state = SLEEPING;
80103716:	c7 46 0c 02 00 00 00 	movl   $0x2,0xc(%esi)
  sched();
8010371d:	e8 1c fe ff ff       	call   8010353e <sched>
  p->chan = 0;
80103722:	c7 46 20 00 00 00 00 	movl   $0x0,0x20(%esi)
  if(lk != &ptable.lock){  //DOC: sleeplock2
80103729:	81 fb 20 1d 11 80    	cmp    $0x80111d20,%ebx
8010372f:	74 18                	je     80103749 <sleep+0x70>
    release(&ptable.lock);
80103731:	83 ec 0c             	sub    $0xc,%esp
80103734:	68 20 1d 11 80       	push   $0x80111d20
80103739:	e8 6b 05 00 00       	call   80103ca9 <release>
    acquire(lk);
8010373e:	89 1c 24             	mov    %ebx,(%esp)
80103741:	e8 fe 04 00 00       	call   80103c44 <acquire>
...
80103753:	68 29 6b 10 80       	push   $0x80106b29
80103758:	e8 eb cb ff ff       	call   80100348 <panic>
    panic("sleep without lk");
8010375d:	83 ec 0c             	sub    $0xc,%esp
80103760:	68 2f 6b 10 80       	push   $0x80106b2f
...
801037d9:	e8 cb 04 00 00       	call   80103ca9 <release>
        return pid;
...
801037e9:	c3                   	ret    
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801037ea:	83 c3 7c             	add    $0x7c,%ebx
801037ed:	81 fb 54 3c 11 80    	cmp    $0x80113c54,%ebx
801037f3:	73 12                	jae    80103807 <wait+0x9d>
      if(p->parent != curproc)
801037f5:	39 73 14             	cmp    %esi,0x14(%ebx)
801037f8:	75 f0                	jne    801037ea <wait+0x80>
      if(p->state == ZOMBIE){
801037fa:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
801037fe:	74 92                	je     80103792 <wait+0x28>
      havekids = 1;
80103800:	b8 01 00 00 00       	mov    $0x1,%eax
80103805:	eb e3                	jmp    801037ea <wait+0x80>
    if(!havekids || curproc->killed){
80103807:	85 c0                	test   %eax,%eax
80103809:	74 06                	je     80103811 <wait+0xa7>
8010380b:	83 7e 24 00          	cmpl   $0x0,0x24(%esi)
8010380f:	74 17                	je     80103828 <wait+0xbe>
      release(&ptable.lock);
80103811:	83 ec 0c             	sub    $0xc,%esp
80103814:	68 20 1d 11 80       	push   $0x80111d20
80103819:	e8 8b 04 00 00       	call   80103ca9 <release>
      return -1;
8010381e:	83 c4 10             	add    $0x10,%esp
80103821:	be ff ff ff ff       	mov    $0xffffffff,%esi
80103826:	eb b9                	jmp    801037e1 <wait+0x77>
    sleep(curproc, &ptable.lock);  //DOC: wait-sleep
80103828:	83 ec 08             	sub    $0x8,%esp
8010382b:	68 20 1d 11 80       	push   $0x80111d20
80103830:	56                   	push   %esi
80103831:	e8 a3 fe ff ff       	call   801036d9 <sleep>
    havekids = 0;
80103836:	83 c4 10             	add    $0x10,%esp
80103839:	e9 48 ff ff ff       	jmp    80103786 <wait+0x1c>
...
80103841:	83 ec 14             	sub    $0x14,%esp
  acquire(&ptable.lock);
80103844:	68 20 1d 11 80       	push   $0x80111d20
80103849:	e8 f6 03 00 00       	call   80103c44 <acquire>
  wakeup1(chan);
8010384e:	8b 45 08             	mov    0x8(%ebp),%eax
80103851:	e8 e0 f7 ff ff       	call   80103036 <wakeup1>
  release(&ptable.lock);
80103856:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
8010385d:	e8 47 04 00 00       	call   80103ca9 <release>
}
...
8010386b:	83 ec 10             	sub    $0x10,%esp
8010386e:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *p;

  acquire(&ptable.lock);
80103871:	68 20 1d 11 80       	push   $0x80111d20
80103876:	e8 c9 03 00 00       	call   80103c44 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010387b:	83 c4 10             	add    $0x10,%esp
8010387e:	b8 54 1d 11 80       	mov    $0x80111d54,%eax
80103883:	3d 54 3c 11 80       	cmp    $0x80113c54,%eax
80103888:	73 3a                	jae    801038c4 <kill+0x5d>
    if(p->pid == pid){
8010388a:	39 58 10             	cmp    %ebx,0x10(%eax)
8010388d:	74 05                	je     80103894 <kill+0x2d>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010388f:	83 c0 7c             	add    $0x7c,%eax
80103892:	eb ef                	jmp    80103883 <kill+0x1c>
      p->killed = 1;
80103894:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
8010389b:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
8010389f:	74 1a                	je     801038bb <kill+0x54>
        p->state = RUNNABLE;
      release(&ptable.lock);
801038a1:	83 ec 0c             	sub    $0xc,%esp
801038a4:	68 20 1d 11 80       	push   $0x80111d20
801038a9:	e8 fb 03 00 00       	call   80103ca9 <release>
      return 0;
...
801038b6:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801038b9:	c9                   	leave  
801038ba:	c3                   	ret    
        p->state = RUNNABLE;
801038bb:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
801038c2:	eb dd                	jmp    801038a1 <kill+0x3a>
  release(&ptable.lock);
801038c4:	83 ec 0c             	sub    $0xc,%esp
801038c7:	68 20 1d 11 80       	push   $0x80111d20
801038cc:	e8 d8 03 00 00       	call   80103ca9 <release>
  return -1;
801038d1:	83 c4 10             	add    $0x10,%esp
801038d4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801038d9:	eb db                	jmp    801038b6 <kill+0x4f>
...
801038e2:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *p;

  acquire(&ptable.lock);
801038e5:	68 20 1d 11 80       	push   $0x80111d20
801038ea:	e8 55 03 00 00       	call   80103c44 <acquire>
  int i = 0;
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801038ef:	83 c4 10             	add    $0x10,%esp
  int i = 0;
801038f2:	ba 00 00 00 00       	mov    $0x0,%edx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801038f7:	b8 54 1d 11 80       	mov    $0x80111d54,%eax
801038fc:	3d 54 3c 11 80       	cmp    $0x80113c54,%eax
80103901:	73 31                	jae    80103934 <setpri+0x59>
    if(p->pid == pid){
80103903:	39 58 10             	cmp    %ebx,0x10(%eax)
80103906:	74 08                	je     80103910 <setpri+0x35>
...
8010390e:	eb ec                	jmp    801038fc <setpri+0x21>
      ptable.pstatus.priority[i] = pri;
80103910:	8b 45 0c             	mov    0xc(%ebp),%eax
80103913:	89 04 95 54 42 11 80 	mov    %eax,-0x7feebdac(,%edx,4)
      release(&ptable.lock);
8010391a:	83 ec 0c             	sub    $0xc,%esp
8010391d:	68 20 1d 11 80       	push   $0x80111d20
80103922:	e8 82 03 00 00       	call   80103ca9 <release>
      return 0;
...
8010392f:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80103932:	c9                   	leave  
80103933:	c3                   	ret    
  release(&ptable.lock);
80103934:	83 ec 0c             	sub    $0xc,%esp
80103937:	68 20 1d 11 80       	push   $0x80111d20
8010393c:	e8 68 03 00 00       	call   80103ca9 <release>
  return -1;
80103941:	83 c4 10             	add    $0x10,%esp
80103944:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103949:	eb e4                	jmp    8010392f <setpri+0x54>
...
8010394e:	56                   	push   %esi
8010394f:	53                   	push   %ebx
80103950:	83 ec 30             	sub    $0x30,%esp
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103953:	bb 54 1d 11 80       	mov    $0x80111d54,%ebx
80103958:	eb 33                	jmp    8010398d <procdump+0x42>
    if(p->state == UNUSED)
      continue;
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
      ...
      state = "???";
8010395a:	b8 40 6b 10 80       	mov    $0x80106b40,%eax
    cprintf("%d %s %s", p->pid, state, p->name);
8010395f:	8d 53 6c             	lea    0x6c(%ebx),%edx
80103962:	52                   	push   %edx
80103963:	50                   	push   %eax
80103964:	ff 73 10             	pushl  0x10(%ebx)
80103967:	68 44 6b 10 80       	push   $0x80106b44
8010396c:	e8 9a cc ff ff       	call   8010060b <cprintf>
    if(p->state == SLEEPING){
80103971:	83 c4 10             	add    $0x10,%esp
80103974:	83 7b 0c 02          	cmpl   $0x2,0xc(%ebx)
80103978:	74 39                	je     801039b3 <procdump+0x68>
...
8010397d:	68 bb 6e 10 80       	push   $0x80106ebb
80103982:	e8 84 cc ff ff       	call   8010060b <cprintf>
80103987:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010398a:	83 c3 7c             	add    $0x7c,%ebx
8010398d:	81 fb 54 3c 11 80    	cmp    $0x80113c54,%ebx
80103993:	73 61                	jae    801039f6 <procdump+0xab>
    if(p->state == UNUSED)
80103995:	8b 43 0c             	mov    0xc(%ebx),%eax
80103998:	85 c0                	test   %eax,%eax
8010399a:	74 ee                	je     8010398a <procdump+0x3f>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
8010399c:	83 f8 05             	cmp    $0x5,%eax
8010399f:	77 b9                	ja     8010395a <procdump+0xf>
801039a1:	8b 04 85 a0 6b 10 80 	mov    -0x7fef9460(,%eax,4),%eax
801039a8:	85 c0                	test   %eax,%eax
801039aa:	75 b3                	jne    8010395f <procdump+0x14>
      state = "???";
801039ac:	b8 40 6b 10 80       	mov    $0x80106b40,%eax
801039b1:	eb ac                	jmp    8010395f <procdump+0x14>
      getcallerpcs((uint*)p->context->ebp+2, pc);
...
801039bf:	8d 55 d0             	lea    -0x30(%ebp),%edx
801039c2:	52                   	push   %edx
801039c3:	50                   	push   %eax
801039c4:	e8 5a 01 00 00       	call   80103b23 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
801039c9:	83 c4 10             	add    $0x10,%esp
801039cc:	be 00 00 00 00       	mov    $0x0,%esi
801039d1:	eb 14                	jmp    801039e7 <procdump+0x9c>
        cprintf(" %p", pc[i]);
801039d3:	83 ec 08             	sub    $0x8,%esp
801039d6:	50                   	push   %eax
801039d7:	68 81 65 10 80       	push   $0x80106581
801039dc:	e8 2a cc ff ff       	call   8010060b <cprintf>
      for(i=0; i<10 && pc[i] != 0; i++)
801039e1:	83 c6 01             	add    $0x1,%esi
801039e4:	83 c4 10             	add    $0x10,%esp
801039e7:	83 fe 09             	cmp    $0x9,%esi
801039ea:	7f 8e                	jg     8010397a <procdump+0x2f>
801039ec:	8b 44 b5 d0          	mov    -0x30(%ebp,%esi,4),%eax
801039f0:	85 c0                	test   %eax,%eax
801039f2:	75 df                	jne    801039d3 <procdump+0x88>
801039f4:	eb 84                	jmp    8010397a <procdump+0x2f>
  }
}
...
80103a04:	8b 5d 08             	mov    0x8(%ebp),%ebx
  initlock(&lk->lk, "sleep lock");
80103a07:	68 b8 6b 10 80       	push   $0x80106bb8
80103a0c:	8d 43 04             	lea    0x4(%ebx),%eax
80103a0f:	50                   	push   %eax
80103a10:	e8 f3 00 00 00       	call   80103b08 <initlock>
  lk->name = name;
80103a15:	8b 45 0c             	mov    0xc(%ebp),%eax
80103a18:	89 43 38             	mov    %eax,0x38(%ebx)
  lk->locked = 0;
80103a1b:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  lk->pid = 0;
80103a21:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
}
...
80103a35:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&lk->lk);
80103a38:	8d 73 04             	lea    0x4(%ebx),%esi
80103a3b:	83 ec 0c             	sub    $0xc,%esp
80103a3e:	56                   	push   %esi
80103a3f:	e8 00 02 00 00       	call   80103c44 <acquire>
  while (lk->locked) {
80103a44:	83 c4 10             	add    $0x10,%esp
80103a47:	eb 0d                	jmp    80103a56 <acquiresleep+0x26>
    sleep(lk, &lk->lk);
80103a49:	83 ec 08             	sub    $0x8,%esp
80103a4c:	56                   	push   %esi
80103a4d:	53                   	push   %ebx
80103a4e:	e8 86 fc ff ff       	call   801036d9 <sleep>
80103a53:	83 c4 10             	add    $0x10,%esp
  while (lk->locked) {
80103a56:	83 3b 00             	cmpl   $0x0,(%ebx)
80103a59:	75 ee                	jne    80103a49 <acquiresleep+0x19>
  }
  lk->locked = 1;
80103a5b:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80103a61:	e8 c5 f7 ff ff       	call   8010322b <myproc>
80103a66:	8b 40 10             	mov    0x10(%eax),%eax
80103a69:	89 43 3c             	mov    %eax,0x3c(%ebx)
  release(&lk->lk);
80103a6c:	83 ec 0c             	sub    $0xc,%esp
80103a6f:	56                   	push   %esi
80103a70:	e8 34 02 00 00       	call   80103ca9 <release>
}
...
80103a84:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&lk->lk);
80103a87:	8d 73 04             	lea    0x4(%ebx),%esi
80103a8a:	83 ec 0c             	sub    $0xc,%esp
80103a8d:	56                   	push   %esi
80103a8e:	e8 b1 01 00 00       	call   80103c44 <acquire>
  lk->locked = 0;
80103a93:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  lk->pid = 0;
80103a99:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
  wakeup(lk);
80103aa0:	89 1c 24             	mov    %ebx,(%esp)
80103aa3:	e8 96 fd ff ff       	call   8010383e <wakeup>
  release(&lk->lk);
80103aa8:	89 34 24             	mov    %esi,(%esp)
80103aab:	e8 f9 01 00 00       	call   80103ca9 <release>
}
...
80103abd:	56                   	push   %esi
80103abe:	53                   	push   %ebx
80103abf:	8b 5d 08             	mov    0x8(%ebp),%ebx
  int r;
  
  acquire(&lk->lk);
80103ac2:	8d 73 04             	lea    0x4(%ebx),%esi
80103ac5:	83 ec 0c             	sub    $0xc,%esp
80103ac8:	56                   	push   %esi
80103ac9:	e8 76 01 00 00       	call   80103c44 <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
80103ace:	83 c4 10             	add    $0x10,%esp
80103ad1:	83 3b 00             	cmpl   $0x0,(%ebx)
80103ad4:	75 17                	jne    80103aed <holdingsleep+0x33>
80103ad6:	bb 00 00 00 00       	mov    $0x0,%ebx
  release(&lk->lk);
80103adb:	83 ec 0c             	sub    $0xc,%esp
80103ade:	56                   	push   %esi
80103adf:	e8 c5 01 00 00       	call   80103ca9 <release>
  return r;
}
...
80103aec:	c3                   	ret    
  r = lk->locked && (lk->pid == myproc()->pid);
80103aed:	8b 5b 3c             	mov    0x3c(%ebx),%ebx
80103af0:	e8 36 f7 ff ff       	call   8010322b <myproc>
80103af5:	3b 58 10             	cmp    0x10(%eax),%ebx
80103af8:	74 07                	je     80103b01 <holdingsleep+0x47>
80103afa:	bb 00 00 00 00       	mov    $0x0,%ebx
80103aff:	eb da                	jmp    80103adb <holdingsleep+0x21>
80103b01:	bb 01 00 00 00       	mov    $0x1,%ebx
80103b06:	eb d3                	jmp    80103adb <holdingsleep+0x21>
...
80103b0b:	8b 45 08             	mov    0x8(%ebp),%eax
  lk->name = name;
80103b0e:	8b 55 0c             	mov    0xc(%ebp),%edx
80103b11:	89 50 04             	mov    %edx,0x4(%eax)
  lk->locked = 0;
80103b14:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->cpu = 0;
80103b1a:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
80103b21:	5d                   	pop    %ebp
80103b22:	c3                   	ret    

80103b23 <getcallerpcs>:
}
...
80103b27:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  ...
  ebp = (uint*)v - 2;
80103b2a:	8b 45 08             	mov    0x8(%ebp),%eax
80103b2d:	8d 50 f8             	lea    -0x8(%eax),%edx
  for(i = 0; i < 10; i++){
80103b30:	b8 00 00 00 00       	mov    $0x0,%eax
80103b35:	83 f8 09             	cmp    $0x9,%eax
80103b38:	7f 25                	jg     80103b5f <getcallerpcs+0x3c>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80103b3a:	8d 9a 00 00 00 80    	lea    -0x80000000(%edx),%ebx
80103b40:	81 fb fe ff ff 7f    	cmp    $0x7ffffffe,%ebx
80103b46:	77 17                	ja     80103b5f <getcallerpcs+0x3c>
      break;
    pcs[i] = ebp[1];     // saved %eip
80103b48:	8b 5a 04             	mov    0x4(%edx),%ebx
80103b4b:	89 1c 81             	mov    %ebx,(%ecx,%eax,4)
    ebp = (uint*)ebp[0]; // saved %ebp
80103b4e:	8b 12                	mov    (%edx),%edx
  for(i = 0; i < 10; i++){
80103b50:	83 c0 01             	add    $0x1,%eax
80103b53:	eb e0                	jmp    80103b35 <getcallerpcs+0x12>
  }
  for(; i < 10; i++)
    pcs[i] = 0;
80103b55:	c7 04 81 00 00 00 00 	movl   $0x0,(%ecx,%eax,4)
  for(; i < 10; i++)
80103b5c:	83 c0 01             	add    $0x1,%eax
80103b5f:	83 f8 09             	cmp    $0x9,%eax
80103b62:	7e f1                	jle    80103b55 <getcallerpcs+0x32>
}
80103b64:	5b                   	pop    %ebx
80103b65:	5d                   	pop    %ebp
80103b66:	c3                   	ret    
...
80103b70:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
80103b71:	e8 3e f6 ff ff       	call   801031b4 <mycpu>
80103b76:	83 b8 a4 00 00 00 00 	cmpl   $0x0,0xa4(%eax)
80103b7d:	74 12                	je     80103b91 <pushcli+0x2a>
    mycpu()->intena = eflags & FL_IF;
  mycpu()->ncli += 1;
80103b7f:	e8 30 f6 ff ff       	call   801031b4 <mycpu>
80103b84:	83 80 a4 00 00 00 01 	addl   $0x1,0xa4(%eax)
}
...
80103b90:	c3                   	ret    
    mycpu()->intena = eflags & FL_IF;
80103b91:	e8 1e f6 ff ff       	call   801031b4 <mycpu>
80103b96:	81 e3 00 02 00 00    	and    $0x200,%ebx
80103b9c:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
80103ba2:	eb db                	jmp    80103b7f <pushcli+0x18>
...
80103bab:	58                   	pop    %eax
  if(readeflags()&FL_IF)
80103bac:	f6 c4 02             	test   $0x2,%ah
80103baf:	75 28                	jne    80103bd9 <popcli+0x35>
    panic("popcli - interruptible");
  if(--mycpu()->ncli < 0)
80103bb1:	e8 fe f5 ff ff       	call   801031b4 <mycpu>
80103bb6:	8b 88 a4 00 00 00    	mov    0xa4(%eax),%ecx
80103bbc:	8d 51 ff             	lea    -0x1(%ecx),%edx
80103bbf:	89 90 a4 00 00 00    	mov    %edx,0xa4(%eax)
80103bc5:	85 d2                	test   %edx,%edx
80103bc7:	78 1d                	js     80103be6 <popcli+0x42>
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
80103bc9:	e8 e6 f5 ff ff       	call   801031b4 <mycpu>
80103bce:	83 b8 a4 00 00 00 00 	cmpl   $0x0,0xa4(%eax)
80103bd5:	74 1c                	je     80103bf3 <popcli+0x4f>
    sti();
}
80103bd7:	c9                   	leave  
80103bd8:	c3                   	ret    
...
80103bdc:	68 c3 6b 10 80       	push   $0x80106bc3
80103be1:	e8 62 c7 ff ff       	call   80100348 <panic>
    panic("popcli");
80103be6:	83 ec 0c             	sub    $0xc,%esp
80103be9:	68 da 6b 10 80       	push   $0x80106bda
80103bee:	e8 55 c7 ff ff       	call   80100348 <panic>
  if(mycpu()->ncli == 0 && mycpu()->intena)
80103bf3:	e8 bc f5 ff ff       	call   801031b4 <mycpu>
80103bf8:	83 b8 a8 00 00 00 00 	cmpl   $0x0,0xa8(%eax)
80103bff:	74 d6                	je     80103bd7 <popcli+0x33>
  asm volatile("sti");
80103c01:	fb                   	sti    
}
80103c02:	eb d3                	jmp    80103bd7 <popcli+0x33>
...
80103c0b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
80103c0e:	e8 54 ff ff ff       	call   80103b67 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
80103c13:	83 3b 00             	cmpl   $0x0,(%ebx)
80103c16:	75 12                	jne    80103c2a <holding+0x26>
80103c18:	bb 00 00 00 00       	mov    $0x0,%ebx
  popcli();
80103c1d:	e8 82 ff ff ff       	call   80103ba4 <popcli>
}
80103c22:	89 d8                	mov    %ebx,%eax
80103c24:	83 c4 04             	add    $0x4,%esp
80103c27:	5b                   	pop    %ebx
80103c28:	5d                   	pop    %ebp
80103c29:	c3                   	ret    
  r = lock->locked && lock->cpu == mycpu();
80103c2a:	8b 5b 08             	mov    0x8(%ebx),%ebx
80103c2d:	e8 82 f5 ff ff       	call   801031b4 <mycpu>
80103c32:	39 c3                	cmp    %eax,%ebx
80103c34:	74 07                	je     80103c3d <holding+0x39>
80103c36:	bb 00 00 00 00       	mov    $0x0,%ebx
80103c3b:	eb e0                	jmp    80103c1d <holding+0x19>
80103c3d:	bb 01 00 00 00       	mov    $0x1,%ebx
80103c42:	eb d9                	jmp    80103c1d <holding+0x19>
...
80103c4b:	e8 17 ff ff ff       	call   80103b67 <pushcli>
  if(holding(lk))
80103c50:	83 ec 0c             	sub    $0xc,%esp
80103c53:	ff 75 08             	pushl  0x8(%ebp)
80103c56:	e8 a9 ff ff ff       	call   80103c04 <holding>
80103c5b:	83 c4 10             	add    $0x10,%esp
80103c5e:	85 c0                	test   %eax,%eax
80103c60:	75 3a                	jne    80103c9c <acquire+0x58>
  while(xchg(&lk->locked, 1) != 0)
80103c62:	8b 55 08             	mov    0x8(%ebp),%edx
  asm volatile("lock; xchgl %0, %1" :
80103c65:	b8 01 00 00 00       	mov    $0x1,%eax
80103c6a:	f0 87 02             	lock xchg %eax,(%edx)
80103c6d:	85 c0                	test   %eax,%eax
80103c6f:	75 f1                	jne    80103c62 <acquire+0x1e>
  __sync_synchronize();
80103c71:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  lk->cpu = mycpu();
80103c76:	8b 5d 08             	mov    0x8(%ebp),%ebx
80103c79:	e8 36 f5 ff ff       	call   801031b4 <mycpu>
80103c7e:	89 43 08             	mov    %eax,0x8(%ebx)
  getcallerpcs(&lk, lk->pcs);
80103c81:	8b 45 08             	mov    0x8(%ebp),%eax
80103c84:	83 c0 0c             	add    $0xc,%eax
80103c87:	83 ec 08             	sub    $0x8,%esp
80103c8a:	50                   	push   %eax
80103c8b:	8d 45 08             	lea    0x8(%ebp),%eax
80103c8e:	50                   	push   %eax
80103c8f:	e8 8f fe ff ff       	call   80103b23 <getcallerpcs>
}
...
80103c9f:	68 e1 6b 10 80       	push   $0x80106be1
80103ca4:	e8 9f c6 ff ff       	call   80100348 <panic>
...
80103cb4:	e8 4b ff ff ff       	call   80103c04 <holding>
80103cb9:	83 c4 10             	add    $0x10,%esp
80103cbc:	85 c0                	test   %eax,%eax
80103cbe:	74 23                	je     80103ce3 <release+0x3a>
  lk->pcs[0] = 0;
80103cc0:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
80103cc7:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  __sync_synchronize();
80103cce:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
80103cd3:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  popcli();
80103cd9:	e8 c6 fe ff ff       	call   80103ba4 <popcli>
}
...
80103ce6:	68 e9 6b 10 80       	push   $0x80106be9
...
80103cf8:	8b 4d 10             	mov    0x10(%ebp),%ecx
  if ((int)dst%4 == 0 && n%4 == 0){
80103cfb:	f6 c2 03             	test   $0x3,%dl
80103cfe:	75 05                	jne    80103d05 <memset+0x15>
80103d00:	f6 c1 03             	test   $0x3,%cl
80103d03:	74 0e                	je     80103d13 <memset+0x23>
  asm volatile("cld; rep stosb" :
80103d05:	89 d7                	mov    %edx,%edi
80103d07:	8b 45 0c             	mov    0xc(%ebp),%eax
80103d0a:	fc                   	cld    
80103d0b:	f3 aa                	rep stos %al,%es:(%edi)
    c &= 0xFF;
...
80103d0d:	89 d0                	mov    %edx,%eax
80103d0f:	5b                   	pop    %ebx
80103d10:	5f                   	pop    %edi
80103d11:	5d                   	pop    %ebp
80103d12:	c3                   	ret    
    c &= 0xFF;
80103d13:	0f b6 7d 0c          	movzbl 0xc(%ebp),%edi
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
80103d17:	c1 e9 02             	shr    $0x2,%ecx
80103d1a:	89 f8                	mov    %edi,%eax
80103d1c:	c1 e0 18             	shl    $0x18,%eax
80103d1f:	89 fb                	mov    %edi,%ebx
80103d21:	c1 e3 10             	shl    $0x10,%ebx
80103d24:	09 d8                	or     %ebx,%eax
80103d26:	89 fb                	mov    %edi,%ebx
80103d28:	c1 e3 08             	shl    $0x8,%ebx
80103d2b:	09 d8                	or     %ebx,%eax
80103d2d:	09 f8                	or     %edi,%eax
  asm volatile("cld; rep stosl" :
80103d2f:	89 d7                	mov    %edx,%edi
80103d31:	fc                   	cld    
80103d32:	f3 ab                	rep stos %eax,%es:(%edi)
80103d34:	eb d7                	jmp    80103d0d <memset+0x1d>
...
80103d3b:	8b 4d 08             	mov    0x8(%ebp),%ecx
80103d3e:	8b 55 0c             	mov    0xc(%ebp),%edx
80103d41:	8b 45 10             	mov    0x10(%ebp),%eax
  const uchar *s1, *s2;

  s1 = v1;
  s2 = v2;
  while(n-- > 0){
80103d44:	8d 70 ff             	lea    -0x1(%eax),%esi
80103d47:	85 c0                	test   %eax,%eax
80103d49:	74 1c                	je     80103d67 <memcmp+0x31>
    if(*s1 != *s2)
80103d4b:	0f b6 01             	movzbl (%ecx),%eax
80103d4e:	0f b6 1a             	movzbl (%edx),%ebx
80103d51:	38 d8                	cmp    %bl,%al
80103d53:	75 0a                	jne    80103d5f <memcmp+0x29>
      return *s1 - *s2;
    s1++, s2++;
80103d55:	83 c1 01             	add    $0x1,%ecx
80103d58:	83 c2 01             	add    $0x1,%edx
  while(n-- > 0){
80103d5b:	89 f0                	mov    %esi,%eax
80103d5d:	eb e5                	jmp    80103d44 <memcmp+0xe>
      return *s1 - *s2;
80103d5f:	0f b6 c0             	movzbl %al,%eax
80103d62:	0f b6 db             	movzbl %bl,%ebx
80103d65:	29 d8                	sub    %ebx,%eax
  }
...
80103d76:	8b 55 10             	mov    0x10(%ebp),%edx
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
80103d79:	39 c1                	cmp    %eax,%ecx
80103d7b:	73 3a                	jae    80103db7 <memmove+0x4c>
80103d7d:	8d 1c 11             	lea    (%ecx,%edx,1),%ebx
80103d80:	39 c3                	cmp    %eax,%ebx
80103d82:	76 37                	jbe    80103dbb <memmove+0x50>
    s += n;
    d += n;
80103d84:	8d 0c 10             	lea    (%eax,%edx,1),%ecx
    while(n-- > 0)
80103d87:	eb 0d                	jmp    80103d96 <memmove+0x2b>
      *--d = *--s;
80103d89:	83 eb 01             	sub    $0x1,%ebx
80103d8c:	83 e9 01             	sub    $0x1,%ecx
80103d8f:	0f b6 13             	movzbl (%ebx),%edx
80103d92:	88 11                	mov    %dl,(%ecx)
    while(n-- > 0)
80103d94:	89 f2                	mov    %esi,%edx
80103d96:	8d 72 ff             	lea    -0x1(%edx),%esi
80103d99:	85 d2                	test   %edx,%edx
80103d9b:	75 ec                	jne    80103d89 <memmove+0x1e>
80103d9d:	eb 14                	jmp    80103db3 <memmove+0x48>
  } else
    while(n-- > 0)
      *d++ = *s++;
80103d9f:	0f b6 11             	movzbl (%ecx),%edx
80103da2:	88 13                	mov    %dl,(%ebx)
80103da4:	8d 5b 01             	lea    0x1(%ebx),%ebx
80103da7:	8d 49 01             	lea    0x1(%ecx),%ecx
    while(n-- > 0)
80103daa:	89 f2                	mov    %esi,%edx
80103dac:	8d 72 ff             	lea    -0x1(%edx),%esi
80103daf:	85 d2                	test   %edx,%edx
80103db1:	75 ec                	jne    80103d9f <memmove+0x34>
...
80103db5:	5d                   	pop    %ebp
80103db6:	c3                   	ret    
80103db7:	89 c3                	mov    %eax,%ebx
80103db9:	eb f1                	jmp    80103dac <memmove+0x41>
80103dbb:	89 c3                	mov    %eax,%ebx
80103dbd:	eb ed                	jmp    80103dac <memmove+0x41>
...
80103dc2:	ff 75 10             	pushl  0x10(%ebp)
80103dc5:	ff 75 0c             	pushl  0xc(%ebp)
80103dc8:	ff 75 08             	pushl  0x8(%ebp)
80103dcb:	e8 9b ff ff ff       	call   80103d6b <memmove>
}
80103dd0:	c9                   	leave  
80103dd1:	c3                   	ret    
...
80103dd9:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80103ddc:	8b 45 10             	mov    0x10(%ebp),%eax
  while(n > 0 && *p && *p == *q)
80103ddf:	eb 09                	jmp    80103dea <strncmp+0x18>
    n--, p++, q++;
80103de1:	83 e8 01             	sub    $0x1,%eax
80103de4:	83 c2 01             	add    $0x1,%edx
80103de7:	83 c1 01             	add    $0x1,%ecx
  while(n > 0 && *p && *p == *q)
80103dea:	85 c0                	test   %eax,%eax
80103dec:	74 0b                	je     80103df9 <strncmp+0x27>
80103dee:	0f b6 1a             	movzbl (%edx),%ebx
80103df1:	84 db                	test   %bl,%bl
80103df3:	74 04                	je     80103df9 <strncmp+0x27>
80103df5:	3a 19                	cmp    (%ecx),%bl
80103df7:	74 e8                	je     80103de1 <strncmp+0xf>
  if(n == 0)
80103df9:	85 c0                	test   %eax,%eax
80103dfb:	74 0b                	je     80103e08 <strncmp+0x36>
    return 0;
  return (uchar)*p - (uchar)*q;
80103dfd:	0f b6 02             	movzbl (%edx),%eax
80103e00:	0f b6 11             	movzbl (%ecx),%edx
80103e03:	29 d0                	sub    %edx,%eax
}
80103e05:	5b                   	pop    %ebx
80103e06:	5d                   	pop    %ebp
80103e07:	c3                   	ret    
...
80103e0d:	eb f6                	jmp    80103e05 <strncmp+0x33>
...
80103e15:	8b 5d 0c             	mov    0xc(%ebp),%ebx
...
80103e1e:	eb 04                	jmp    80103e24 <strncpy+0x15>
80103e20:	89 fb                	mov    %edi,%ebx
80103e22:	89 f0                	mov    %esi,%eax
80103e24:	8d 51 ff             	lea    -0x1(%ecx),%edx
80103e27:	85 c9                	test   %ecx,%ecx
80103e29:	7e 1d                	jle    80103e48 <strncpy+0x39>
80103e2b:	8d 7b 01             	lea    0x1(%ebx),%edi
80103e2e:	8d 70 01             	lea    0x1(%eax),%esi
80103e31:	0f b6 1b             	movzbl (%ebx),%ebx
80103e34:	88 18                	mov    %bl,(%eax)
80103e36:	89 d1                	mov    %edx,%ecx
80103e38:	84 db                	test   %bl,%bl
80103e3a:	75 e4                	jne    80103e20 <strncpy+0x11>
80103e3c:	89 f0                	mov    %esi,%eax
80103e3e:	eb 08                	jmp    80103e48 <strncpy+0x39>
    ;
  while(n-- > 0)
    *s++ = 0;
80103e40:	c6 00 00             	movb   $0x0,(%eax)
  while(n-- > 0)
80103e43:	89 ca                	mov    %ecx,%edx
    *s++ = 0;
80103e45:	8d 40 01             	lea    0x1(%eax),%eax
  while(n-- > 0)
80103e48:	8d 4a ff             	lea    -0x1(%edx),%ecx
80103e4b:	85 d2                	test   %edx,%edx
80103e4d:	7f f1                	jg     80103e40 <strncpy+0x31>
  return os;
}
...
80103e63:	8b 55 10             	mov    0x10(%ebp),%edx
  ...
  os = s;
  if(n <= 0)
80103e66:	85 d2                	test   %edx,%edx
80103e68:	7e 23                	jle    80103e8d <safestrcpy+0x36>
80103e6a:	89 c1                	mov    %eax,%ecx
80103e6c:	eb 04                	jmp    80103e72 <safestrcpy+0x1b>
    return os;
  while(--n > 0 && (*s++ = *t++) != 0)
80103e6e:	89 fb                	mov    %edi,%ebx
80103e70:	89 f1                	mov    %esi,%ecx
80103e72:	83 ea 01             	sub    $0x1,%edx
80103e75:	85 d2                	test   %edx,%edx
80103e77:	7e 11                	jle    80103e8a <safestrcpy+0x33>
80103e79:	8d 7b 01             	lea    0x1(%ebx),%edi
80103e7c:	8d 71 01             	lea    0x1(%ecx),%esi
80103e7f:	0f b6 1b             	movzbl (%ebx),%ebx
80103e82:	88 19                	mov    %bl,(%ecx)
80103e84:	84 db                	test   %bl,%bl
80103e86:	75 e6                	jne    80103e6e <safestrcpy+0x17>
80103e88:	89 f1                	mov    %esi,%ecx
    ;
  *s = 0;
...
80103e9d:	eb 03                	jmp    80103ea2 <strlen+0x10>
80103e9f:	83 c0 01             	add    $0x1,%eax
80103ea2:	80 3c 02 00          	cmpb   $0x0,(%edx,%eax,1)
80103ea6:	75 f7                	jne    80103e9f <strlen+0xd>
    ;
  return n;
}
80103ea8:	5d                   	pop    %ebp
...
swtch:
  movl 4(%esp), %eax
80103eaa:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
80103eae:	8b 54 24 08          	mov    0x8(%esp),%edx
...
80103eb5:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
80103eb6:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
80103eb8:	89 d4                	mov    %edx,%esp
...
80103ec6:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80103ec9:	e8 5d f3 ff ff       	call   8010322b <myproc>

  if(addr >= curproc->sz || addr+4 > curproc->sz)
80103ece:	8b 00                	mov    (%eax),%eax
80103ed0:	39 d8                	cmp    %ebx,%eax
80103ed2:	76 19                	jbe    80103eed <fetchint+0x2e>
80103ed4:	8d 53 04             	lea    0x4(%ebx),%edx
80103ed7:	39 d0                	cmp    %edx,%eax
80103ed9:	72 19                	jb     80103ef4 <fetchint+0x35>
    return -1;
  *ip = *(int*)(addr);
80103edb:	8b 13                	mov    (%ebx),%edx
80103edd:	8b 45 0c             	mov    0xc(%ebp),%eax
80103ee0:	89 10                	mov    %edx,(%eax)
  return 0;
80103ee2:	b8 00 00 00 00       	mov    $0x0,%eax
}
80103ee7:	83 c4 04             	add    $0x4,%esp
80103eea:	5b                   	pop    %ebx
80103eeb:	5d                   	pop    %ebp
80103eec:	c3                   	ret    
    return -1;
80103eed:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103ef2:	eb f3                	jmp    80103ee7 <fetchint+0x28>
80103ef4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103ef9:	eb ec                	jmp    80103ee7 <fetchint+0x28>
...
80103f02:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80103f05:	e8 21 f3 ff ff       	call   8010322b <myproc>

  if(addr >= curproc->sz)
80103f0a:	39 18                	cmp    %ebx,(%eax)
80103f0c:	76 26                	jbe    80103f34 <fetchstr+0x39>
    return -1;
  *pp = (char*)addr;
80103f0e:	8b 55 0c             	mov    0xc(%ebp),%edx
80103f11:	89 1a                	mov    %ebx,(%edx)
  ep = (char*)curproc->sz;
80103f13:	8b 10                	mov    (%eax),%edx
  for(s = *pp; s < ep; s++){
80103f15:	89 d8                	mov    %ebx,%eax
80103f17:	39 d0                	cmp    %edx,%eax
80103f19:	73 0e                	jae    80103f29 <fetchstr+0x2e>
    if(*s == 0)
80103f1b:	80 38 00             	cmpb   $0x0,(%eax)
80103f1e:	74 05                	je     80103f25 <fetchstr+0x2a>
  for(s = *pp; s < ep; s++){
80103f20:	83 c0 01             	add    $0x1,%eax
80103f23:	eb f2                	jmp    80103f17 <fetchstr+0x1c>
      return s - *pp;
80103f25:	29 d8                	sub    %ebx,%eax
80103f27:	eb 05                	jmp    80103f2e <fetchstr+0x33>
  }
  return -1;
...
80103f39:	eb f3                	jmp    80103f2e <fetchstr+0x33>
...
80103f41:	e8 e5 f2 ff ff       	call   8010322b <myproc>
80103f46:	8b 50 18             	mov    0x18(%eax),%edx
80103f49:	8b 45 08             	mov    0x8(%ebp),%eax
80103f4c:	c1 e0 02             	shl    $0x2,%eax
80103f4f:	03 42 44             	add    0x44(%edx),%eax
80103f52:	83 ec 08             	sub    $0x8,%esp
80103f55:	ff 75 0c             	pushl  0xc(%ebp)
80103f58:	83 c0 04             	add    $0x4,%eax
80103f5b:	50                   	push   %eax
80103f5c:	e8 5e ff ff ff       	call   80103ebf <fetchint>
}
80103f61:	c9                   	leave  
80103f62:	c3                   	ret    
...
80103f6b:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80103f6e:	e8 b8 f2 ff ff       	call   8010322b <myproc>
80103f73:	89 c6                	mov    %eax,%esi
 
  if(argint(n, &i) < 0)
80103f75:	83 ec 08             	sub    $0x8,%esp
80103f78:	8d 45 f4             	lea    -0xc(%ebp),%eax
80103f7b:	50                   	push   %eax
80103f7c:	ff 75 08             	pushl  0x8(%ebp)
80103f7f:	e8 b7 ff ff ff       	call   80103f3b <argint>
80103f84:	83 c4 10             	add    $0x10,%esp
80103f87:	85 c0                	test   %eax,%eax
80103f89:	78 24                	js     80103faf <argptr+0x4c>
    return -1;
  if(size < 0 || (uint)i >= curproc->sz || (uint)i+size > curproc->sz)
80103f8b:	85 db                	test   %ebx,%ebx
80103f8d:	78 27                	js     80103fb6 <argptr+0x53>
80103f8f:	8b 16                	mov    (%esi),%edx
80103f91:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103f94:	39 c2                	cmp    %eax,%edx
80103f96:	76 25                	jbe    80103fbd <argptr+0x5a>
80103f98:	01 c3                	add    %eax,%ebx
80103f9a:	39 da                	cmp    %ebx,%edx
80103f9c:	72 26                	jb     80103fc4 <argptr+0x61>
    return -1;
  *pp = (char*)i;
80103f9e:	8b 55 0c             	mov    0xc(%ebp),%edx
80103fa1:	89 02                	mov    %eax,(%edx)
  return 0;
...
80103fb4:	eb f2                	jmp    80103fa8 <argptr+0x45>
    return -1;
80103fb6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103fbb:	eb eb                	jmp    80103fa8 <argptr+0x45>
80103fbd:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103fc2:	eb e4                	jmp    80103fa8 <argptr+0x45>
80103fc4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103fc9:	eb dd                	jmp    80103fa8 <argptr+0x45>
...
80103fce:	83 ec 20             	sub    $0x20,%esp
  int addr;
  if(argint(n, &addr) < 0)
80103fd1:	8d 45 f4             	lea    -0xc(%ebp),%eax
80103fd4:	50                   	push   %eax
80103fd5:	ff 75 08             	pushl  0x8(%ebp)
80103fd8:	e8 5e ff ff ff       	call   80103f3b <argint>
80103fdd:	83 c4 10             	add    $0x10,%esp
80103fe0:	85 c0                	test   %eax,%eax
80103fe2:	78 13                	js     80103ff7 <argstr+0x2c>
    return -1;
  return fetchstr(addr, pp);
80103fe4:	83 ec 08             	sub    $0x8,%esp
80103fe7:	ff 75 0c             	pushl  0xc(%ebp)
80103fea:	ff 75 f4             	pushl  -0xc(%ebp)
80103fed:	e8 09 ff ff ff       	call   80103efb <fetchstr>
...
80103ffc:	eb f7                	jmp    80103ff5 <argstr+0x2a>
...
80104002:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104005:	e8 21 f2 ff ff       	call   8010322b <myproc>
8010400a:	89 c3                	mov    %eax,%ebx

  num = curproc->tf->eax;
8010400c:	8b 40 18             	mov    0x18(%eax),%eax
8010400f:	8b 40 1c             	mov    0x1c(%eax),%eax
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104012:	8d 50 ff             	lea    -0x1(%eax),%edx
80104015:	83 fa 15             	cmp    $0x15,%edx
80104018:	77 18                	ja     80104032 <syscall+0x34>
8010401a:	8b 14 85 20 6c 10 80 	mov    -0x7fef93e0(,%eax,4),%edx
80104021:	85 d2                	test   %edx,%edx
80104023:	74 0d                	je     80104032 <syscall+0x34>
    curproc->tf->eax = syscalls[num]();
80104025:	ff d2                	call   *%edx
80104027:	8b 53 18             	mov    0x18(%ebx),%edx
8010402a:	89 42 1c             	mov    %eax,0x1c(%edx)
  } else {
...
80104031:	c3                   	ret    
            curproc->pid, curproc->name, num);
80104032:	8d 53 6c             	lea    0x6c(%ebx),%edx
    cprintf("%d %s: unknown sys call %d\n",
80104035:	50                   	push   %eax
80104036:	52                   	push   %edx
80104037:	ff 73 10             	pushl  0x10(%ebx)
8010403a:	68 f1 6b 10 80       	push   $0x80106bf1
8010403f:	e8 c7 c5 ff ff       	call   8010060b <cprintf>
    curproc->tf->eax = -1;
80104044:	8b 43 18             	mov    0x18(%ebx),%eax
80104047:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
8010404e:	83 c4 10             	add    $0x10,%esp
}
80104051:	eb da                	jmp    8010402d <syscall+0x2f>
...
8010405b:	89 d6                	mov    %edx,%esi
8010405d:	89 cb                	mov    %ecx,%ebx
  int fd;
  struct file *f;

  if(argint(n, &fd) < 0)
8010405f:	8d 55 f4             	lea    -0xc(%ebp),%edx
80104062:	52                   	push   %edx
80104063:	50                   	push   %eax
80104064:	e8 d2 fe ff ff       	call   80103f3b <argint>
80104069:	83 c4 10             	add    $0x10,%esp
8010406c:	85 c0                	test   %eax,%eax
8010406e:	78 2e                	js     8010409e <argfd+0x4b>
    return -1;
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
80104070:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80104074:	77 2f                	ja     801040a5 <argfd+0x52>
80104076:	e8 b0 f1 ff ff       	call   8010322b <myproc>
8010407b:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010407e:	8b 44 90 28          	mov    0x28(%eax,%edx,4),%eax
80104082:	85 c0                	test   %eax,%eax
80104084:	74 26                	je     801040ac <argfd+0x59>
    return -1;
  if(pfd)
80104086:	85 f6                	test   %esi,%esi
80104088:	74 02                	je     8010408c <argfd+0x39>
    *pfd = fd;
8010408a:	89 16                	mov    %edx,(%esi)
  if(pf)
8010408c:	85 db                	test   %ebx,%ebx
8010408e:	74 23                	je     801040b3 <argfd+0x60>
    *pf = f;
80104090:	89 03                	mov    %eax,(%ebx)
  return 0;
80104092:	b8 00 00 00 00       	mov    $0x0,%eax
}
80104097:	8d 65 f8             	lea    -0x8(%ebp),%esp
8010409a:	5b                   	pop    %ebx
8010409b:	5e                   	pop    %esi
8010409c:	5d                   	pop    %ebp
8010409d:	c3                   	ret    
...
801040a3:	eb f2                	jmp    80104097 <argfd+0x44>
    return -1;
801040a5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801040aa:	eb eb                	jmp    80104097 <argfd+0x44>
801040ac:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801040b1:	eb e4                	jmp    80104097 <argfd+0x44>
  return 0;
801040b3:	b8 00 00 00 00       	mov    $0x0,%eax
801040b8:	eb dd                	jmp    80104097 <argfd+0x44>
...
801040c1:	89 c3                	mov    %eax,%ebx
  int fd;
  struct proc *curproc = myproc();
801040c3:	e8 63 f1 ff ff       	call   8010322b <myproc>

  for(fd = 0; fd < NOFILE; fd++){
801040c8:	ba 00 00 00 00       	mov    $0x0,%edx
801040cd:	83 fa 0f             	cmp    $0xf,%edx
801040d0:	7f 18                	jg     801040ea <fdalloc+0x30>
    if(curproc->ofile[fd] == 0){
801040d2:	83 7c 90 28 00       	cmpl   $0x0,0x28(%eax,%edx,4)
801040d7:	74 05                	je     801040de <fdalloc+0x24>
  for(fd = 0; fd < NOFILE; fd++){
801040d9:	83 c2 01             	add    $0x1,%edx
801040dc:	eb ef                	jmp    801040cd <fdalloc+0x13>
      curproc->ofile[fd] = f;
801040de:	89 5c 90 28          	mov    %ebx,0x28(%eax,%edx,4)
      return fd;
    }
  }
  return -1;
}
801040e2:	89 d0                	mov    %edx,%eax
801040e4:	83 c4 04             	add    $0x4,%esp
801040e7:	5b                   	pop    %ebx
801040e8:	5d                   	pop    %ebp
801040e9:	c3                   	ret    
  return -1;
801040ea:	ba ff ff ff ff       	mov    $0xffffffff,%edx
801040ef:	eb f1                	jmp    801040e2 <fdalloc+0x28>
...
8010410f:	e8 5f d6 ff ff       	call   80101773 <readi>
...
8010412b:	68 7c 6c 10 80       	push   $0x80106c7c
...
8010414e:	83 ec 44             	sub    $0x44,%esp
80104151:	89 55 c4             	mov    %edx,-0x3c(%ebp)
80104154:	89 4d c0             	mov    %ecx,-0x40(%ebp)
...
8010415a:	8d 55 d6             	lea    -0x2a(%ebp),%edx
8010415d:	52                   	push   %edx
8010415e:	50                   	push   %eax
8010415f:	e8 95 da ff ff       	call   80101bf9 <nameiparent>
80104164:	89 c6                	mov    %eax,%esi
80104166:	83 c4 10             	add    $0x10,%esp
80104169:	85 c0                	test   %eax,%eax
8010416b:	0f 84 3a 01 00 00    	je     801042ab <create+0x163>
    return 0;
  ilock(dp);
80104171:	83 ec 0c             	sub    $0xc,%esp
80104174:	50                   	push   %eax
80104175:	e8 07 d4 ff ff       	call   80101581 <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
8010417a:	83 c4 0c             	add    $0xc,%esp
8010417d:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80104180:	50                   	push   %eax
80104181:	8d 45 d6             	lea    -0x2a(%ebp),%eax
80104184:	50                   	push   %eax
80104185:	56                   	push   %esi
80104186:	e8 25 d8 ff ff       	call   801019b0 <dirlookup>
8010418b:	89 c3                	mov    %eax,%ebx
8010418d:	83 c4 10             	add    $0x10,%esp
80104190:	85 c0                	test   %eax,%eax
80104192:	74 3f                	je     801041d3 <create+0x8b>
    iunlockput(dp);
80104194:	83 ec 0c             	sub    $0xc,%esp
80104197:	56                   	push   %esi
80104198:	e8 8b d5 ff ff       	call   80101728 <iunlockput>
    ilock(ip);
8010419d:	89 1c 24             	mov    %ebx,(%esp)
801041a0:	e8 dc d3 ff ff       	call   80101581 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
801041a5:	83 c4 10             	add    $0x10,%esp
801041a8:	66 83 7d c4 02       	cmpw   $0x2,-0x3c(%ebp)
801041ad:	75 11                	jne    801041c0 <create+0x78>
801041af:	66 83 7b 50 02       	cmpw   $0x2,0x50(%ebx)
801041b4:	75 0a                	jne    801041c0 <create+0x78>
...
801041cc:	bb 00 00 00 00       	mov    $0x0,%ebx
801041d1:	eb e3                	jmp    801041b6 <create+0x6e>
  if((ip = ialloc(dp->dev, type)) == 0)
801041d3:	0f bf 45 c4          	movswl -0x3c(%ebp),%eax
801041d7:	83 ec 08             	sub    $0x8,%esp
801041da:	50                   	push   %eax
801041db:	ff 36                	pushl  (%esi)
801041dd:	e8 9c d1 ff ff       	call   8010137e <ialloc>
801041e2:	89 c3                	mov    %eax,%ebx
801041e4:	83 c4 10             	add    $0x10,%esp
801041e7:	85 c0                	test   %eax,%eax
801041e9:	74 55                	je     80104240 <create+0xf8>
  ilock(ip);
801041eb:	83 ec 0c             	sub    $0xc,%esp
801041ee:	50                   	push   %eax
801041ef:	e8 8d d3 ff ff       	call   80101581 <ilock>
  ip->major = major;
801041f4:	0f b7 45 c0          	movzwl -0x40(%ebp),%eax
801041f8:	66 89 43 52          	mov    %ax,0x52(%ebx)
  ip->minor = minor;
801041fc:	66 89 7b 54          	mov    %di,0x54(%ebx)
  ip->nlink = 1;
80104200:	66 c7 43 56 01 00    	movw   $0x1,0x56(%ebx)
  iupdate(ip);
80104206:	89 1c 24             	mov    %ebx,(%esp)
80104209:	e8 12 d2 ff ff       	call   80101420 <iupdate>
  if(type == T_DIR){  // Create . and .. entries.
8010420e:	83 c4 10             	add    $0x10,%esp
80104211:	66 83 7d c4 01       	cmpw   $0x1,-0x3c(%ebp)
80104216:	74 35                	je     8010424d <create+0x105>
  if(dirlink(dp, name, ip->inum) < 0)
80104218:	83 ec 04             	sub    $0x4,%esp
8010421b:	ff 73 04             	pushl  0x4(%ebx)
8010421e:	8d 45 d6             	lea    -0x2a(%ebp),%eax
80104221:	50                   	push   %eax
80104222:	56                   	push   %esi
80104223:	e8 08 d9 ff ff       	call   80101b30 <dirlink>
80104228:	83 c4 10             	add    $0x10,%esp
8010422b:	85 c0                	test   %eax,%eax
8010422d:	78 6f                	js     8010429e <create+0x156>
  iunlockput(dp);
8010422f:	83 ec 0c             	sub    $0xc,%esp
80104232:	56                   	push   %esi
80104233:	e8 f0 d4 ff ff       	call   80101728 <iunlockput>
  return ip;
80104238:	83 c4 10             	add    $0x10,%esp
8010423b:	e9 76 ff ff ff       	jmp    801041b6 <create+0x6e>
    panic("create: ialloc");
80104240:	83 ec 0c             	sub    $0xc,%esp
80104243:	68 8e 6c 10 80       	push   $0x80106c8e
80104248:	e8 fb c0 ff ff       	call   80100348 <panic>
    dp->nlink++;  // for ".."
8010424d:	0f b7 46 56          	movzwl 0x56(%esi),%eax
80104251:	83 c0 01             	add    $0x1,%eax
80104254:	66 89 46 56          	mov    %ax,0x56(%esi)
    iupdate(dp);
80104258:	83 ec 0c             	sub    $0xc,%esp
8010425b:	56                   	push   %esi
8010425c:	e8 bf d1 ff ff       	call   80101420 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104261:	83 c4 0c             	add    $0xc,%esp
80104264:	ff 73 04             	pushl  0x4(%ebx)
80104267:	68 9e 6c 10 80       	push   $0x80106c9e
8010426c:	53                   	push   %ebx
8010426d:	e8 be d8 ff ff       	call   80101b30 <dirlink>
80104272:	83 c4 10             	add    $0x10,%esp
80104275:	85 c0                	test   %eax,%eax
80104277:	78 18                	js     80104291 <create+0x149>
80104279:	83 ec 04             	sub    $0x4,%esp
8010427c:	ff 76 04             	pushl  0x4(%esi)
8010427f:	68 9d 6c 10 80       	push   $0x80106c9d
80104284:	53                   	push   %ebx
80104285:	e8 a6 d8 ff ff       	call   80101b30 <dirlink>
8010428a:	83 c4 10             	add    $0x10,%esp
8010428d:	85 c0                	test   %eax,%eax
8010428f:	79 87                	jns    80104218 <create+0xd0>
      panic("create dots");
80104291:	83 ec 0c             	sub    $0xc,%esp
80104294:	68 a0 6c 10 80       	push   $0x80106ca0
80104299:	e8 aa c0 ff ff       	call   80100348 <panic>
    panic("create: dirlink");
8010429e:	83 ec 0c             	sub    $0xc,%esp
801042a1:	68 ac 6c 10 80       	push   $0x80106cac
801042a6:	e8 9d c0 ff ff       	call   80100348 <panic>
    return 0;
801042ab:	89 c3                	mov    %eax,%ebx
801042ad:	e9 04 ff ff ff       	jmp    801041b6 <create+0x6e>
...
801042b6:	83 ec 14             	sub    $0x14,%esp
  if(argfd(0, 0, &f) < 0)
801042b9:	8d 4d f4             	lea    -0xc(%ebp),%ecx
801042bc:	ba 00 00 00 00       	mov    $0x0,%edx
801042c1:	b8 00 00 00 00       	mov    $0x0,%eax
801042c6:	e8 88 fd ff ff       	call   80104053 <argfd>
801042cb:	85 c0                	test   %eax,%eax
801042cd:	78 23                	js     801042f2 <sys_dup+0x40>
  if((fd=fdalloc(f)) < 0)
801042cf:	8b 45 f4             	mov    -0xc(%ebp),%eax
801042d2:	e8 e3 fd ff ff       	call   801040ba <fdalloc>
801042d7:	89 c3                	mov    %eax,%ebx
801042d9:	85 c0                	test   %eax,%eax
801042db:	78 1c                	js     801042f9 <sys_dup+0x47>
  filedup(f);
801042dd:	83 ec 0c             	sub    $0xc,%esp
801042e0:	ff 75 f4             	pushl  -0xc(%ebp)
801042e3:	e8 a6 c9 ff ff       	call   80100c8e <filedup>
  return fd;
...
801042f7:	eb f2                	jmp    801042eb <sys_dup+0x39>
    return -1;
801042f9:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
801042fe:	eb eb                	jmp    801042eb <sys_dup+0x39>
...
80104306:	8d 4d f4             	lea    -0xc(%ebp),%ecx
80104309:	ba 00 00 00 00       	mov    $0x0,%edx
8010430e:	b8 00 00 00 00       	mov    $0x0,%eax
80104313:	e8 3b fd ff ff       	call   80104053 <argfd>
80104318:	85 c0                	test   %eax,%eax
8010431a:	78 43                	js     8010435f <sys_read+0x5f>
8010431c:	83 ec 08             	sub    $0x8,%esp
8010431f:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104322:	50                   	push   %eax
80104323:	6a 02                	push   $0x2
80104325:	e8 11 fc ff ff       	call   80103f3b <argint>
8010432a:	83 c4 10             	add    $0x10,%esp
8010432d:	85 c0                	test   %eax,%eax
8010432f:	78 35                	js     80104366 <sys_read+0x66>
80104331:	83 ec 04             	sub    $0x4,%esp
80104334:	ff 75 f0             	pushl  -0x10(%ebp)
80104337:	8d 45 ec             	lea    -0x14(%ebp),%eax
8010433a:	50                   	push   %eax
8010433b:	6a 01                	push   $0x1
8010433d:	e8 21 fc ff ff       	call   80103f63 <argptr>
80104342:	83 c4 10             	add    $0x10,%esp
80104345:	85 c0                	test   %eax,%eax
80104347:	78 24                	js     8010436d <sys_read+0x6d>
  return fileread(f, p, n);
80104349:	83 ec 04             	sub    $0x4,%esp
8010434c:	ff 75 f0             	pushl  -0x10(%ebp)
8010434f:	ff 75 ec             	pushl  -0x14(%ebp)
80104352:	ff 75 f4             	pushl  -0xc(%ebp)
80104355:	e8 7d ca ff ff       	call   80100dd7 <fileread>
...
80104364:	eb f7                	jmp    8010435d <sys_read+0x5d>
80104366:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010436b:	eb f0                	jmp    8010435d <sys_read+0x5d>
8010436d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104372:	eb e9                	jmp    8010435d <sys_read+0x5d>
...
80104377:	83 ec 18             	sub    $0x18,%esp
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argptr(1, &p, n) < 0)
8010437a:	8d 4d f4             	lea    -0xc(%ebp),%ecx
8010437d:	ba 00 00 00 00       	mov    $0x0,%edx
80104382:	b8 00 00 00 00       	mov    $0x0,%eax
80104387:	e8 c7 fc ff ff       	call   80104053 <argfd>
8010438c:	85 c0                	test   %eax,%eax
8010438e:	78 43                	js     801043d3 <sys_write+0x5f>
80104390:	83 ec 08             	sub    $0x8,%esp
80104393:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104396:	50                   	push   %eax
80104397:	6a 02                	push   $0x2
80104399:	e8 9d fb ff ff       	call   80103f3b <argint>
8010439e:	83 c4 10             	add    $0x10,%esp
801043a1:	85 c0                	test   %eax,%eax
801043a3:	78 35                	js     801043da <sys_write+0x66>
801043a5:	83 ec 04             	sub    $0x4,%esp
801043a8:	ff 75 f0             	pushl  -0x10(%ebp)
801043ab:	8d 45 ec             	lea    -0x14(%ebp),%eax
801043ae:	50                   	push   %eax
801043af:	6a 01                	push   $0x1
801043b1:	e8 ad fb ff ff       	call   80103f63 <argptr>
801043b6:	83 c4 10             	add    $0x10,%esp
801043b9:	85 c0                	test   %eax,%eax
801043bb:	78 24                	js     801043e1 <sys_write+0x6d>
  return filewrite(f, p, n);
801043bd:	83 ec 04             	sub    $0x4,%esp
801043c0:	ff 75 f0             	pushl  -0x10(%ebp)
801043c3:	ff 75 ec             	pushl  -0x14(%ebp)
801043c6:	ff 75 f4             	pushl  -0xc(%ebp)
801043c9:	e8 8e ca ff ff       	call   80100e5c <filewrite>
...
801043d8:	eb f7                	jmp    801043d1 <sys_write+0x5d>
801043da:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801043df:	eb f0                	jmp    801043d1 <sys_write+0x5d>
801043e1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801043e6:	eb e9                	jmp    801043d1 <sys_write+0x5d>
...
801043eb:	83 ec 18             	sub    $0x18,%esp
  if(argfd(0, &fd, &f) < 0)
801043ee:	8d 4d f0             	lea    -0x10(%ebp),%ecx
801043f1:	8d 55 f4             	lea    -0xc(%ebp),%edx
801043f4:	b8 00 00 00 00       	mov    $0x0,%eax
801043f9:	e8 55 fc ff ff       	call   80104053 <argfd>
801043fe:	85 c0                	test   %eax,%eax
80104400:	78 25                	js     80104427 <sys_close+0x3f>
  myproc()->ofile[fd] = 0;
80104402:	e8 24 ee ff ff       	call   8010322b <myproc>
80104407:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010440a:	c7 44 90 28 00 00 00 	movl   $0x0,0x28(%eax,%edx,4)
80104411:	00 
  fileclose(f);
80104412:	83 ec 0c             	sub    $0xc,%esp
80104415:	ff 75 f0             	pushl  -0x10(%ebp)
80104418:	e8 b6 c8 ff ff       	call   80100cd3 <fileclose>
  return 0;
...
8010442c:	eb f7                	jmp    80104425 <sys_close+0x3d>
...
80104441:	e8 0d fc ff ff       	call   80104053 <argfd>
80104446:	85 c0                	test   %eax,%eax
80104448:	78 2a                	js     80104474 <sys_fstat+0x46>
8010444a:	83 ec 04             	sub    $0x4,%esp
8010444d:	6a 14                	push   $0x14
8010444f:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104452:	50                   	push   %eax
80104453:	6a 01                	push   $0x1
80104455:	e8 09 fb ff ff       	call   80103f63 <argptr>
8010445a:	83 c4 10             	add    $0x10,%esp
8010445d:	85 c0                	test   %eax,%eax
8010445f:	78 1a                	js     8010447b <sys_fstat+0x4d>
  return filestat(f, st);
80104461:	83 ec 08             	sub    $0x8,%esp
80104464:	ff 75 f0             	pushl  -0x10(%ebp)
80104467:	ff 75 f4             	pushl  -0xc(%ebp)
8010446a:	e8 21 c9 ff ff       	call   80100d90 <filestat>
...
80104479:	eb f7                	jmp    80104472 <sys_fstat+0x44>
8010447b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104480:	eb f0                	jmp    80104472 <sys_fstat+0x44>
...
80104487:	83 ec 28             	sub    $0x28,%esp
  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
8010448a:	8d 45 e0             	lea    -0x20(%ebp),%eax
8010448d:	50                   	push   %eax
8010448e:	6a 00                	push   $0x0
80104490:	e8 36 fb ff ff       	call   80103fcb <argstr>
80104495:	83 c4 10             	add    $0x10,%esp
80104498:	85 c0                	test   %eax,%eax
8010449a:	0f 88 32 01 00 00    	js     801045d2 <sys_link+0x150>
801044a0:	83 ec 08             	sub    $0x8,%esp
801044a3:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801044a6:	50                   	push   %eax
801044a7:	6a 01                	push   $0x1
801044a9:	e8 1d fb ff ff       	call   80103fcb <argstr>
801044ae:	83 c4 10             	add    $0x10,%esp
801044b1:	85 c0                	test   %eax,%eax
801044b3:	0f 88 20 01 00 00    	js     801045d9 <sys_link+0x157>
  begin_op();
801044b9:	e8 f0 e2 ff ff       	call   801027ae <begin_op>
  if((ip = namei(old)) == 0){
801044be:	83 ec 0c             	sub    $0xc,%esp
801044c1:	ff 75 e0             	pushl  -0x20(%ebp)
801044c4:	e8 18 d7 ff ff       	call   80101be1 <namei>
801044c9:	89 c3                	mov    %eax,%ebx
801044cb:	83 c4 10             	add    $0x10,%esp
801044ce:	85 c0                	test   %eax,%eax
801044d0:	0f 84 99 00 00 00    	je     8010456f <sys_link+0xed>
  ilock(ip);
801044d6:	83 ec 0c             	sub    $0xc,%esp
801044d9:	50                   	push   %eax
801044da:	e8 a2 d0 ff ff       	call   80101581 <ilock>
  if(ip->type == T_DIR){
801044df:	83 c4 10             	add    $0x10,%esp
801044e2:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
801044e7:	0f 84 8e 00 00 00    	je     8010457b <sys_link+0xf9>
  ip->nlink++;
801044ed:	0f b7 43 56          	movzwl 0x56(%ebx),%eax
801044f1:	83 c0 01             	add    $0x1,%eax
801044f4:	66 89 43 56          	mov    %ax,0x56(%ebx)
  iupdate(ip);
801044f8:	83 ec 0c             	sub    $0xc,%esp
801044fb:	53                   	push   %ebx
801044fc:	e8 1f cf ff ff       	call   80101420 <iupdate>
  iunlock(ip);
80104501:	89 1c 24             	mov    %ebx,(%esp)
80104504:	e8 3a d1 ff ff       	call   80101643 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80104509:	83 c4 08             	add    $0x8,%esp
8010450c:	8d 45 ea             	lea    -0x16(%ebp),%eax
8010450f:	50                   	push   %eax
80104510:	ff 75 e4             	pushl  -0x1c(%ebp)
80104513:	e8 e1 d6 ff ff       	call   80101bf9 <nameiparent>
80104518:	89 c6                	mov    %eax,%esi
8010451a:	83 c4 10             	add    $0x10,%esp
8010451d:	85 c0                	test   %eax,%eax
8010451f:	74 7e                	je     8010459f <sys_link+0x11d>
  ilock(dp);
80104521:	83 ec 0c             	sub    $0xc,%esp
80104524:	50                   	push   %eax
80104525:	e8 57 d0 ff ff       	call   80101581 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
8010452a:	83 c4 10             	add    $0x10,%esp
8010452d:	8b 03                	mov    (%ebx),%eax
8010452f:	39 06                	cmp    %eax,(%esi)
80104531:	75 60                	jne    80104593 <sys_link+0x111>
80104533:	83 ec 04             	sub    $0x4,%esp
80104536:	ff 73 04             	pushl  0x4(%ebx)
80104539:	8d 45 ea             	lea    -0x16(%ebp),%eax
8010453c:	50                   	push   %eax
8010453d:	56                   	push   %esi
8010453e:	e8 ed d5 ff ff       	call   80101b30 <dirlink>
80104543:	83 c4 10             	add    $0x10,%esp
80104546:	85 c0                	test   %eax,%eax
80104548:	78 49                	js     80104593 <sys_link+0x111>
  iunlockput(dp);
8010454a:	83 ec 0c             	sub    $0xc,%esp
8010454d:	56                   	push   %esi
8010454e:	e8 d5 d1 ff ff       	call   80101728 <iunlockput>
  iput(ip);
80104553:	89 1c 24             	mov    %ebx,(%esp)
80104556:	e8 2d d1 ff ff       	call   80101688 <iput>
  end_op();
8010455b:	e8 c8 e2 ff ff       	call   80102828 <end_op>
  return 0;
...
8010456e:	c3                   	ret    
    end_op();
8010456f:	e8 b4 e2 ff ff       	call   80102828 <end_op>
    return -1;
80104574:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104579:	eb ed                	jmp    80104568 <sys_link+0xe6>
    iunlockput(ip);
8010457b:	83 ec 0c             	sub    $0xc,%esp
8010457e:	53                   	push   %ebx
8010457f:	e8 a4 d1 ff ff       	call   80101728 <iunlockput>
    end_op();
80104584:	e8 9f e2 ff ff       	call   80102828 <end_op>
    return -1;
80104589:	83 c4 10             	add    $0x10,%esp
8010458c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104591:	eb d5                	jmp    80104568 <sys_link+0xe6>
    iunlockput(dp);
80104593:	83 ec 0c             	sub    $0xc,%esp
80104596:	56                   	push   %esi
80104597:	e8 8c d1 ff ff       	call   80101728 <iunlockput>
    goto bad;
8010459c:	83 c4 10             	add    $0x10,%esp
  ilock(ip);
8010459f:	83 ec 0c             	sub    $0xc,%esp
801045a2:	53                   	push   %ebx
801045a3:	e8 d9 cf ff ff       	call   80101581 <ilock>
  ip->nlink--;
801045a8:	0f b7 43 56          	movzwl 0x56(%ebx),%eax
801045ac:	83 e8 01             	sub    $0x1,%eax
801045af:	66 89 43 56          	mov    %ax,0x56(%ebx)
  iupdate(ip);
801045b3:	89 1c 24             	mov    %ebx,(%esp)
801045b6:	e8 65 ce ff ff       	call   80101420 <iupdate>
  iunlockput(ip);
801045bb:	89 1c 24             	mov    %ebx,(%esp)
801045be:	e8 65 d1 ff ff       	call   80101728 <iunlockput>
  end_op();
801045c3:	e8 60 e2 ff ff       	call   80102828 <end_op>
  return -1;
801045c8:	83 c4 10             	add    $0x10,%esp
801045cb:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801045d0:	eb 96                	jmp    80104568 <sys_link+0xe6>
    return -1;
801045d2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801045d7:	eb 8f                	jmp    80104568 <sys_link+0xe6>
801045d9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801045de:	eb 88                	jmp    80104568 <sys_link+0xe6>
...
801045e6:	83 ec 44             	sub    $0x44,%esp
  if(argstr(0, &path) < 0)
801045e9:	8d 45 c4             	lea    -0x3c(%ebp),%eax
801045ec:	50                   	push   %eax
801045ed:	6a 00                	push   $0x0
801045ef:	e8 d7 f9 ff ff       	call   80103fcb <argstr>
801045f4:	83 c4 10             	add    $0x10,%esp
801045f7:	85 c0                	test   %eax,%eax
801045f9:	0f 88 83 01 00 00    	js     80104782 <sys_unlink+0x1a2>
  begin_op();
801045ff:	e8 aa e1 ff ff       	call   801027ae <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80104604:	83 ec 08             	sub    $0x8,%esp
80104607:	8d 45 ca             	lea    -0x36(%ebp),%eax
8010460a:	50                   	push   %eax
8010460b:	ff 75 c4             	pushl  -0x3c(%ebp)
8010460e:	e8 e6 d5 ff ff       	call   80101bf9 <nameiparent>
80104613:	89 c6                	mov    %eax,%esi
80104615:	83 c4 10             	add    $0x10,%esp
80104618:	85 c0                	test   %eax,%eax
8010461a:	0f 84 ed 00 00 00    	je     8010470d <sys_unlink+0x12d>
  ilock(dp);
80104620:	83 ec 0c             	sub    $0xc,%esp
80104623:	50                   	push   %eax
80104624:	e8 58 cf ff ff       	call   80101581 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80104629:	83 c4 08             	add    $0x8,%esp
8010462c:	68 9e 6c 10 80       	push   $0x80106c9e
...
8010463f:	0f 84 fc 00 00 00    	je     80104741 <sys_unlink+0x161>
80104645:	83 ec 08             	sub    $0x8,%esp
80104648:	68 9d 6c 10 80       	push   $0x80106c9d
8010464d:	8d 45 ca             	lea    -0x36(%ebp),%eax
80104650:	50                   	push   %eax
80104651:	e8 45 d3 ff ff       	call   8010199b <namecmp>
80104656:	83 c4 10             	add    $0x10,%esp
80104659:	85 c0                	test   %eax,%eax
8010465b:	0f 84 e0 00 00 00    	je     80104741 <sys_unlink+0x161>
  if((ip = dirlookup(dp, name, &off)) == 0)
80104661:	83 ec 04             	sub    $0x4,%esp
80104664:	8d 45 c0             	lea    -0x40(%ebp),%eax
80104667:	50                   	push   %eax
80104668:	8d 45 ca             	lea    -0x36(%ebp),%eax
8010466b:	50                   	push   %eax
8010466c:	56                   	push   %esi
8010466d:	e8 3e d3 ff ff       	call   801019b0 <dirlookup>
80104672:	89 c3                	mov    %eax,%ebx
80104674:	83 c4 10             	add    $0x10,%esp
80104677:	85 c0                	test   %eax,%eax
80104679:	0f 84 c2 00 00 00    	je     80104741 <sys_unlink+0x161>
  ilock(ip);
8010467f:	83 ec 0c             	sub    $0xc,%esp
80104682:	50                   	push   %eax
80104683:	e8 f9 ce ff ff       	call   80101581 <ilock>
  if(ip->nlink < 1)
80104688:	83 c4 10             	add    $0x10,%esp
8010468b:	66 83 7b 56 00       	cmpw   $0x0,0x56(%ebx)
80104690:	0f 8e 83 00 00 00    	jle    80104719 <sys_unlink+0x139>
  if(ip->type == T_DIR && !isdirempty(ip)){
80104696:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
8010469b:	0f 84 85 00 00 00    	je     80104726 <sys_unlink+0x146>
  memset(&de, 0, sizeof(de));
801046a1:	83 ec 04             	sub    $0x4,%esp
801046a4:	6a 10                	push   $0x10
801046a6:	6a 00                	push   $0x0
801046a8:	8d 7d d8             	lea    -0x28(%ebp),%edi
801046ab:	57                   	push   %edi
801046ac:	e8 3f f6 ff ff       	call   80103cf0 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
801046b1:	6a 10                	push   $0x10
801046b3:	ff 75 c0             	pushl  -0x40(%ebp)
801046b6:	57                   	push   %edi
801046b7:	56                   	push   %esi
801046b8:	e8 b3 d1 ff ff       	call   80101870 <writei>
801046bd:	83 c4 20             	add    $0x20,%esp
801046c0:	83 f8 10             	cmp    $0x10,%eax
801046c3:	0f 85 90 00 00 00    	jne    80104759 <sys_unlink+0x179>
  if(ip->type == T_DIR){
801046c9:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
801046ce:	0f 84 92 00 00 00    	je     80104766 <sys_unlink+0x186>
  iunlockput(dp);
...
801046eb:	e8 30 cd ff ff       	call   80101420 <iupdate>
  iunlockput(ip);
801046f0:	89 1c 24             	mov    %ebx,(%esp)
801046f3:	e8 30 d0 ff ff       	call   80101728 <iunlockput>
  end_op();
801046f8:	e8 2b e1 ff ff       	call   80102828 <end_op>
  return 0;
801046fd:	83 c4 10             	add    $0x10,%esp
80104700:	b8 00 00 00 00       	mov    $0x0,%eax
}
...
8010470c:	c3                   	ret    
    end_op();
8010470d:	e8 16 e1 ff ff       	call   80102828 <end_op>
    return -1;
80104712:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104717:	eb ec                	jmp    80104705 <sys_unlink+0x125>
    panic("unlink: nlink < 1");
80104719:	83 ec 0c             	sub    $0xc,%esp
8010471c:	68 bc 6c 10 80       	push   $0x80106cbc
80104721:	e8 22 bc ff ff       	call   80100348 <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
80104726:	89 d8                	mov    %ebx,%eax
80104728:	e8 c4 f9 ff ff       	call   801040f1 <isdirempty>
8010472d:	85 c0                	test   %eax,%eax
8010472f:	0f 85 6c ff ff ff    	jne    801046a1 <sys_unlink+0xc1>
    iunlockput(ip);
...
80104745:	e8 de cf ff ff       	call   80101728 <iunlockput>
  end_op();
8010474a:	e8 d9 e0 ff ff       	call   80102828 <end_op>
  return -1;
8010474f:	83 c4 10             	add    $0x10,%esp
80104752:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104757:	eb ac                	jmp    80104705 <sys_unlink+0x125>
    panic("unlink: writei");
80104759:	83 ec 0c             	sub    $0xc,%esp
8010475c:	68 ce 6c 10 80       	push   $0x80106cce
80104761:	e8 e2 bb ff ff       	call   80100348 <panic>
    dp->nlink--;
80104766:	0f b7 46 56          	movzwl 0x56(%esi),%eax
8010476a:	83 e8 01             	sub    $0x1,%eax
8010476d:	66 89 46 56          	mov    %ax,0x56(%esi)
    iupdate(dp);
80104771:	83 ec 0c             	sub    $0xc,%esp
80104774:	56                   	push   %esi
80104775:	e8 a6 cc ff ff       	call   80101420 <iupdate>
8010477a:	83 c4 10             	add    $0x10,%esp
8010477d:	e9 52 ff ff ff       	jmp    801046d4 <sys_unlink+0xf4>
    return -1;
80104782:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104787:	e9 79 ff ff ff       	jmp    80104705 <sys_unlink+0x125>
...
80104792:	83 ec 24             	sub    $0x24,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
80104795:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80104798:	50                   	push   %eax
80104799:	6a 00                	push   $0x0
8010479b:	e8 2b f8 ff ff       	call   80103fcb <argstr>
801047a0:	83 c4 10             	add    $0x10,%esp
801047a3:	85 c0                	test   %eax,%eax
801047a5:	0f 88 30 01 00 00    	js     801048db <sys_open+0x14f>
801047ab:	83 ec 08             	sub    $0x8,%esp
801047ae:	8d 45 e0             	lea    -0x20(%ebp),%eax
801047b1:	50                   	push   %eax
801047b2:	6a 01                	push   $0x1
801047b4:	e8 82 f7 ff ff       	call   80103f3b <argint>
801047b9:	83 c4 10             	add    $0x10,%esp
801047bc:	85 c0                	test   %eax,%eax
801047be:	0f 88 21 01 00 00    	js     801048e5 <sys_open+0x159>
    return -1;

  begin_op();
801047c4:	e8 e5 df ff ff       	call   801027ae <begin_op>

  if(omode & O_CREATE){
801047c9:	f6 45 e1 02          	testb  $0x2,-0x1f(%ebp)
801047cd:	0f 84 84 00 00 00    	je     80104857 <sys_open+0xcb>
    ip = create(path, T_FILE, 0, 0);
801047d3:	83 ec 0c             	sub    $0xc,%esp
801047d6:	6a 00                	push   $0x0
801047d8:	b9 00 00 00 00       	mov    $0x0,%ecx
801047dd:	ba 02 00 00 00       	mov    $0x2,%edx
801047e2:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801047e5:	e8 5e f9 ff ff       	call   80104148 <create>
801047ea:	89 c6                	mov    %eax,%esi
    if(ip == 0){
801047ec:	83 c4 10             	add    $0x10,%esp
801047ef:	85 c0                	test   %eax,%eax
801047f1:	74 58                	je     8010484b <sys_open+0xbf>
      end_op();
      return -1;
    }
  }
...
801047f3:	e8 35 c4 ff ff       	call   80100c2d <filealloc>
801047f8:	89 c3                	mov    %eax,%ebx
801047fa:	85 c0                	test   %eax,%eax
801047fc:	0f 84 ae 00 00 00    	je     801048b0 <sys_open+0x124>
80104802:	e8 b3 f8 ff ff       	call   801040ba <fdalloc>
80104807:	89 c7                	mov    %eax,%edi
80104809:	85 c0                	test   %eax,%eax
8010480b:	0f 88 9f 00 00 00    	js     801048b0 <sys_open+0x124>
      fileclose(f);
    iunlockput(ip);
    end_op();
    return -1;
...
80104815:	e8 29 ce ff ff       	call   80101643 <iunlock>
  end_op();
8010481a:	e8 09 e0 ff ff       	call   80102828 <end_op>

  f->type = FD_INODE;
8010481f:	c7 03 02 00 00 00    	movl   $0x2,(%ebx)
  f->ip = ip;
80104825:	89 73 10             	mov    %esi,0x10(%ebx)
  f->off = 0;
80104828:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
  f->readable = !(omode & O_WRONLY);
8010482f:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104832:	83 c4 10             	add    $0x10,%esp
80104835:	a8 01                	test   $0x1,%al
80104837:	0f 94 43 08          	sete   0x8(%ebx)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
8010483b:	a8 03                	test   $0x3,%al
8010483d:	0f 95 43 09          	setne  0x9(%ebx)
  return fd;
}
...
8010484a:	c3                   	ret    
      end_op();
8010484b:	e8 d8 df ff ff       	call   80102828 <end_op>
      return -1;
80104850:	bf ff ff ff ff       	mov    $0xffffffff,%edi
80104855:	eb ea                	jmp    80104841 <sys_open+0xb5>
    if((ip = namei(path)) == 0){
80104857:	83 ec 0c             	sub    $0xc,%esp
8010485a:	ff 75 e4             	pushl  -0x1c(%ebp)
8010485d:	e8 7f d3 ff ff       	call   80101be1 <namei>
80104862:	89 c6                	mov    %eax,%esi
80104864:	83 c4 10             	add    $0x10,%esp
80104867:	85 c0                	test   %eax,%eax
80104869:	74 39                	je     801048a4 <sys_open+0x118>
    ilock(ip);
8010486b:	83 ec 0c             	sub    $0xc,%esp
8010486e:	50                   	push   %eax
8010486f:	e8 0d cd ff ff       	call   80101581 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80104874:	83 c4 10             	add    $0x10,%esp
80104877:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
8010487c:	0f 85 71 ff ff ff    	jne    801047f3 <sys_open+0x67>
80104882:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
80104886:	0f 84 67 ff ff ff    	je     801047f3 <sys_open+0x67>
      iunlockput(ip);
...
801048a2:	eb 9d                	jmp    80104841 <sys_open+0xb5>
      end_op();
801048a4:	e8 7f df ff ff       	call   80102828 <end_op>
      return -1;
801048a9:	bf ff ff ff ff       	mov    $0xffffffff,%edi
801048ae:	eb 91                	jmp    80104841 <sys_open+0xb5>
    if(f)
801048b0:	85 db                	test   %ebx,%ebx
801048b2:	74 0c                	je     801048c0 <sys_open+0x134>
      fileclose(f);
...
801048c4:	e8 5f ce ff ff       	call   80101728 <iunlockput>
    end_op();
801048c9:	e8 5a df ff ff       	call   80102828 <end_op>
    return -1;
801048ce:	83 c4 10             	add    $0x10,%esp
801048d1:	bf ff ff ff ff       	mov    $0xffffffff,%edi
801048d6:	e9 66 ff ff ff       	jmp    80104841 <sys_open+0xb5>
    return -1;
801048db:	bf ff ff ff ff       	mov    $0xffffffff,%edi
801048e0:	e9 5c ff ff ff       	jmp    80104841 <sys_open+0xb5>
801048e5:	bf ff ff ff ff       	mov    $0xffffffff,%edi
801048ea:	e9 52 ff ff ff       	jmp    80104841 <sys_open+0xb5>
...
801048f2:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
801048f5:	e8 b4 de ff ff       	call   801027ae <begin_op>
  if(argstr(0, &path) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
801048fa:	83 ec 08             	sub    $0x8,%esp
801048fd:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104900:	50                   	push   %eax
80104901:	6a 00                	push   $0x0
80104903:	e8 c3 f6 ff ff       	call   80103fcb <argstr>
80104908:	83 c4 10             	add    $0x10,%esp
8010490b:	85 c0                	test   %eax,%eax
8010490d:	78 36                	js     80104945 <sys_mkdir+0x56>
8010490f:	83 ec 0c             	sub    $0xc,%esp
80104912:	6a 00                	push   $0x0
80104914:	b9 00 00 00 00       	mov    $0x0,%ecx
80104919:	ba 01 00 00 00       	mov    $0x1,%edx
8010491e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104921:	e8 22 f8 ff ff       	call   80104148 <create>
80104926:	83 c4 10             	add    $0x10,%esp
80104929:	85 c0                	test   %eax,%eax
8010492b:	74 18                	je     80104945 <sys_mkdir+0x56>
    end_op();
    return -1;
  }
  iunlockput(ip);
...
80104931:	e8 f2 cd ff ff       	call   80101728 <iunlockput>
  end_op();
80104936:	e8 ed de ff ff       	call   80102828 <end_op>
  return 0;
...
8010494f:	eb f2                	jmp    80104943 <sys_mkdir+0x54>
...
80104954:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
80104957:	e8 52 de ff ff       	call   801027ae <begin_op>
  if((argstr(0, &path)) < 0 ||
8010495c:	83 ec 08             	sub    $0x8,%esp
8010495f:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104962:	50                   	push   %eax
80104963:	6a 00                	push   $0x0
80104965:	e8 61 f6 ff ff       	call   80103fcb <argstr>
8010496a:	83 c4 10             	add    $0x10,%esp
8010496d:	85 c0                	test   %eax,%eax
8010496f:	78 62                	js     801049d3 <sys_mknod+0x82>
     argint(1, &major) < 0 ||
80104971:	83 ec 08             	sub    $0x8,%esp
80104974:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104977:	50                   	push   %eax
80104978:	6a 01                	push   $0x1
8010497a:	e8 bc f5 ff ff       	call   80103f3b <argint>
  if((argstr(0, &path)) < 0 ||
8010497f:	83 c4 10             	add    $0x10,%esp
80104982:	85 c0                	test   %eax,%eax
80104984:	78 4d                	js     801049d3 <sys_mknod+0x82>
     argint(2, &minor) < 0 ||
80104986:	83 ec 08             	sub    $0x8,%esp
80104989:	8d 45 ec             	lea    -0x14(%ebp),%eax
8010498c:	50                   	push   %eax
8010498d:	6a 02                	push   $0x2
8010498f:	e8 a7 f5 ff ff       	call   80103f3b <argint>
     argint(1, &major) < 0 ||
80104994:	83 c4 10             	add    $0x10,%esp
80104997:	85 c0                	test   %eax,%eax
80104999:	78 38                	js     801049d3 <sys_mknod+0x82>
     (ip = create(path, T_DEV, major, minor)) == 0){
8010499b:	0f bf 45 ec          	movswl -0x14(%ebp),%eax
8010499f:	0f bf 4d f0          	movswl -0x10(%ebp),%ecx
     argint(2, &minor) < 0 ||
801049a3:	83 ec 0c             	sub    $0xc,%esp
801049a6:	50                   	push   %eax
801049a7:	ba 03 00 00 00       	mov    $0x3,%edx
801049ac:	8b 45 f4             	mov    -0xc(%ebp),%eax
801049af:	e8 94 f7 ff ff       	call   80104148 <create>
801049b4:	83 c4 10             	add    $0x10,%esp
801049b7:	85 c0                	test   %eax,%eax
801049b9:	74 18                	je     801049d3 <sys_mknod+0x82>
    end_op();
    return -1;
  }
  iunlockput(ip);
...
801049bf:	e8 64 cd ff ff       	call   80101728 <iunlockput>
  end_op();
801049c4:	e8 5f de ff ff       	call   80102828 <end_op>
  return 0;
801049c9:	83 c4 10             	add    $0x10,%esp
801049cc:	b8 00 00 00 00       	mov    $0x0,%eax
}
801049d1:	c9                   	leave  
801049d2:	c3                   	ret    
    end_op();
801049d3:	e8 50 de ff ff       	call   80102828 <end_op>
    return -1;
801049d8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801049dd:	eb f2                	jmp    801049d1 <sys_mknod+0x80>
...
80104a20:	e8 5c cb ff ff       	call   80101581 <ilock>
  if(ip->type != T_DIR){
80104a25:	83 c4 10             	add    $0x10,%esp
80104a28:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104a2d:	75 37                	jne    80104a66 <sys_chdir+0x87>
    iunlockput(ip);
    end_op();
    return -1;
  }
...
80104a33:	e8 0b cc ff ff       	call   80101643 <iunlock>
  iput(curproc->cwd);
80104a38:	83 c4 04             	add    $0x4,%esp
80104a3b:	ff 76 68             	pushl  0x68(%esi)
80104a3e:	e8 45 cc ff ff       	call   80101688 <iput>
  end_op();
80104a43:	e8 e0 dd ff ff       	call   80102828 <end_op>
  curproc->cwd = ip;
80104a48:	89 5e 68             	mov    %ebx,0x68(%esi)
  return 0;
...
80104a59:	c3                   	ret    
    end_op();
80104a5a:	e8 c9 dd ff ff       	call   80102828 <end_op>
    return -1;
80104a5f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104a64:	eb ed                	jmp    80104a53 <sys_chdir+0x74>
    iunlockput(ip);
...
80104a7c:	eb d5                	jmp    80104a53 <sys_chdir+0x74>
...
80104a82:	81 ec 9c 00 00 00    	sub    $0x9c,%esp
  char *path, *argv[MAXARG];
  int i;
  uint uargv, uarg;

  if(argstr(0, &path) < 0 || argint(1, (int*)&uargv) < 0){
80104a88:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104a8b:	50                   	push   %eax
80104a8c:	6a 00                	push   $0x0
80104a8e:	e8 38 f5 ff ff       	call   80103fcb <argstr>
80104a93:	83 c4 10             	add    $0x10,%esp
80104a96:	85 c0                	test   %eax,%eax
80104a98:	0f 88 a8 00 00 00    	js     80104b46 <sys_exec+0xc8>
80104a9e:	83 ec 08             	sub    $0x8,%esp
80104aa1:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
80104aa7:	50                   	push   %eax
80104aa8:	6a 01                	push   $0x1
80104aaa:	e8 8c f4 ff ff       	call   80103f3b <argint>
80104aaf:	83 c4 10             	add    $0x10,%esp
80104ab2:	85 c0                	test   %eax,%eax
80104ab4:	0f 88 93 00 00 00    	js     80104b4d <sys_exec+0xcf>
    return -1;
  }
  memset(argv, 0, sizeof(argv));
80104aba:	83 ec 04             	sub    $0x4,%esp
80104abd:	68 80 00 00 00       	push   $0x80
80104ac2:	6a 00                	push   $0x0
80104ac4:	8d 85 74 ff ff ff    	lea    -0x8c(%ebp),%eax
80104aca:	50                   	push   %eax
80104acb:	e8 20 f2 ff ff       	call   80103cf0 <memset>
80104ad0:	83 c4 10             	add    $0x10,%esp
  for(i=0;; i++){
80104ad3:	bb 00 00 00 00       	mov    $0x0,%ebx
    if(i >= NELEM(argv))
80104ad8:	83 fb 1f             	cmp    $0x1f,%ebx
80104adb:	77 77                	ja     80104b54 <sys_exec+0xd6>
      return -1;
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
80104add:	83 ec 08             	sub    $0x8,%esp
80104ae0:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
80104ae6:	50                   	push   %eax
80104ae7:	8b 85 70 ff ff ff    	mov    -0x90(%ebp),%eax
80104aed:	8d 04 98             	lea    (%eax,%ebx,4),%eax
80104af0:	50                   	push   %eax
80104af1:	e8 c9 f3 ff ff       	call   80103ebf <fetchint>
80104af6:	83 c4 10             	add    $0x10,%esp
80104af9:	85 c0                	test   %eax,%eax
80104afb:	78 5e                	js     80104b5b <sys_exec+0xdd>
      return -1;
    if(uarg == 0){
80104afd:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
80104b03:	85 c0                	test   %eax,%eax
80104b05:	74 1d                	je     80104b24 <sys_exec+0xa6>
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
80104b07:	83 ec 08             	sub    $0x8,%esp
80104b0a:	8d 94 9d 74 ff ff ff 	lea    -0x8c(%ebp,%ebx,4),%edx
80104b11:	52                   	push   %edx
80104b12:	50                   	push   %eax
80104b13:	e8 e3 f3 ff ff       	call   80103efb <fetchstr>
80104b18:	83 c4 10             	add    $0x10,%esp
80104b1b:	85 c0                	test   %eax,%eax
80104b1d:	78 46                	js     80104b65 <sys_exec+0xe7>
  for(i=0;; i++){
80104b1f:	83 c3 01             	add    $0x1,%ebx
    if(i >= NELEM(argv))
80104b22:	eb b4                	jmp    80104ad8 <sys_exec+0x5a>
      argv[i] = 0;
80104b24:	c7 84 9d 74 ff ff ff 	movl   $0x0,-0x8c(%ebp,%ebx,4)
80104b2b:	00 00 00 00 
      return -1;
  }
  return exec(path, argv);
80104b2f:	83 ec 08             	sub    $0x8,%esp
80104b32:	8d 85 74 ff ff ff    	lea    -0x8c(%ebp),%eax
80104b38:	50                   	push   %eax
80104b39:	ff 75 f4             	pushl  -0xc(%ebp)
80104b3c:	e8 91 bd ff ff       	call   801008d2 <exec>
80104b41:	83 c4 10             	add    $0x10,%esp
80104b44:	eb 1a                	jmp    80104b60 <sys_exec+0xe2>
    return -1;
80104b46:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104b4b:	eb 13                	jmp    80104b60 <sys_exec+0xe2>
80104b4d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104b52:	eb 0c                	jmp    80104b60 <sys_exec+0xe2>
      return -1;
80104b54:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104b59:	eb 05                	jmp    80104b60 <sys_exec+0xe2>
      return -1;
...
80104b6a:	eb f4                	jmp    80104b60 <sys_exec+0xe2>
...
80104b73:	6a 08                	push   $0x8
80104b75:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104b78:	50                   	push   %eax
80104b79:	6a 00                	push   $0x0
80104b7b:	e8 e3 f3 ff ff       	call   80103f63 <argptr>
80104b80:	83 c4 10             	add    $0x10,%esp
80104b83:	85 c0                	test   %eax,%eax
80104b85:	78 77                	js     80104bfe <sys_pipe+0x92>
    return -1;
  if(pipealloc(&rf, &wf) < 0)
80104b87:	83 ec 08             	sub    $0x8,%esp
80104b8a:	8d 45 ec             	lea    -0x14(%ebp),%eax
80104b8d:	50                   	push   %eax
80104b8e:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104b91:	50                   	push   %eax
80104b92:	e8 9e e1 ff ff       	call   80102d35 <pipealloc>
80104b97:	83 c4 10             	add    $0x10,%esp
80104b9a:	85 c0                	test   %eax,%eax
80104b9c:	78 67                	js     80104c05 <sys_pipe+0x99>
    return -1;
  fd0 = -1;
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80104b9e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104ba1:	e8 14 f5 ff ff       	call   801040ba <fdalloc>
80104ba6:	89 c3                	mov    %eax,%ebx
80104ba8:	85 c0                	test   %eax,%eax
80104baa:	78 21                	js     80104bcd <sys_pipe+0x61>
80104bac:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104baf:	e8 06 f5 ff ff       	call   801040ba <fdalloc>
80104bb4:	85 c0                	test   %eax,%eax
80104bb6:	78 15                	js     80104bcd <sys_pipe+0x61>
      myproc()->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
  ...
  fd[0] = fd0;
80104bb8:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104bbb:	89 1a                	mov    %ebx,(%edx)
  fd[1] = fd1;
80104bbd:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104bc0:	89 42 04             	mov    %eax,0x4(%edx)
  return 0;
...
80104bcc:	c3                   	ret    
    if(fd0 >= 0)
80104bcd:	85 db                	test   %ebx,%ebx
80104bcf:	78 0d                	js     80104bde <sys_pipe+0x72>
      myproc()->ofile[fd0] = 0;
80104bd1:	e8 55 e6 ff ff       	call   8010322b <myproc>
80104bd6:	c7 44 98 28 00 00 00 	movl   $0x0,0x28(%eax,%ebx,4)
80104bdd:	00 
    fileclose(rf);
80104bde:	83 ec 0c             	sub    $0xc,%esp
80104be1:	ff 75 f0             	pushl  -0x10(%ebp)
80104be4:	e8 ea c0 ff ff       	call   80100cd3 <fileclose>
    fileclose(wf);
80104be9:	83 c4 04             	add    $0x4,%esp
80104bec:	ff 75 ec             	pushl  -0x14(%ebp)
80104bef:	e8 df c0 ff ff       	call   80100cd3 <fileclose>
    return -1;
80104bf4:	83 c4 10             	add    $0x10,%esp
80104bf7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104bfc:	eb ca                	jmp    80104bc8 <sys_pipe+0x5c>
    return -1;
80104bfe:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104c03:	eb c3                	jmp    80104bc8 <sys_pipe+0x5c>
    return -1;
80104c05:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104c0a:	eb bc                	jmp    80104bc8 <sys_pipe+0x5c>
...
80104c0f:	83 ec 08             	sub    $0x8,%esp
  return fork();
80104c12:	e8 8c e7 ff ff       	call   801033a3 <fork>
}
80104c17:	c9                   	leave  
80104c18:	c3                   	ret    
...
80104c1c:	83 ec 08             	sub    $0x8,%esp
  exit();
80104c1f:	e8 bd e9 ff ff       	call   801035e1 <exit>
...
80104c2e:	83 ec 08             	sub    $0x8,%esp
  return wait();
80104c31:	e8 34 eb ff ff       	call   8010376a <wait>
}
80104c36:	c9                   	leave  
80104c37:	c3                   	ret    
...
80104c3b:	83 ec 20             	sub    $0x20,%esp
  int pid;
...
80104c44:	e8 f2 f2 ff ff       	call   80103f3b <argint>
80104c49:	83 c4 10             	add    $0x10,%esp
80104c4c:	85 c0                	test   %eax,%eax
80104c4e:	78 10                	js     80104c60 <sys_kill+0x28>
    return -1;
  return kill(pid);
80104c50:	83 ec 0c             	sub    $0xc,%esp
80104c53:	ff 75 f4             	pushl  -0xc(%ebp)
80104c56:	e8 0c ec ff ff       	call   80103867 <kill>
...
80104c65:	eb f7                	jmp    80104c5e <sys_kill+0x26>
...
80104c6a:	83 ec 20             	sub    $0x20,%esp
  int pid;
  int pri;
...
80104cc2:	eb f7                	jmp    80104cbb <sys_setpri+0x54>
    return -1;
80104cc4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104cc9:	eb f0                	jmp    80104cbb <sys_setpri+0x54>
80104ccb:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104cd0:	eb e9                	jmp    80104cbb <sys_setpri+0x54>
...
80104cd5:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80104cd8:	e8 4e e5 ff ff       	call   8010322b <myproc>
...
80104cef:	e8 47 f2 ff ff       	call   80103f3b <argint>
80104cf4:	83 c4 10             	add    $0x10,%esp
80104cf7:	85 c0                	test   %eax,%eax
80104cf9:	78 27                	js     80104d22 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80104cfb:	e8 2b e5 ff ff       	call   8010322b <myproc>
80104d00:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
80104d02:	83 ec 0c             	sub    $0xc,%esp
80104d05:	ff 75 f4             	pushl  -0xc(%ebp)
80104d08:	e8 29 e6 ff ff       	call   80103336 <growproc>
80104d0d:	83 c4 10             	add    $0x10,%esp
80104d10:	85 c0                	test   %eax,%eax
80104d12:	78 07                	js     80104d1b <sys_sbrk+0x39>
    return -1;
  return addr;
}
...
80104d20:	eb f2                	jmp    80104d14 <sys_sbrk+0x32>
    return -1;
80104d22:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80104d27:	eb eb                	jmp    80104d14 <sys_sbrk+0x32>
...
80104d2d:	83 ec 1c             	sub    $0x1c,%esp
  int n;
  uint ticks0;
...
80104d36:	e8 00 f2 ff ff       	call   80103f3b <argint>
80104d3b:	83 c4 10             	add    $0x10,%esp
80104d3e:	85 c0                	test   %eax,%eax
80104d40:	78 75                	js     80104db7 <sys_sleep+0x8e>
    return -1;
  acquire(&tickslock);
80104d42:	83 ec 0c             	sub    $0xc,%esp
80104d45:	68 60 4c 11 80       	push   $0x80114c60
80104d4a:	e8 f5 ee ff ff       	call   80103c44 <acquire>
  ticks0 = ticks;
80104d4f:	8b 1d a0 54 11 80    	mov    0x801154a0,%ebx
  while(ticks - ticks0 < n){
80104d55:	83 c4 10             	add    $0x10,%esp
80104d58:	a1 a0 54 11 80       	mov    0x801154a0,%eax
80104d5d:	29 d8                	sub    %ebx,%eax
80104d5f:	3b 45 f4             	cmp    -0xc(%ebp),%eax
80104d62:	73 39                	jae    80104d9d <sys_sleep+0x74>
    if(myproc()->killed){
80104d64:	e8 c2 e4 ff ff       	call   8010322b <myproc>
80104d69:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80104d6d:	75 17                	jne    80104d86 <sys_sleep+0x5d>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
80104d6f:	83 ec 08             	sub    $0x8,%esp
80104d72:	68 60 4c 11 80       	push   $0x80114c60
80104d77:	68 a0 54 11 80       	push   $0x801154a0
80104d7c:	e8 58 e9 ff ff       	call   801036d9 <sleep>
80104d81:	83 c4 10             	add    $0x10,%esp
80104d84:	eb d2                	jmp    80104d58 <sys_sleep+0x2f>
      release(&tickslock);
80104d86:	83 ec 0c             	sub    $0xc,%esp
80104d89:	68 60 4c 11 80       	push   $0x80114c60
80104d8e:	e8 16 ef ff ff       	call   80103ca9 <release>
      return -1;
80104d93:	83 c4 10             	add    $0x10,%esp
80104d96:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104d9b:	eb 15                	jmp    80104db2 <sys_sleep+0x89>
  }
  release(&tickslock);
80104d9d:	83 ec 0c             	sub    $0xc,%esp
80104da0:	68 60 4c 11 80       	push   $0x80114c60
80104da5:	e8 ff ee ff ff       	call   80103ca9 <release>
  return 0;
...
80104dbc:	eb f4                	jmp    80104db2 <sys_sleep+0x89>
...
80104dc2:	83 ec 10             	sub    $0x10,%esp
  uint xticks;

  acquire(&tickslock);
80104dc5:	68 60 4c 11 80       	push   $0x80114c60
80104dca:	e8 75 ee ff ff       	call   80103c44 <acquire>
  xticks = ticks;
80104dcf:	8b 1d a0 54 11 80    	mov    0x801154a0,%ebx
  release(&tickslock);
80104dd5:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
80104ddc:	e8 c8 ee ff ff       	call   80103ca9 <release>
  return xticks;
}
80104de1:	89 d8                	mov    %ebx,%eax
80104de3:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104de6:	c9                   	leave  
80104de7:	c3                   	ret    
...
80104de9:	06                   	push   %es
  pushl %fs
80104dea:	0f a0                	push   %fs
  pushl %gs
80104dec:	0f a8                	push   %gs
  pushal
80104dee:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80104def:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80104df3:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80104df5:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80104df7:	54                   	push   %esp
  call trap
80104df8:	e8 e3 00 00 00       	call   80104ee0 <trap>
  addl $4, %esp
80104dfd:	83 c4 04             	add    $0x4,%esp
...
80104e00:	61                   	popa   
  popl %gs
80104e01:	0f a9                	pop    %gs
  popl %fs
80104e03:	0f a1                	pop    %fs
  popl %es
80104e05:	07                   	pop    %es
  popl %ds
80104e06:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80104e07:	83 c4 08             	add    $0x8,%esp
  iret
80104e0a:	cf                   	iret   
...
80104e16:	eb 4a                	jmp    80104e62 <tvinit+0x57>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80104e18:	8b 0c 85 08 90 10 80 	mov    -0x7fef6ff8(,%eax,4),%ecx
80104e1f:	66 89 0c c5 a0 4c 11 	mov    %cx,-0x7feeb360(,%eax,8)
80104e26:	80 
80104e27:	66 c7 04 c5 a2 4c 11 	movw   $0x8,-0x7feeb35e(,%eax,8)
80104e2e:	80 08 00 
80104e31:	c6 04 c5 a4 4c 11 80 	movb   $0x0,-0x7feeb35c(,%eax,8)
80104e38:	00 
80104e39:	0f b6 14 c5 a5 4c 11 	movzbl -0x7feeb35b(,%eax,8),%edx
80104e40:	80 
80104e41:	83 e2 f0             	and    $0xfffffff0,%edx
80104e44:	83 ca 0e             	or     $0xe,%edx
80104e47:	83 e2 8f             	and    $0xffffff8f,%edx
80104e4a:	83 ca 80             	or     $0xffffff80,%edx
80104e4d:	88 14 c5 a5 4c 11 80 	mov    %dl,-0x7feeb35b(,%eax,8)
80104e54:	c1 e9 10             	shr    $0x10,%ecx
80104e57:	66 89 0c c5 a6 4c 11 	mov    %cx,-0x7feeb35a(,%eax,8)
80104e5e:	80 
  for(i = 0; i < 256; i++)
80104e5f:	83 c0 01             	add    $0x1,%eax
80104e62:	3d ff 00 00 00       	cmp    $0xff,%eax
80104e67:	7e af                	jle    80104e18 <tvinit+0xd>
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80104e69:	8b 15 08 91 10 80    	mov    0x80109108,%edx
80104e6f:	66 89 15 a0 4e 11 80 	mov    %dx,0x80114ea0
80104e76:	66 c7 05 a2 4e 11 80 	movw   $0x8,0x80114ea2
80104e7d:	08 00 
80104e7f:	c6 05 a4 4e 11 80 00 	movb   $0x0,0x80114ea4
80104e86:	0f b6 05 a5 4e 11 80 	movzbl 0x80114ea5,%eax
80104e8d:	83 c8 0f             	or     $0xf,%eax
80104e90:	83 e0 ef             	and    $0xffffffef,%eax
80104e93:	83 c8 e0             	or     $0xffffffe0,%eax
80104e96:	a2 a5 4e 11 80       	mov    %al,0x80114ea5
80104e9b:	c1 ea 10             	shr    $0x10,%edx
80104e9e:	66 89 15 a6 4e 11 80 	mov    %dx,0x80114ea6

  initlock(&tickslock, "time");
80104ea5:	83 ec 08             	sub    $0x8,%esp
80104ea8:	68 dd 6c 10 80       	push   $0x80106cdd
80104ead:	68 60 4c 11 80       	push   $0x80114c60
80104eb2:	e8 51 ec ff ff       	call   80103b08 <initlock>
}
...
80104ec2:	66 c7 45 fa ff 07    	movw   $0x7ff,-0x6(%ebp)
  pd[1] = (uint)p;
80104ec8:	b8 a0 4c 11 80       	mov    $0x80114ca0,%eax
...
80104ef2:	74 13                	je     80104f07 <trap+0x27>
    if(myproc()->killed)
      exit();
    return;
  }
  ...
  switch(tf->trapno){
80104ef4:	83 e8 20             	sub    $0x20,%eax
80104ef7:	83 f8 1f             	cmp    $0x1f,%eax
80104efa:	0f 87 3a 01 00 00    	ja     8010503a <trap+0x15a>
80104f00:	ff 24 85 84 6d 10 80 	jmp    *-0x7fef927c(,%eax,4)
    if(myproc()->killed)
80104f07:	e8 1f e3 ff ff       	call   8010322b <myproc>
80104f0c:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80104f10:	75 1f                	jne    80104f31 <trap+0x51>
    myproc()->tf = tf;
80104f12:	e8 14 e3 ff ff       	call   8010322b <myproc>
80104f17:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80104f1a:	e8 df f0 ff ff       	call   80103ffe <syscall>
    if(myproc()->killed)
80104f1f:	e8 07 e3 ff ff       	call   8010322b <myproc>
80104f24:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80104f28:	74 7e                	je     80104fa8 <trap+0xc8>
      exit();
80104f2a:	e8 b2 e6 ff ff       	call   801035e1 <exit>
80104f2f:	eb 77                	jmp    80104fa8 <trap+0xc8>
      exit();
80104f31:	e8 ab e6 ff ff       	call   801035e1 <exit>
80104f36:	eb da                	jmp    80104f12 <trap+0x32>
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
80104f38:	e8 d3 e2 ff ff       	call   80103210 <cpuid>
80104f3d:	85 c0                	test   %eax,%eax
80104f3f:	74 6f                	je     80104fb0 <trap+0xd0>
      acquire(&tickslock);
      ticks++;
      wakeup(&ticks);
      release(&tickslock);
    ...
    lapiceoi();
80104f41:	e8 53 d4 ff ff       	call   80102399 <lapiceoi>
  }
...
80104f46:	e8 e0 e2 ff ff       	call   8010322b <myproc>
80104f4b:	85 c0                	test   %eax,%eax
80104f4d:	74 1c                	je     80104f6b <trap+0x8b>
80104f4f:	e8 d7 e2 ff ff       	call   8010322b <myproc>
80104f54:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80104f58:	74 11                	je     80104f6b <trap+0x8b>
80104f5a:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80104f5e:	83 e0 03             	and    $0x3,%eax
80104f61:	66 83 f8 03          	cmp    $0x3,%ax
80104f65:	0f 84 62 01 00 00    	je     801050cd <trap+0x1ed>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80104f6b:	e8 bb e2 ff ff       	call   8010322b <myproc>
80104f70:	85 c0                	test   %eax,%eax
80104f72:	74 0f                	je     80104f83 <trap+0xa3>
80104f74:	e8 b2 e2 ff ff       	call   8010322b <myproc>
80104f79:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80104f7d:	0f 84 54 01 00 00    	je     801050d7 <trap+0x1f7>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80104f83:	e8 a3 e2 ff ff       	call   8010322b <myproc>
80104f88:	85 c0                	test   %eax,%eax
80104f8a:	74 1c                	je     80104fa8 <trap+0xc8>
80104f8c:	e8 9a e2 ff ff       	call   8010322b <myproc>
80104f91:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80104f95:	74 11                	je     80104fa8 <trap+0xc8>
80104f97:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80104f9b:	83 e0 03             	and    $0x3,%eax
80104f9e:	66 83 f8 03          	cmp    $0x3,%ax
80104fa2:	0f 84 43 01 00 00    	je     801050eb <trap+0x20b>
    exit();
}
80104fa8:	8d 65 f4             	lea    -0xc(%ebp),%esp
80104fab:	5b                   	pop    %ebx
80104fac:	5e                   	pop    %esi
80104fad:	5f                   	pop    %edi
80104fae:	5d                   	pop    %ebp
...
80104fb3:	68 60 4c 11 80       	push   $0x80114c60
80104fb8:	e8 87 ec ff ff       	call   80103c44 <acquire>
      ticks++;
80104fbd:	83 05 a0 54 11 80 01 	addl   $0x1,0x801154a0
      wakeup(&ticks);
80104fc4:	c7 04 24 a0 54 11 80 	movl   $0x801154a0,(%esp)
80104fcb:	e8 6e e8 ff ff       	call   8010383e <wakeup>
      release(&tickslock);
80104fd0:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
80104fd7:	e8 cd ec ff ff       	call   80103ca9 <release>
80104fdc:	83 c4 10             	add    $0x10,%esp
80104fdf:	e9 5d ff ff ff       	jmp    80104f41 <trap+0x61>
    ideintr();
80104fe4:	e8 8a cd ff ff       	call   80101d73 <ideintr>
    lapiceoi();
80104fe9:	e8 ab d3 ff ff       	call   80102399 <lapiceoi>
    break;
80104fee:	e9 53 ff ff ff       	jmp    80104f46 <trap+0x66>
    kbdintr();
80104ff3:	e8 e5 d1 ff ff       	call   801021dd <kbdintr>
    lapiceoi();
80104ff8:	e8 9c d3 ff ff       	call   80102399 <lapiceoi>
    break;
80104ffd:	e9 44 ff ff ff       	jmp    80104f46 <trap+0x66>
    uartintr();
80105002:	e8 05 02 00 00       	call   8010520c <uartintr>
    lapiceoi();
80105007:	e8 8d d3 ff ff       	call   80102399 <lapiceoi>
    break;
8010500c:	e9 35 ff ff ff       	jmp    80104f46 <trap+0x66>
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105011:	8b 7b 38             	mov    0x38(%ebx),%edi
            cpuid(), tf->cs, tf->eip);
80105014:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105018:	e8 f3 e1 ff ff       	call   80103210 <cpuid>
8010501d:	57                   	push   %edi
8010501e:	0f b7 f6             	movzwl %si,%esi
80105021:	56                   	push   %esi
80105022:	50                   	push   %eax
80105023:	68 e8 6c 10 80       	push   $0x80106ce8
80105028:	e8 de b5 ff ff       	call   8010060b <cprintf>
    lapiceoi();
8010502d:	e8 67 d3 ff ff       	call   80102399 <lapiceoi>
    break;
80105032:	83 c4 10             	add    $0x10,%esp
80105035:	e9 0c ff ff ff       	jmp    80104f46 <trap+0x66>
    if(myproc() == 0 || (tf->cs&3) == 0){
8010503a:	e8 ec e1 ff ff       	call   8010322b <myproc>
8010503f:	85 c0                	test   %eax,%eax
80105041:	74 5f                	je     801050a2 <trap+0x1c2>
80105043:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105047:	74 59                	je     801050a2 <trap+0x1c2>
...
80105049:	0f 20 d7             	mov    %cr2,%edi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010504c:	8b 43 38             	mov    0x38(%ebx),%eax
8010504f:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80105052:	e8 b9 e1 ff ff       	call   80103210 <cpuid>
80105057:	89 45 e0             	mov    %eax,-0x20(%ebp)
8010505a:	8b 53 34             	mov    0x34(%ebx),%edx
8010505d:	89 55 dc             	mov    %edx,-0x24(%ebp)
80105060:	8b 73 30             	mov    0x30(%ebx),%esi
            myproc()->pid, myproc()->name, tf->trapno,
80105063:	e8 c3 e1 ff ff       	call   8010322b <myproc>
80105068:	8d 48 6c             	lea    0x6c(%eax),%ecx
8010506b:	89 4d d8             	mov    %ecx,-0x28(%ebp)
8010506e:	e8 b8 e1 ff ff       	call   8010322b <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105073:	57                   	push   %edi
80105074:	ff 75 e4             	pushl  -0x1c(%ebp)
80105077:	ff 75 e0             	pushl  -0x20(%ebp)
8010507a:	ff 75 dc             	pushl  -0x24(%ebp)
8010507d:	56                   	push   %esi
8010507e:	ff 75 d8             	pushl  -0x28(%ebp)
80105081:	ff 70 10             	pushl  0x10(%eax)
80105084:	68 40 6d 10 80       	push   $0x80106d40
80105089:	e8 7d b5 ff ff       	call   8010060b <cprintf>
    myproc()->killed = 1;
8010508e:	83 c4 20             	add    $0x20,%esp
80105091:	e8 95 e1 ff ff       	call   8010322b <myproc>
80105096:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
8010509d:	e9 a4 fe ff ff       	jmp    80104f46 <trap+0x66>
801050a2:	0f 20 d7             	mov    %cr2,%edi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801050a5:	8b 73 38             	mov    0x38(%ebx),%esi
801050a8:	e8 63 e1 ff ff       	call   80103210 <cpuid>
801050ad:	83 ec 0c             	sub    $0xc,%esp
801050b0:	57                   	push   %edi
801050b1:	56                   	push   %esi
801050b2:	50                   	push   %eax
801050b3:	ff 73 30             	pushl  0x30(%ebx)
801050b6:	68 0c 6d 10 80       	push   $0x80106d0c
801050bb:	e8 4b b5 ff ff       	call   8010060b <cprintf>
      panic("trap");
801050c0:	83 c4 14             	add    $0x14,%esp
801050c3:	68 e2 6c 10 80       	push   $0x80106ce2
801050c8:	e8 7b b2 ff ff       	call   80100348 <panic>
    exit();
801050cd:	e8 0f e5 ff ff       	call   801035e1 <exit>
801050d2:	e9 94 fe ff ff       	jmp    80104f6b <trap+0x8b>
  if(myproc() && myproc()->state == RUNNING &&
801050d7:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
801050db:	0f 85 a2 fe ff ff    	jne    80104f83 <trap+0xa3>
    yield();
801050e1:	e8 c1 e5 ff ff       	call   801036a7 <yield>
801050e6:	e9 98 fe ff ff       	jmp    80104f83 <trap+0xa3>
    exit();
801050eb:	e8 f1 e4 ff ff       	call   801035e1 <exit>
801050f0:	e9 b3 fe ff ff       	jmp    80104fa8 <trap+0xc8>
...
801050ff:	74 15                	je     80105116 <uartgetc+0x21>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
...
80105109:	74 12                	je     8010511d <uartgetc+0x28>
...
8010511b:	eb f7                	jmp    80105114 <uartgetc+0x1f>
    return -1;
8010511d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105122:	eb f0                	jmp    80105114 <uartgetc+0x1f>

80105124 <uartputc>:
  if(!uart)
80105124:	83 3d bc 95 10 80 00 	cmpl   $0x0,0x801095bc
8010512b:	74 3b                	je     80105168 <uartputc+0x44>
{
...
80105134:	bb 00 00 00 00       	mov    $0x0,%ebx
80105139:	eb 10                	jmp    8010514b <uartputc+0x27>
    microdelay(10);
8010513b:	83 ec 0c             	sub    $0xc,%esp
8010513e:	6a 0a                	push   $0xa
80105140:	e8 73 d2 ff ff       	call   801023b8 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80105145:	83 c3 01             	add    $0x1,%ebx
80105148:	83 c4 10             	add    $0x10,%esp
8010514b:	83 fb 7f             	cmp    $0x7f,%ebx
8010514e:	7f 0a                	jg     8010515a <uartputc+0x36>
80105150:	ba fd 03 00 00       	mov    $0x3fd,%edx
80105155:	ec                   	in     (%dx),%al
80105156:	a8 20                	test   $0x20,%al
80105158:	74 e1                	je     8010513b <uartputc+0x17>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
8010515a:	8b 45 08             	mov    0x8(%ebp),%eax
8010515d:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105162:	ee                   	out    %al,(%dx)
}
80105163:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80105166:	c9                   	leave  
80105167:	c3                   	ret    
80105168:	f3 c3                	repz ret 
...
8010516f:	b9 00 00 00 00       	mov    $0x0,%ecx
80105174:	ba fa 03 00 00       	mov    $0x3fa,%edx
80105179:	89 c8                	mov    %ecx,%eax
8010517b:	ee                   	out    %al,(%dx)
8010517c:	be fb 03 00 00       	mov    $0x3fb,%esi
80105181:	b8 80 ff ff ff       	mov    $0xffffff80,%eax
80105186:	89 f2                	mov    %esi,%edx
80105188:	ee                   	out    %al,(%dx)
80105189:	b8 0c 00 00 00       	mov    $0xc,%eax
8010518e:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105193:	ee                   	out    %al,(%dx)
80105194:	bb f9 03 00 00       	mov    $0x3f9,%ebx
80105199:	89 c8                	mov    %ecx,%eax
8010519b:	89 da                	mov    %ebx,%edx
8010519d:	ee                   	out    %al,(%dx)
8010519e:	b8 03 00 00 00       	mov    $0x3,%eax
801051a3:	89 f2                	mov    %esi,%edx
801051a5:	ee                   	out    %al,(%dx)
801051a6:	ba fc 03 00 00       	mov    $0x3fc,%edx
801051ab:	89 c8                	mov    %ecx,%eax
801051ad:	ee                   	out    %al,(%dx)
801051ae:	b8 01 00 00 00       	mov    $0x1,%eax
801051b3:	89 da                	mov    %ebx,%edx
801051b5:	ee                   	out    %al,(%dx)
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
801051b6:	ba fd 03 00 00       	mov    $0x3fd,%edx
801051bb:	ec                   	in     (%dx),%al
  if(inb(COM1+5) == 0xFF)
801051bc:	3c ff                	cmp    $0xff,%al
801051be:	74 45                	je     80105205 <uartinit+0x9b>
  uart = 1;
801051c0:	c7 05 bc 95 10 80 01 	movl   $0x1,0x801095bc
801051c7:	00 00 00 
801051ca:	ba fa 03 00 00       	mov    $0x3fa,%edx
801051cf:	ec                   	in     (%dx),%al
801051d0:	ba f8 03 00 00       	mov    $0x3f8,%edx
801051d5:	ec                   	in     (%dx),%al
  ioapicenable(IRQ_COM1, 0);
801051d6:	83 ec 08             	sub    $0x8,%esp
801051d9:	6a 00                	push   $0x0
801051db:	6a 04                	push   $0x4
801051dd:	e8 9c cd ff ff       	call   80101f7e <ioapicenable>
  for(p="xv6...\n"; *p; p++)
801051e2:	83 c4 10             	add    $0x10,%esp
801051e5:	bb 04 6e 10 80       	mov    $0x80106e04,%ebx
801051ea:	eb 12                	jmp    801051fe <uartinit+0x94>
    uartputc(*p);
801051ec:	83 ec 0c             	sub    $0xc,%esp
801051ef:	0f be c0             	movsbl %al,%eax
801051f2:	50                   	push   %eax
801051f3:	e8 2c ff ff ff       	call   80105124 <uartputc>
  for(p="xv6...\n"; *p; p++)
801051f8:	83 c3 01             	add    $0x1,%ebx
801051fb:	83 c4 10             	add    $0x10,%esp
801051fe:	0f b6 03             	movzbl (%ebx),%eax
80105201:	84 c0                	test   %al,%al
80105203:	75 e7                	jne    801051ec <uartinit+0x82>
}
80105205:	8d 65 f8             	lea    -0x8(%ebp),%esp
80105208:	5b                   	pop    %ebx
80105209:	5e                   	pop    %esi
8010520a:	5d                   	pop    %ebp
8010520b:	c3                   	ret    
...
8010520f:	83 ec 14             	sub    $0x14,%esp
  consoleintr(uartgetc);
80105212:	68 f5 50 10 80       	push   $0x801050f5
80105217:	e8 22 b5 ff ff       	call   8010073e <consoleintr>
}
...
80105223:	6a 00                	push   $0x0
  jmp alltraps
80105225:	e9 be fb ff ff       	jmp    80104de8 <alltraps>
...
8010522c:	6a 01                	push   $0x1
  jmp alltraps
8010522e:	e9 b5 fb ff ff       	jmp    80104de8 <alltraps>
...
80105233:	6a 00                	push   $0x0
  pushl $2
80105235:	6a 02                	push   $0x2
  jmp alltraps
80105237:	e9 ac fb ff ff       	jmp    80104de8 <alltraps>
...
8010523c:	6a 00                	push   $0x0
  pushl $3
8010523e:	6a 03                	push   $0x3
  jmp alltraps
80105240:	e9 a3 fb ff ff       	jmp    80104de8 <alltraps>
...
80105245:	6a 00                	push   $0x0
  pushl $4
80105247:	6a 04                	push   $0x4
  jmp alltraps
80105249:	e9 9a fb ff ff       	jmp    80104de8 <alltraps>
...
8010524e:	6a 00                	push   $0x0
  pushl $5
80105250:	6a 05                	push   $0x5
  jmp alltraps
80105252:	e9 91 fb ff ff       	jmp    80104de8 <alltraps>

80105257 <vector6>:
.globl vector6
vector6:
  pushl $0
80105257:	6a 00                	push   $0x0
  pushl $6
80105259:	6a 06                	push   $0x6
  jmp alltraps
8010525b:	e9 88 fb ff ff       	jmp    80104de8 <alltraps>
...
80105260:	6a 00                	push   $0x0
  pushl $7
80105262:	6a 07                	push   $0x7
  jmp alltraps
80105264:	e9 7f fb ff ff       	jmp    80104de8 <alltraps>

80105269 <vector8>:
.globl vector8
vector8:
  pushl $8
80105269:	6a 08                	push   $0x8
  jmp alltraps
8010526b:	e9 78 fb ff ff       	jmp    80104de8 <alltraps>
...
80105270:	6a 00                	push   $0x0
  pushl $9
80105272:	6a 09                	push   $0x9
  jmp alltraps
80105274:	e9 6f fb ff ff       	jmp    80104de8 <alltraps>

80105279 <vector10>:
.globl vector10
vector10:
  pushl $10
80105279:	6a 0a                	push   $0xa
  jmp alltraps
8010527b:	e9 68 fb ff ff       	jmp    80104de8 <alltraps>

80105280 <vector11>:
.globl vector11
vector11:
  pushl $11
80105280:	6a 0b                	push   $0xb
  jmp alltraps
80105282:	e9 61 fb ff ff       	jmp    80104de8 <alltraps>

80105287 <vector12>:
.globl vector12
vector12:
  pushl $12
80105287:	6a 0c                	push   $0xc
  jmp alltraps
80105289:	e9 5a fb ff ff       	jmp    80104de8 <alltraps>

8010528e <vector13>:
.globl vector13
vector13:
  pushl $13
8010528e:	6a 0d                	push   $0xd
  jmp alltraps
80105290:	e9 53 fb ff ff       	jmp    80104de8 <alltraps>

80105295 <vector14>:
.globl vector14
vector14:
  pushl $14
80105295:	6a 0e                	push   $0xe
  jmp alltraps
80105297:	e9 4c fb ff ff       	jmp    80104de8 <alltraps>
...
8010529c:	6a 00                	push   $0x0
  pushl $15
8010529e:	6a 0f                	push   $0xf
  jmp alltraps
801052a0:	e9 43 fb ff ff       	jmp    80104de8 <alltraps>
...
801052a7:	6a 10                	push   $0x10
  jmp alltraps
801052a9:	e9 3a fb ff ff       	jmp    80104de8 <alltraps>

801052ae <vector17>:
.globl vector17
vector17:
  pushl $17
801052ae:	6a 11                	push   $0x11
  jmp alltraps
801052b0:	e9 33 fb ff ff       	jmp    80104de8 <alltraps>
...
801052b5:	6a 00                	push   $0x0
  pushl $18
801052b7:	6a 12                	push   $0x12
  jmp alltraps
801052b9:	e9 2a fb ff ff       	jmp    80104de8 <alltraps>
...
801052be:	6a 00                	push   $0x0
  pushl $19
801052c0:	6a 13                	push   $0x13
  jmp alltraps
801052c2:	e9 21 fb ff ff       	jmp    80104de8 <alltraps>
...
801052c7:	6a 00                	push   $0x0
  pushl $20
801052c9:	6a 14                	push   $0x14
  jmp alltraps
801052cb:	e9 18 fb ff ff       	jmp    80104de8 <alltraps>
...
801052d0:	6a 00                	push   $0x0
  pushl $21
801052d2:	6a 15                	push   $0x15
  jmp alltraps
801052d4:	e9 0f fb ff ff       	jmp    80104de8 <alltraps>
...
801052d9:	6a 00                	push   $0x0
  pushl $22
801052db:	6a 16                	push   $0x16
  jmp alltraps
801052dd:	e9 06 fb ff ff       	jmp    80104de8 <alltraps>
...
801052e2:	6a 00                	push   $0x0
  pushl $23
801052e4:	6a 17                	push   $0x17
  jmp alltraps
801052e6:	e9 fd fa ff ff       	jmp    80104de8 <alltraps>
...
801052eb:	6a 00                	push   $0x0
  pushl $24
801052ed:	6a 18                	push   $0x18
  jmp alltraps
801052ef:	e9 f4 fa ff ff       	jmp    80104de8 <alltraps>
...
801052f4:	6a 00                	push   $0x0
  pushl $25
801052f6:	6a 19                	push   $0x19
  jmp alltraps
801052f8:	e9 eb fa ff ff       	jmp    80104de8 <alltraps>
...
801052fd:	6a 00                	push   $0x0
  pushl $26
801052ff:	6a 1a                	push   $0x1a
  jmp alltraps
80105301:	e9 e2 fa ff ff       	jmp    80104de8 <alltraps>
...
80105306:	6a 00                	push   $0x0
  pushl $27
80105308:	6a 1b                	push   $0x1b
  jmp alltraps
8010530a:	e9 d9 fa ff ff       	jmp    80104de8 <alltraps>
...
8010530f:	6a 00                	push   $0x0
  pushl $28
80105311:	6a 1c                	push   $0x1c
  jmp alltraps
80105313:	e9 d0 fa ff ff       	jmp    80104de8 <alltraps>
...
80105318:	6a 00                	push   $0x0
  pushl $29
8010531a:	6a 1d                	push   $0x1d
  jmp alltraps
8010531c:	e9 c7 fa ff ff       	jmp    80104de8 <alltraps>
...
80105321:	6a 00                	push   $0x0
  pushl $30
80105323:	6a 1e                	push   $0x1e
  jmp alltraps
80105325:	e9 be fa ff ff       	jmp    80104de8 <alltraps>
...
8010532a:	6a 00                	push   $0x0
  pushl $31
8010532c:	6a 1f                	push   $0x1f
  jmp alltraps
8010532e:	e9 b5 fa ff ff       	jmp    80104de8 <alltraps>
...
80105333:	6a 00                	push   $0x0
  pushl $32
80105335:	6a 20                	push   $0x20
  jmp alltraps
80105337:	e9 ac fa ff ff       	jmp    80104de8 <alltraps>
...
8010533c:	6a 00                	push   $0x0
  pushl $33
8010533e:	6a 21                	push   $0x21
  jmp alltraps
80105340:	e9 a3 fa ff ff       	jmp    80104de8 <alltraps>
...
80105345:	6a 00                	push   $0x0
  pushl $34
80105347:	6a 22                	push   $0x22
  jmp alltraps
80105349:	e9 9a fa ff ff       	jmp    80104de8 <alltraps>
...
8010534e:	6a 00                	push   $0x0
  pushl $35
80105350:	6a 23                	push   $0x23
  jmp alltraps
80105352:	e9 91 fa ff ff       	jmp    80104de8 <alltraps>
...
80105357:	6a 00                	push   $0x0
  pushl $36
80105359:	6a 24                	push   $0x24
  jmp alltraps
8010535b:	e9 88 fa ff ff       	jmp    80104de8 <alltraps>
...
80105360:	6a 00                	push   $0x0
  pushl $37
80105362:	6a 25                	push   $0x25
  jmp alltraps
80105364:	e9 7f fa ff ff       	jmp    80104de8 <alltraps>
...
80105369:	6a 00                	push   $0x0
  pushl $38
8010536b:	6a 26                	push   $0x26
  jmp alltraps
8010536d:	e9 76 fa ff ff       	jmp    80104de8 <alltraps>
...
80105372:	6a 00                	push   $0x0
  pushl $39
80105374:	6a 27                	push   $0x27
  jmp alltraps
80105376:	e9 6d fa ff ff       	jmp    80104de8 <alltraps>
...
8010537b:	6a 00                	push   $0x0
  pushl $40
8010537d:	6a 28                	push   $0x28
  jmp alltraps
8010537f:	e9 64 fa ff ff       	jmp    80104de8 <alltraps>
...
80105384:	6a 00                	push   $0x0
  pushl $41
80105386:	6a 29                	push   $0x29
  jmp alltraps
80105388:	e9 5b fa ff ff       	jmp    80104de8 <alltraps>
...
8010538d:	6a 00                	push   $0x0
  pushl $42
8010538f:	6a 2a                	push   $0x2a
  jmp alltraps
80105391:	e9 52 fa ff ff       	jmp    80104de8 <alltraps>
...
80105396:	6a 00                	push   $0x0
  pushl $43
80105398:	6a 2b                	push   $0x2b
  jmp alltraps
8010539a:	e9 49 fa ff ff       	jmp    80104de8 <alltraps>
...
8010539f:	6a 00                	push   $0x0
  pushl $44
801053a1:	6a 2c                	push   $0x2c
  jmp alltraps
801053a3:	e9 40 fa ff ff       	jmp    80104de8 <alltraps>
...
801053a8:	6a 00                	push   $0x0
  pushl $45
801053aa:	6a 2d                	push   $0x2d
  jmp alltraps
801053ac:	e9 37 fa ff ff       	jmp    80104de8 <alltraps>
...
801053b1:	6a 00                	push   $0x0
  pushl $46
801053b3:	6a 2e                	push   $0x2e
  jmp alltraps
801053b5:	e9 2e fa ff ff       	jmp    80104de8 <alltraps>
...
801053ba:	6a 00                	push   $0x0
  pushl $47
801053bc:	6a 2f                	push   $0x2f
  jmp alltraps
801053be:	e9 25 fa ff ff       	jmp    80104de8 <alltraps>
...
801053c3:	6a 00                	push   $0x0
  pushl $48
801053c5:	6a 30                	push   $0x30
  jmp alltraps
801053c7:	e9 1c fa ff ff       	jmp    80104de8 <alltraps>
...
801053cc:	6a 00                	push   $0x0
  pushl $49
801053ce:	6a 31                	push   $0x31
  jmp alltraps
801053d0:	e9 13 fa ff ff       	jmp    80104de8 <alltraps>
...
801053d5:	6a 00                	push   $0x0
  pushl $50
801053d7:	6a 32                	push   $0x32
  jmp alltraps
801053d9:	e9 0a fa ff ff       	jmp    80104de8 <alltraps>
...
801053de:	6a 00                	push   $0x0
  pushl $51
801053e0:	6a 33                	push   $0x33
  jmp alltraps
801053e2:	e9 01 fa ff ff       	jmp    80104de8 <alltraps>
...
801053e7:	6a 00                	push   $0x0
  pushl $52
801053e9:	6a 34                	push   $0x34
  jmp alltraps
801053eb:	e9 f8 f9 ff ff       	jmp    80104de8 <alltraps>
...
801053f0:	6a 00                	push   $0x0
  pushl $53
801053f2:	6a 35                	push   $0x35
  jmp alltraps
801053f4:	e9 ef f9 ff ff       	jmp    80104de8 <alltraps>
...
801053f9:	6a 00                	push   $0x0
  pushl $54
801053fb:	6a 36                	push   $0x36
  jmp alltraps
801053fd:	e9 e6 f9 ff ff       	jmp    80104de8 <alltraps>
...
80105402:	6a 00                	push   $0x0
  pushl $55
80105404:	6a 37                	push   $0x37
  jmp alltraps
80105406:	e9 dd f9 ff ff       	jmp    80104de8 <alltraps>
...
8010540b:	6a 00                	push   $0x0
  pushl $56
8010540d:	6a 38                	push   $0x38
  jmp alltraps
8010540f:	e9 d4 f9 ff ff       	jmp    80104de8 <alltraps>
...
80105414:	6a 00                	push   $0x0
  pushl $57
80105416:	6a 39                	push   $0x39
  jmp alltraps
80105418:	e9 cb f9 ff ff       	jmp    80104de8 <alltraps>
...
8010541d:	6a 00                	push   $0x0
  pushl $58
8010541f:	6a 3a                	push   $0x3a
  jmp alltraps
80105421:	e9 c2 f9 ff ff       	jmp    80104de8 <alltraps>
...
80105426:	6a 00                	push   $0x0
  pushl $59
80105428:	6a 3b                	push   $0x3b
  jmp alltraps
8010542a:	e9 b9 f9 ff ff       	jmp    80104de8 <alltraps>
...
8010542f:	6a 00                	push   $0x0
  pushl $60
80105431:	6a 3c                	push   $0x3c
  jmp alltraps
80105433:	e9 b0 f9 ff ff       	jmp    80104de8 <alltraps>
...
80105438:	6a 00                	push   $0x0
  pushl $61
8010543a:	6a 3d                	push   $0x3d
  jmp alltraps
8010543c:	e9 a7 f9 ff ff       	jmp    80104de8 <alltraps>
...
80105441:	6a 00                	push   $0x0
  pushl $62
80105443:	6a 3e                	push   $0x3e
  jmp alltraps
80105445:	e9 9e f9 ff ff       	jmp    80104de8 <alltraps>
...
8010544a:	6a 00                	push   $0x0
  pushl $63
8010544c:	6a 3f                	push   $0x3f
  jmp alltraps
8010544e:	e9 95 f9 ff ff       	jmp    80104de8 <alltraps>
...
80105453:	6a 00                	push   $0x0
  pushl $64
80105455:	6a 40                	push   $0x40
  jmp alltraps
80105457:	e9 8c f9 ff ff       	jmp    80104de8 <alltraps>
...
8010545c:	6a 00                	push   $0x0
  pushl $65
8010545e:	6a 41                	push   $0x41
  jmp alltraps
80105460:	e9 83 f9 ff ff       	jmp    80104de8 <alltraps>
...
80105465:	6a 00                	push   $0x0
  pushl $66
80105467:	6a 42                	push   $0x42
  jmp alltraps
80105469:	e9 7a f9 ff ff       	jmp    80104de8 <alltraps>
...
8010546e:	6a 00                	push   $0x0
  pushl $67
80105470:	6a 43                	push   $0x43
  jmp alltraps
80105472:	e9 71 f9 ff ff       	jmp    80104de8 <alltraps>
...
80105477:	6a 00                	push   $0x0
  pushl $68
80105479:	6a 44                	push   $0x44
  jmp alltraps
8010547b:	e9 68 f9 ff ff       	jmp    80104de8 <alltraps>
...
80105480:	6a 00                	push   $0x0
  pushl $69
80105482:	6a 45                	push   $0x45
  jmp alltraps
80105484:	e9 5f f9 ff ff       	jmp    80104de8 <alltraps>
...
80105489:	6a 00                	push   $0x0
  pushl $70
8010548b:	6a 46                	push   $0x46
  jmp alltraps
8010548d:	e9 56 f9 ff ff       	jmp    80104de8 <alltraps>
...
80105492:	6a 00                	push   $0x0
  pushl $71
80105494:	6a 47                	push   $0x47
  jmp alltraps
80105496:	e9 4d f9 ff ff       	jmp    80104de8 <alltraps>
...
8010549b:	6a 00                	push   $0x0
  pushl $72
8010549d:	6a 48                	push   $0x48
  jmp alltraps
8010549f:	e9 44 f9 ff ff       	jmp    80104de8 <alltraps>
...
801054a4:	6a 00                	push   $0x0
  pushl $73
801054a6:	6a 49                	push   $0x49
  jmp alltraps
801054a8:	e9 3b f9 ff ff       	jmp    80104de8 <alltraps>
...
801054ad:	6a 00                	push   $0x0
  pushl $74
801054af:	6a 4a                	push   $0x4a
  jmp alltraps
801054b1:	e9 32 f9 ff ff       	jmp    80104de8 <alltraps>
...
801054b6:	6a 00                	push   $0x0
  pushl $75
801054b8:	6a 4b                	push   $0x4b
  jmp alltraps
801054ba:	e9 29 f9 ff ff       	jmp    80104de8 <alltraps>
...
801054bf:	6a 00                	push   $0x0
  pushl $76
801054c1:	6a 4c                	push   $0x4c
  jmp alltraps
801054c3:	e9 20 f9 ff ff       	jmp    80104de8 <alltraps>
...
801054c8:	6a 00                	push   $0x0
  pushl $77
801054ca:	6a 4d                	push   $0x4d
  jmp alltraps
801054cc:	e9 17 f9 ff ff       	jmp    80104de8 <alltraps>
...
801054d1:	6a 00                	push   $0x0
  pushl $78
801054d3:	6a 4e                	push   $0x4e
  jmp alltraps
801054d5:	e9 0e f9 ff ff       	jmp    80104de8 <alltraps>
...
801054da:	6a 00                	push   $0x0
  pushl $79
801054dc:	6a 4f                	push   $0x4f
  jmp alltraps
801054de:	e9 05 f9 ff ff       	jmp    80104de8 <alltraps>
...
801054e3:	6a 00                	push   $0x0
  pushl $80
801054e5:	6a 50                	push   $0x50
  jmp alltraps
801054e7:	e9 fc f8 ff ff       	jmp    80104de8 <alltraps>
...
801054ec:	6a 00                	push   $0x0
  pushl $81
801054ee:	6a 51                	push   $0x51
  jmp alltraps
801054f0:	e9 f3 f8 ff ff       	jmp    80104de8 <alltraps>
...
801054f5:	6a 00                	push   $0x0
  pushl $82
801054f7:	6a 52                	push   $0x52
  jmp alltraps
801054f9:	e9 ea f8 ff ff       	jmp    80104de8 <alltraps>
...
801054fe:	6a 00                	push   $0x0
  pushl $83
80105500:	6a 53                	push   $0x53
  jmp alltraps
80105502:	e9 e1 f8 ff ff       	jmp    80104de8 <alltraps>
...
80105507:	6a 00                	push   $0x0
  pushl $84
80105509:	6a 54                	push   $0x54
  jmp alltraps
8010550b:	e9 d8 f8 ff ff       	jmp    80104de8 <alltraps>
...
80105510:	6a 00                	push   $0x0
  pushl $85
80105512:	6a 55                	push   $0x55
  jmp alltraps
80105514:	e9 cf f8 ff ff       	jmp    80104de8 <alltraps>
...
80105519:	6a 00                	push   $0x0
  pushl $86
8010551b:	6a 56                	push   $0x56
  jmp alltraps
8010551d:	e9 c6 f8 ff ff       	jmp    80104de8 <alltraps>
...
80105522:	6a 00                	push   $0x0
  pushl $87
80105524:	6a 57                	push   $0x57
  jmp alltraps
80105526:	e9 bd f8 ff ff       	jmp    80104de8 <alltraps>
...
8010552b:	6a 00                	push   $0x0
  pushl $88
8010552d:	6a 58                	push   $0x58
  jmp alltraps
8010552f:	e9 b4 f8 ff ff       	jmp    80104de8 <alltraps>
...
80105534:	6a 00                	push   $0x0
  pushl $89
80105536:	6a 59                	push   $0x59
  jmp alltraps
80105538:	e9 ab f8 ff ff       	jmp    80104de8 <alltraps>
...
8010553d:	6a 00                	push   $0x0
  pushl $90
8010553f:	6a 5a                	push   $0x5a
  jmp alltraps
80105541:	e9 a2 f8 ff ff       	jmp    80104de8 <alltraps>
...
80105546:	6a 00                	push   $0x0
  pushl $91
80105548:	6a 5b                	push   $0x5b
  jmp alltraps
8010554a:	e9 99 f8 ff ff       	jmp    80104de8 <alltraps>
...
8010554f:	6a 00                	push   $0x0
  pushl $92
80105551:	6a 5c                	push   $0x5c
  jmp alltraps
80105553:	e9 90 f8 ff ff       	jmp    80104de8 <alltraps>
...
80105558:	6a 00                	push   $0x0
  pushl $93
8010555a:	6a 5d                	push   $0x5d
  jmp alltraps
8010555c:	e9 87 f8 ff ff       	jmp    80104de8 <alltraps>
...
80105561:	6a 00                	push   $0x0
  pushl $94
80105563:	6a 5e                	push   $0x5e
  jmp alltraps
80105565:	e9 7e f8 ff ff       	jmp    80104de8 <alltraps>
...
8010556a:	6a 00                	push   $0x0
  pushl $95
8010556c:	6a 5f                	push   $0x5f
  jmp alltraps
8010556e:	e9 75 f8 ff ff       	jmp    80104de8 <alltraps>
...
80105573:	6a 00                	push   $0x0
  pushl $96
80105575:	6a 60                	push   $0x60
  jmp alltraps
80105577:	e9 6c f8 ff ff       	jmp    80104de8 <alltraps>
...
8010557c:	6a 00                	push   $0x0
  pushl $97
8010557e:	6a 61                	push   $0x61
  jmp alltraps
80105580:	e9 63 f8 ff ff       	jmp    80104de8 <alltraps>
...
80105585:	6a 00                	push   $0x0
  pushl $98
80105587:	6a 62                	push   $0x62
  jmp alltraps
80105589:	e9 5a f8 ff ff       	jmp    80104de8 <alltraps>
...
8010558e:	6a 00                	push   $0x0
  pushl $99
80105590:	6a 63                	push   $0x63
  jmp alltraps
80105592:	e9 51 f8 ff ff       	jmp    80104de8 <alltraps>
...
80105597:	6a 00                	push   $0x0
  pushl $100
80105599:	6a 64                	push   $0x64
  jmp alltraps
8010559b:	e9 48 f8 ff ff       	jmp    80104de8 <alltraps>
...
801055a0:	6a 00                	push   $0x0
  pushl $101
801055a2:	6a 65                	push   $0x65
  jmp alltraps
801055a4:	e9 3f f8 ff ff       	jmp    80104de8 <alltraps>
...
801055a9:	6a 00                	push   $0x0
  pushl $102
801055ab:	6a 66                	push   $0x66
  jmp alltraps
801055ad:	e9 36 f8 ff ff       	jmp    80104de8 <alltraps>
...
801055b2:	6a 00                	push   $0x0
  pushl $103
801055b4:	6a 67                	push   $0x67
  jmp alltraps
801055b6:	e9 2d f8 ff ff       	jmp    80104de8 <alltraps>
...
801055bb:	6a 00                	push   $0x0
  pushl $104
801055bd:	6a 68                	push   $0x68
  jmp alltraps
801055bf:	e9 24 f8 ff ff       	jmp    80104de8 <alltraps>
...
801055c4:	6a 00                	push   $0x0
  pushl $105
801055c6:	6a 69                	push   $0x69
  jmp alltraps
801055c8:	e9 1b f8 ff ff       	jmp    80104de8 <alltraps>
...
801055cd:	6a 00                	push   $0x0
  pushl $106
801055cf:	6a 6a                	push   $0x6a
  jmp alltraps
801055d1:	e9 12 f8 ff ff       	jmp    80104de8 <alltraps>
...
801055d6:	6a 00                	push   $0x0
  pushl $107
801055d8:	6a 6b                	push   $0x6b
  jmp alltraps
801055da:	e9 09 f8 ff ff       	jmp    80104de8 <alltraps>
...
801055df:	6a 00                	push   $0x0
  pushl $108
801055e1:	6a 6c                	push   $0x6c
  jmp alltraps
801055e3:	e9 00 f8 ff ff       	jmp    80104de8 <alltraps>
...
801055e8:	6a 00                	push   $0x0
  pushl $109
801055ea:	6a 6d                	push   $0x6d
  jmp alltraps
801055ec:	e9 f7 f7 ff ff       	jmp    80104de8 <alltraps>
...
801055f1:	6a 00                	push   $0x0
  pushl $110
801055f3:	6a 6e                	push   $0x6e
  jmp alltraps
801055f5:	e9 ee f7 ff ff       	jmp    80104de8 <alltraps>
...
801055fa:	6a 00                	push   $0x0
  pushl $111
801055fc:	6a 6f                	push   $0x6f
  jmp alltraps
801055fe:	e9 e5 f7 ff ff       	jmp    80104de8 <alltraps>
...
80105603:	6a 00                	push   $0x0
  pushl $112
80105605:	6a 70                	push   $0x70
  jmp alltraps
80105607:	e9 dc f7 ff ff       	jmp    80104de8 <alltraps>
...
8010560c:	6a 00                	push   $0x0
  pushl $113
8010560e:	6a 71                	push   $0x71
  jmp alltraps
80105610:	e9 d3 f7 ff ff       	jmp    80104de8 <alltraps>
...
80105615:	6a 00                	push   $0x0
  pushl $114
80105617:	6a 72                	push   $0x72
  jmp alltraps
80105619:	e9 ca f7 ff ff       	jmp    80104de8 <alltraps>
...
8010561e:	6a 00                	push   $0x0
  pushl $115
80105620:	6a 73                	push   $0x73
  jmp alltraps
80105622:	e9 c1 f7 ff ff       	jmp    80104de8 <alltraps>
...
80105627:	6a 00                	push   $0x0
  pushl $116
80105629:	6a 74                	push   $0x74
  jmp alltraps
8010562b:	e9 b8 f7 ff ff       	jmp    80104de8 <alltraps>
...
80105630:	6a 00                	push   $0x0
  pushl $117
80105632:	6a 75                	push   $0x75
  jmp alltraps
80105634:	e9 af f7 ff ff       	jmp    80104de8 <alltraps>
...
80105639:	6a 00                	push   $0x0
  pushl $118
8010563b:	6a 76                	push   $0x76
  jmp alltraps
8010563d:	e9 a6 f7 ff ff       	jmp    80104de8 <alltraps>
...
80105642:	6a 00                	push   $0x0
  pushl $119
80105644:	6a 77                	push   $0x77
  jmp alltraps
80105646:	e9 9d f7 ff ff       	jmp    80104de8 <alltraps>
...
8010564b:	6a 00                	push   $0x0
  pushl $120
8010564d:	6a 78                	push   $0x78
  jmp alltraps
8010564f:	e9 94 f7 ff ff       	jmp    80104de8 <alltraps>
...
80105654:	6a 00                	push   $0x0
  pushl $121
80105656:	6a 79                	push   $0x79
  jmp alltraps
80105658:	e9 8b f7 ff ff       	jmp    80104de8 <alltraps>
...
8010565d:	6a 00                	push   $0x0
  pushl $122
8010565f:	6a 7a                	push   $0x7a
  jmp alltraps
80105661:	e9 82 f7 ff ff       	jmp    80104de8 <alltraps>
...
80105666:	6a 00                	push   $0x0
  pushl $123
80105668:	6a 7b                	push   $0x7b
  jmp alltraps
8010566a:	e9 79 f7 ff ff       	jmp    80104de8 <alltraps>
...
8010566f:	6a 00                	push   $0x0
  pushl $124
80105671:	6a 7c                	push   $0x7c
  jmp alltraps
80105673:	e9 70 f7 ff ff       	jmp    80104de8 <alltraps>
...
80105678:	6a 00                	push   $0x0
  pushl $125
8010567a:	6a 7d                	push   $0x7d
  jmp alltraps
8010567c:	e9 67 f7 ff ff       	jmp    80104de8 <alltraps>
...
80105681:	6a 00                	push   $0x0
  pushl $126
80105683:	6a 7e                	push   $0x7e
  jmp alltraps
80105685:	e9 5e f7 ff ff       	jmp    80104de8 <alltraps>
...
8010568a:	6a 00                	push   $0x0
  pushl $127
8010568c:	6a 7f                	push   $0x7f
  jmp alltraps
8010568e:	e9 55 f7 ff ff       	jmp    80104de8 <alltraps>
...
80105693:	6a 00                	push   $0x0
  pushl $128
80105695:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010569a:	e9 49 f7 ff ff       	jmp    80104de8 <alltraps>
...
8010569f:	6a 00                	push   $0x0
  pushl $129
801056a1:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801056a6:	e9 3d f7 ff ff       	jmp    80104de8 <alltraps>
...
801056ab:	6a 00                	push   $0x0
  pushl $130
801056ad:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801056b2:	e9 31 f7 ff ff       	jmp    80104de8 <alltraps>
...
801056b7:	6a 00                	push   $0x0
  pushl $131
801056b9:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801056be:	e9 25 f7 ff ff       	jmp    80104de8 <alltraps>
...
801056c3:	6a 00                	push   $0x0
  pushl $132
801056c5:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801056ca:	e9 19 f7 ff ff       	jmp    80104de8 <alltraps>
...
801056cf:	6a 00                	push   $0x0
  pushl $133
801056d1:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801056d6:	e9 0d f7 ff ff       	jmp    80104de8 <alltraps>
...
801056db:	6a 00                	push   $0x0
  pushl $134
801056dd:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801056e2:	e9 01 f7 ff ff       	jmp    80104de8 <alltraps>
...
801056e7:	6a 00                	push   $0x0
  pushl $135
801056e9:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801056ee:	e9 f5 f6 ff ff       	jmp    80104de8 <alltraps>
...
801056f3:	6a 00                	push   $0x0
  pushl $136
801056f5:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801056fa:	e9 e9 f6 ff ff       	jmp    80104de8 <alltraps>
...
801056ff:	6a 00                	push   $0x0
  pushl $137
80105701:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80105706:	e9 dd f6 ff ff       	jmp    80104de8 <alltraps>
...
8010570b:	6a 00                	push   $0x0
  pushl $138
8010570d:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80105712:	e9 d1 f6 ff ff       	jmp    80104de8 <alltraps>
...
80105717:	6a 00                	push   $0x0
  pushl $139
80105719:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
8010571e:	e9 c5 f6 ff ff       	jmp    80104de8 <alltraps>
...
80105723:	6a 00                	push   $0x0
  pushl $140
80105725:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010572a:	e9 b9 f6 ff ff       	jmp    80104de8 <alltraps>
...
8010572f:	6a 00                	push   $0x0
  pushl $141
80105731:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80105736:	e9 ad f6 ff ff       	jmp    80104de8 <alltraps>
...
8010573b:	6a 00                	push   $0x0
  pushl $142
8010573d:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80105742:	e9 a1 f6 ff ff       	jmp    80104de8 <alltraps>
...
80105747:	6a 00                	push   $0x0
  pushl $143
80105749:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
8010574e:	e9 95 f6 ff ff       	jmp    80104de8 <alltraps>
...
80105753:	6a 00                	push   $0x0
  pushl $144
80105755:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010575a:	e9 89 f6 ff ff       	jmp    80104de8 <alltraps>
...
8010575f:	6a 00                	push   $0x0
  pushl $145
80105761:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80105766:	e9 7d f6 ff ff       	jmp    80104de8 <alltraps>
...
8010576b:	6a 00                	push   $0x0
  pushl $146
8010576d:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80105772:	e9 71 f6 ff ff       	jmp    80104de8 <alltraps>
...
80105777:	6a 00                	push   $0x0
  pushl $147
80105779:	68 93 00 00 00       	push   $0x93
  jmp alltraps
8010577e:	e9 65 f6 ff ff       	jmp    80104de8 <alltraps>
...
80105783:	6a 00                	push   $0x0
  pushl $148
80105785:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010578a:	e9 59 f6 ff ff       	jmp    80104de8 <alltraps>
...
8010578f:	6a 00                	push   $0x0
  pushl $149
80105791:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80105796:	e9 4d f6 ff ff       	jmp    80104de8 <alltraps>
...
8010579b:	6a 00                	push   $0x0
  pushl $150
8010579d:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801057a2:	e9 41 f6 ff ff       	jmp    80104de8 <alltraps>
...
801057a7:	6a 00                	push   $0x0
  pushl $151
801057a9:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801057ae:	e9 35 f6 ff ff       	jmp    80104de8 <alltraps>
...
801057b3:	6a 00                	push   $0x0
  pushl $152
801057b5:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801057ba:	e9 29 f6 ff ff       	jmp    80104de8 <alltraps>
...
801057bf:	6a 00                	push   $0x0
  pushl $153
801057c1:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801057c6:	e9 1d f6 ff ff       	jmp    80104de8 <alltraps>
...
801057cb:	6a 00                	push   $0x0
  pushl $154
801057cd:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801057d2:	e9 11 f6 ff ff       	jmp    80104de8 <alltraps>
...
801057d7:	6a 00                	push   $0x0
  pushl $155
801057d9:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801057de:	e9 05 f6 ff ff       	jmp    80104de8 <alltraps>
...
801057e3:	6a 00                	push   $0x0
  pushl $156
801057e5:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801057ea:	e9 f9 f5 ff ff       	jmp    80104de8 <alltraps>
...
801057ef:	6a 00                	push   $0x0
  pushl $157
801057f1:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801057f6:	e9 ed f5 ff ff       	jmp    80104de8 <alltraps>
...
801057fb:	6a 00                	push   $0x0
  pushl $158
801057fd:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80105802:	e9 e1 f5 ff ff       	jmp    80104de8 <alltraps>
...
80105807:	6a 00                	push   $0x0
  pushl $159
80105809:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
8010580e:	e9 d5 f5 ff ff       	jmp    80104de8 <alltraps>
...
80105813:	6a 00                	push   $0x0
  pushl $160
80105815:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010581a:	e9 c9 f5 ff ff       	jmp    80104de8 <alltraps>
...
8010581f:	6a 00                	push   $0x0
  pushl $161
80105821:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80105826:	e9 bd f5 ff ff       	jmp    80104de8 <alltraps>
...
8010582b:	6a 00                	push   $0x0
  pushl $162
8010582d:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80105832:	e9 b1 f5 ff ff       	jmp    80104de8 <alltraps>
...
80105837:	6a 00                	push   $0x0
  pushl $163
80105839:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
8010583e:	e9 a5 f5 ff ff       	jmp    80104de8 <alltraps>
...
80105843:	6a 00                	push   $0x0
  pushl $164
80105845:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010584a:	e9 99 f5 ff ff       	jmp    80104de8 <alltraps>
...
8010584f:	6a 00                	push   $0x0
  pushl $165
80105851:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80105856:	e9 8d f5 ff ff       	jmp    80104de8 <alltraps>
...
8010585b:	6a 00                	push   $0x0
  pushl $166
8010585d:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80105862:	e9 81 f5 ff ff       	jmp    80104de8 <alltraps>
...
80105867:	6a 00                	push   $0x0
  pushl $167
80105869:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
8010586e:	e9 75 f5 ff ff       	jmp    80104de8 <alltraps>
...
80105873:	6a 00                	push   $0x0
  pushl $168
80105875:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010587a:	e9 69 f5 ff ff       	jmp    80104de8 <alltraps>
...
8010587f:	6a 00                	push   $0x0
  pushl $169
80105881:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80105886:	e9 5d f5 ff ff       	jmp    80104de8 <alltraps>
...
8010588b:	6a 00                	push   $0x0
  pushl $170
8010588d:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80105892:	e9 51 f5 ff ff       	jmp    80104de8 <alltraps>
...
80105897:	6a 00                	push   $0x0
  pushl $171
80105899:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
8010589e:	e9 45 f5 ff ff       	jmp    80104de8 <alltraps>
...
801058a3:	6a 00                	push   $0x0
  pushl $172
801058a5:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801058aa:	e9 39 f5 ff ff       	jmp    80104de8 <alltraps>
...
801058af:	6a 00                	push   $0x0
  pushl $173
801058b1:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801058b6:	e9 2d f5 ff ff       	jmp    80104de8 <alltraps>
...
801058bb:	6a 00                	push   $0x0
  pushl $174
801058bd:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801058c2:	e9 21 f5 ff ff       	jmp    80104de8 <alltraps>
...
801058c7:	6a 00                	push   $0x0
  pushl $175
801058c9:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801058ce:	e9 15 f5 ff ff       	jmp    80104de8 <alltraps>
...
801058d3:	6a 00                	push   $0x0
  pushl $176
801058d5:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801058da:	e9 09 f5 ff ff       	jmp    80104de8 <alltraps>
...
801058df:	6a 00                	push   $0x0
  pushl $177
801058e1:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801058e6:	e9 fd f4 ff ff       	jmp    80104de8 <alltraps>
...
801058eb:	6a 00                	push   $0x0
  pushl $178
801058ed:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801058f2:	e9 f1 f4 ff ff       	jmp    80104de8 <alltraps>
...
801058f7:	6a 00                	push   $0x0
  pushl $179
801058f9:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801058fe:	e9 e5 f4 ff ff       	jmp    80104de8 <alltraps>
...
80105903:	6a 00                	push   $0x0
  pushl $180
80105905:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010590a:	e9 d9 f4 ff ff       	jmp    80104de8 <alltraps>
...
8010590f:	6a 00                	push   $0x0
  pushl $181
80105911:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80105916:	e9 cd f4 ff ff       	jmp    80104de8 <alltraps>
...
8010591b:	6a 00                	push   $0x0
  pushl $182
8010591d:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80105922:	e9 c1 f4 ff ff       	jmp    80104de8 <alltraps>
...
80105927:	6a 00                	push   $0x0
  pushl $183
80105929:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
8010592e:	e9 b5 f4 ff ff       	jmp    80104de8 <alltraps>
...
80105933:	6a 00                	push   $0x0
  pushl $184
80105935:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010593a:	e9 a9 f4 ff ff       	jmp    80104de8 <alltraps>
...
8010593f:	6a 00                	push   $0x0
  pushl $185
80105941:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80105946:	e9 9d f4 ff ff       	jmp    80104de8 <alltraps>
...
8010594b:	6a 00                	push   $0x0
  pushl $186
8010594d:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80105952:	e9 91 f4 ff ff       	jmp    80104de8 <alltraps>
...
80105957:	6a 00                	push   $0x0
  pushl $187
80105959:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
8010595e:	e9 85 f4 ff ff       	jmp    80104de8 <alltraps>
...
80105963:	6a 00                	push   $0x0
  pushl $188
80105965:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010596a:	e9 79 f4 ff ff       	jmp    80104de8 <alltraps>
...
8010596f:	6a 00                	push   $0x0
  pushl $189
80105971:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80105976:	e9 6d f4 ff ff       	jmp    80104de8 <alltraps>
...
8010597b:	6a 00                	push   $0x0
  pushl $190
8010597d:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80105982:	e9 61 f4 ff ff       	jmp    80104de8 <alltraps>
...
80105987:	6a 00                	push   $0x0
  pushl $191
80105989:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
8010598e:	e9 55 f4 ff ff       	jmp    80104de8 <alltraps>
...
80105993:	6a 00                	push   $0x0
  pushl $192
80105995:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010599a:	e9 49 f4 ff ff       	jmp    80104de8 <alltraps>
...
8010599f:	6a 00                	push   $0x0
  pushl $193
801059a1:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801059a6:	e9 3d f4 ff ff       	jmp    80104de8 <alltraps>
...
801059ab:	6a 00                	push   $0x0
  pushl $194
801059ad:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801059b2:	e9 31 f4 ff ff       	jmp    80104de8 <alltraps>
...
801059b7:	6a 00                	push   $0x0
  pushl $195
801059b9:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801059be:	e9 25 f4 ff ff       	jmp    80104de8 <alltraps>
...
801059c3:	6a 00                	push   $0x0
  pushl $196
801059c5:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801059ca:	e9 19 f4 ff ff       	jmp    80104de8 <alltraps>
...
801059cf:	6a 00                	push   $0x0
  pushl $197
801059d1:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801059d6:	e9 0d f4 ff ff       	jmp    80104de8 <alltraps>
...
801059db:	6a 00                	push   $0x0
  pushl $198
801059dd:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801059e2:	e9 01 f4 ff ff       	jmp    80104de8 <alltraps>
...
801059e7:	6a 00                	push   $0x0
  pushl $199
801059e9:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801059ee:	e9 f5 f3 ff ff       	jmp    80104de8 <alltraps>
...
801059f3:	6a 00                	push   $0x0
  pushl $200
801059f5:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801059fa:	e9 e9 f3 ff ff       	jmp    80104de8 <alltraps>
...
801059ff:	6a 00                	push   $0x0
  pushl $201
80105a01:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80105a06:	e9 dd f3 ff ff       	jmp    80104de8 <alltraps>
...
80105a0b:	6a 00                	push   $0x0
  pushl $202
80105a0d:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80105a12:	e9 d1 f3 ff ff       	jmp    80104de8 <alltraps>
...
80105a17:	6a 00                	push   $0x0
  pushl $203
80105a19:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80105a1e:	e9 c5 f3 ff ff       	jmp    80104de8 <alltraps>
...
80105a23:	6a 00                	push   $0x0
  pushl $204
80105a25:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80105a2a:	e9 b9 f3 ff ff       	jmp    80104de8 <alltraps>
...
80105a2f:	6a 00                	push   $0x0
  pushl $205
80105a31:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80105a36:	e9 ad f3 ff ff       	jmp    80104de8 <alltraps>
...
80105a3b:	6a 00                	push   $0x0
  pushl $206
80105a3d:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80105a42:	e9 a1 f3 ff ff       	jmp    80104de8 <alltraps>
...
80105a47:	6a 00                	push   $0x0
  pushl $207
80105a49:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80105a4e:	e9 95 f3 ff ff       	jmp    80104de8 <alltraps>
...
80105a53:	6a 00                	push   $0x0
  pushl $208
80105a55:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80105a5a:	e9 89 f3 ff ff       	jmp    80104de8 <alltraps>
...
80105a5f:	6a 00                	push   $0x0
  pushl $209
80105a61:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80105a66:	e9 7d f3 ff ff       	jmp    80104de8 <alltraps>
...
80105a6b:	6a 00                	push   $0x0
  pushl $210
80105a6d:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80105a72:	e9 71 f3 ff ff       	jmp    80104de8 <alltraps>
...
80105a77:	6a 00                	push   $0x0
  pushl $211
80105a79:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80105a7e:	e9 65 f3 ff ff       	jmp    80104de8 <alltraps>
...
80105a83:	6a 00                	push   $0x0
  pushl $212
80105a85:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80105a8a:	e9 59 f3 ff ff       	jmp    80104de8 <alltraps>
...
80105a8f:	6a 00                	push   $0x0
  pushl $213
80105a91:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80105a96:	e9 4d f3 ff ff       	jmp    80104de8 <alltraps>
...
80105a9b:	6a 00                	push   $0x0
  pushl $214
80105a9d:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80105aa2:	e9 41 f3 ff ff       	jmp    80104de8 <alltraps>
...
80105aa7:	6a 00                	push   $0x0
  pushl $215
80105aa9:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80105aae:	e9 35 f3 ff ff       	jmp    80104de8 <alltraps>
...
80105ab3:	6a 00                	push   $0x0
  pushl $216
80105ab5:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80105aba:	e9 29 f3 ff ff       	jmp    80104de8 <alltraps>
...
80105abf:	6a 00                	push   $0x0
  pushl $217
80105ac1:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80105ac6:	e9 1d f3 ff ff       	jmp    80104de8 <alltraps>
...
80105acb:	6a 00                	push   $0x0
  pushl $218
80105acd:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80105ad2:	e9 11 f3 ff ff       	jmp    80104de8 <alltraps>
...
80105ad7:	6a 00                	push   $0x0
  pushl $219
80105ad9:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80105ade:	e9 05 f3 ff ff       	jmp    80104de8 <alltraps>
...
80105ae3:	6a 00                	push   $0x0
  pushl $220
80105ae5:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80105aea:	e9 f9 f2 ff ff       	jmp    80104de8 <alltraps>
...
80105aef:	6a 00                	push   $0x0
  pushl $221
80105af1:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80105af6:	e9 ed f2 ff ff       	jmp    80104de8 <alltraps>
...
80105afb:	6a 00                	push   $0x0
  pushl $222
80105afd:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80105b02:	e9 e1 f2 ff ff       	jmp    80104de8 <alltraps>
...
80105b07:	6a 00                	push   $0x0
  pushl $223
80105b09:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80105b0e:	e9 d5 f2 ff ff       	jmp    80104de8 <alltraps>
...
80105b13:	6a 00                	push   $0x0
  pushl $224
80105b15:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80105b1a:	e9 c9 f2 ff ff       	jmp    80104de8 <alltraps>
...
80105b1f:	6a 00                	push   $0x0
  pushl $225
80105b21:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80105b26:	e9 bd f2 ff ff       	jmp    80104de8 <alltraps>
...
80105b2b:	6a 00                	push   $0x0
  pushl $226
80105b2d:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80105b32:	e9 b1 f2 ff ff       	jmp    80104de8 <alltraps>
...
80105b37:	6a 00                	push   $0x0
  pushl $227
80105b39:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80105b3e:	e9 a5 f2 ff ff       	jmp    80104de8 <alltraps>
...
80105b43:	6a 00                	push   $0x0
  pushl $228
80105b45:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80105b4a:	e9 99 f2 ff ff       	jmp    80104de8 <alltraps>
...
80105b4f:	6a 00                	push   $0x0
  pushl $229
80105b51:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80105b56:	e9 8d f2 ff ff       	jmp    80104de8 <alltraps>
...
80105b5b:	6a 00                	push   $0x0
  pushl $230
80105b5d:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80105b62:	e9 81 f2 ff ff       	jmp    80104de8 <alltraps>
...
80105b67:	6a 00                	push   $0x0
  pushl $231
80105b69:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80105b6e:	e9 75 f2 ff ff       	jmp    80104de8 <alltraps>
...
80105b73:	6a 00                	push   $0x0
  pushl $232
80105b75:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80105b7a:	e9 69 f2 ff ff       	jmp    80104de8 <alltraps>
...
80105b7f:	6a 00                	push   $0x0
  pushl $233
80105b81:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80105b86:	e9 5d f2 ff ff       	jmp    80104de8 <alltraps>
...
80105b8b:	6a 00                	push   $0x0
  pushl $234
80105b8d:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80105b92:	e9 51 f2 ff ff       	jmp    80104de8 <alltraps>
...
80105b97:	6a 00                	push   $0x0
  pushl $235
80105b99:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80105b9e:	e9 45 f2 ff ff       	jmp    80104de8 <alltraps>
...
80105ba3:	6a 00                	push   $0x0
  pushl $236
80105ba5:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80105baa:	e9 39 f2 ff ff       	jmp    80104de8 <alltraps>
...
80105baf:	6a 00                	push   $0x0
  pushl $237
80105bb1:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80105bb6:	e9 2d f2 ff ff       	jmp    80104de8 <alltraps>
...
80105bbb:	6a 00                	push   $0x0
  pushl $238
80105bbd:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80105bc2:	e9 21 f2 ff ff       	jmp    80104de8 <alltraps>
...
80105bc7:	6a 00                	push   $0x0
  pushl $239
80105bc9:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80105bce:	e9 15 f2 ff ff       	jmp    80104de8 <alltraps>
...
80105bd3:	6a 00                	push   $0x0
  pushl $240
80105bd5:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80105bda:	e9 09 f2 ff ff       	jmp    80104de8 <alltraps>
...
80105bdf:	6a 00                	push   $0x0
  pushl $241
80105be1:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80105be6:	e9 fd f1 ff ff       	jmp    80104de8 <alltraps>
...
80105beb:	6a 00                	push   $0x0
  pushl $242
80105bed:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80105bf2:	e9 f1 f1 ff ff       	jmp    80104de8 <alltraps>
...
80105bf7:	6a 00                	push   $0x0
  pushl $243
80105bf9:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80105bfe:	e9 e5 f1 ff ff       	jmp    80104de8 <alltraps>
...
80105c03:	6a 00                	push   $0x0
  pushl $244
80105c05:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80105c0a:	e9 d9 f1 ff ff       	jmp    80104de8 <alltraps>
...
80105c0f:	6a 00                	push   $0x0
  pushl $245
80105c11:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80105c16:	e9 cd f1 ff ff       	jmp    80104de8 <alltraps>
...
80105c1b:	6a 00                	push   $0x0
  pushl $246
80105c1d:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80105c22:	e9 c1 f1 ff ff       	jmp    80104de8 <alltraps>
...
80105c27:	6a 00                	push   $0x0
  pushl $247
80105c29:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80105c2e:	e9 b5 f1 ff ff       	jmp    80104de8 <alltraps>
...
80105c33:	6a 00                	push   $0x0
  pushl $248
80105c35:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80105c3a:	e9 a9 f1 ff ff       	jmp    80104de8 <alltraps>
...
80105c3f:	6a 00                	push   $0x0
  pushl $249
80105c41:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80105c46:	e9 9d f1 ff ff       	jmp    80104de8 <alltraps>
...
80105c4b:	6a 00                	push   $0x0
  pushl $250
80105c4d:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80105c52:	e9 91 f1 ff ff       	jmp    80104de8 <alltraps>
...
80105c57:	6a 00                	push   $0x0
  pushl $251
80105c59:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80105c5e:	e9 85 f1 ff ff       	jmp    80104de8 <alltraps>
...
80105c63:	6a 00                	push   $0x0
  pushl $252
80105c65:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80105c6a:	e9 79 f1 ff ff       	jmp    80104de8 <alltraps>
...
80105c6f:	6a 00                	push   $0x0
  pushl $253
80105c71:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80105c76:	e9 6d f1 ff ff       	jmp    80104de8 <alltraps>
...
80105c7b:	6a 00                	push   $0x0
  pushl $254
80105c7d:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80105c82:	e9 61 f1 ff ff       	jmp    80104de8 <alltraps>
...
80105c87:	6a 00                	push   $0x0
  pushl $255
80105c89:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80105c8e:	e9 55 f1 ff ff       	jmp    80104de8 <alltraps>
...
80105c9c:	89 d6                	mov    %edx,%esi
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
80105c9e:	c1 ea 16             	shr    $0x16,%edx
80105ca1:	8d 3c 90             	lea    (%eax,%edx,4),%edi
  if(*pde & PTE_P){
80105ca4:	8b 1f                	mov    (%edi),%ebx
80105ca6:	f6 c3 01             	test   $0x1,%bl
80105ca9:	74 22                	je     80105ccd <walkpgdir+0x3a>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80105cab:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
80105cb1:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
  ...
  return &pgtab[PTX(va)];
80105cb7:	c1 ee 0c             	shr    $0xc,%esi
80105cba:	81 e6 ff 03 00 00    	and    $0x3ff,%esi
80105cc0:	8d 1c b3             	lea    (%ebx,%esi,4),%ebx
}
...
80105ccf:	74 2b                	je     80105cfc <walkpgdir+0x69>
80105cd1:	e8 e5 c3 ff ff       	call   801020bb <kalloc>
80105cd6:	89 c3                	mov    %eax,%ebx
80105cd8:	85 c0                	test   %eax,%eax
80105cda:	74 e7                	je     80105cc3 <walkpgdir+0x30>
    memset(pgtab, 0, PGSIZE);
80105cdc:	83 ec 04             	sub    $0x4,%esp
80105cdf:	68 00 10 00 00       	push   $0x1000
80105ce4:	6a 00                	push   $0x0
80105ce6:	50                   	push   %eax
80105ce7:	e8 04 e0 ff ff       	call   80103cf0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80105cec:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80105cf2:	83 c8 07             	or     $0x7,%eax
80105cf5:	89 07                	mov    %eax,(%edi)
80105cf7:	83 c4 10             	add    $0x10,%esp
80105cfa:	eb bb                	jmp    80105cb7 <walkpgdir+0x24>
      return 0;
80105cfc:	bb 00 00 00 00       	mov    $0x0,%ebx
80105d01:	eb c0                	jmp    80105cc3 <walkpgdir+0x30>
...
80105d09:	83 ec 1c             	sub    $0x1c,%esp
80105d0c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80105d0f:	8b 75 08             	mov    0x8(%ebp),%esi
  char *a, *last;
  pte_t *pte;

  a = (char*)PGROUNDDOWN((uint)va);
80105d12:	89 d3                	mov    %edx,%ebx
80105d14:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80105d1a:	8d 7c 0a ff          	lea    -0x1(%edx,%ecx,1),%edi
80105d1e:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80105d24:	b9 01 00 00 00       	mov    $0x1,%ecx
80105d29:	89 da                	mov    %ebx,%edx
80105d2b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105d2e:	e8 60 ff ff ff       	call   80105c93 <walkpgdir>
80105d33:	85 c0                	test   %eax,%eax
80105d35:	74 2e                	je     80105d65 <mappages+0x62>
      return -1;
    if(*pte & PTE_P)
80105d37:	f6 00 01             	testb  $0x1,(%eax)
80105d3a:	75 1c                	jne    80105d58 <mappages+0x55>
      panic("remap");
    *pte = pa | perm | PTE_P;
80105d3c:	89 f2                	mov    %esi,%edx
80105d3e:	0b 55 0c             	or     0xc(%ebp),%edx
80105d41:	83 ca 01             	or     $0x1,%edx
80105d44:	89 10                	mov    %edx,(%eax)
    if(a == last)
80105d46:	39 fb                	cmp    %edi,%ebx
80105d48:	74 28                	je     80105d72 <mappages+0x6f>
      break;
    a += PGSIZE;
80105d4a:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    pa += PGSIZE;
80105d50:	81 c6 00 10 00 00    	add    $0x1000,%esi
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80105d56:	eb cc                	jmp    80105d24 <mappages+0x21>
      panic("remap");
80105d58:	83 ec 0c             	sub    $0xc,%esp
80105d5b:	68 0c 6e 10 80       	push   $0x80106e0c
80105d60:	e8 e3 a5 ff ff       	call   80100348 <panic>
      return -1;
...
80105d77:	eb f1                	jmp    80105d6a <mappages+0x67>
...
80105d7d:	83 ec 14             	sub    $0x14,%esp
  c = &cpus[cpuid()];
80105d80:	e8 8b d4 ff ff       	call   80103210 <cpuid>
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80105d85:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
80105d8b:	66 c7 80 f8 17 11 80 	movw   $0xffff,-0x7feee808(%eax)
80105d92:	ff ff 
80105d94:	66 c7 80 fa 17 11 80 	movw   $0x0,-0x7feee806(%eax)
80105d9b:	00 00 
80105d9d:	c6 80 fc 17 11 80 00 	movb   $0x0,-0x7feee804(%eax)
80105da4:	0f b6 88 fd 17 11 80 	movzbl -0x7feee803(%eax),%ecx
80105dab:	83 e1 f0             	and    $0xfffffff0,%ecx
80105dae:	83 c9 1a             	or     $0x1a,%ecx
80105db1:	83 e1 9f             	and    $0xffffff9f,%ecx
80105db4:	83 c9 80             	or     $0xffffff80,%ecx
80105db7:	88 88 fd 17 11 80    	mov    %cl,-0x7feee803(%eax)
80105dbd:	0f b6 88 fe 17 11 80 	movzbl -0x7feee802(%eax),%ecx
80105dc4:	83 c9 0f             	or     $0xf,%ecx
80105dc7:	83 e1 cf             	and    $0xffffffcf,%ecx
80105dca:	83 c9 c0             	or     $0xffffffc0,%ecx
80105dcd:	88 88 fe 17 11 80    	mov    %cl,-0x7feee802(%eax)
80105dd3:	c6 80 ff 17 11 80 00 	movb   $0x0,-0x7feee801(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80105dda:	66 c7 80 00 18 11 80 	movw   $0xffff,-0x7feee800(%eax)
80105de1:	ff ff 
80105de3:	66 c7 80 02 18 11 80 	movw   $0x0,-0x7feee7fe(%eax)
80105dea:	00 00 
80105dec:	c6 80 04 18 11 80 00 	movb   $0x0,-0x7feee7fc(%eax)
80105df3:	0f b6 88 05 18 11 80 	movzbl -0x7feee7fb(%eax),%ecx
80105dfa:	83 e1 f0             	and    $0xfffffff0,%ecx
80105dfd:	83 c9 12             	or     $0x12,%ecx
80105e00:	83 e1 9f             	and    $0xffffff9f,%ecx
80105e03:	83 c9 80             	or     $0xffffff80,%ecx
80105e06:	88 88 05 18 11 80    	mov    %cl,-0x7feee7fb(%eax)
80105e0c:	0f b6 88 06 18 11 80 	movzbl -0x7feee7fa(%eax),%ecx
80105e13:	83 c9 0f             	or     $0xf,%ecx
80105e16:	83 e1 cf             	and    $0xffffffcf,%ecx
80105e19:	83 c9 c0             	or     $0xffffffc0,%ecx
80105e1c:	88 88 06 18 11 80    	mov    %cl,-0x7feee7fa(%eax)
80105e22:	c6 80 07 18 11 80 00 	movb   $0x0,-0x7feee7f9(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80105e29:	66 c7 80 08 18 11 80 	movw   $0xffff,-0x7feee7f8(%eax)
80105e30:	ff ff 
80105e32:	66 c7 80 0a 18 11 80 	movw   $0x0,-0x7feee7f6(%eax)
80105e39:	00 00 
80105e3b:	c6 80 0c 18 11 80 00 	movb   $0x0,-0x7feee7f4(%eax)
80105e42:	c6 80 0d 18 11 80 fa 	movb   $0xfa,-0x7feee7f3(%eax)
80105e49:	0f b6 88 0e 18 11 80 	movzbl -0x7feee7f2(%eax),%ecx
80105e50:	83 c9 0f             	or     $0xf,%ecx
80105e53:	83 e1 cf             	and    $0xffffffcf,%ecx
80105e56:	83 c9 c0             	or     $0xffffffc0,%ecx
80105e59:	88 88 0e 18 11 80    	mov    %cl,-0x7feee7f2(%eax)
80105e5f:	c6 80 0f 18 11 80 00 	movb   $0x0,-0x7feee7f1(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80105e66:	66 c7 80 10 18 11 80 	movw   $0xffff,-0x7feee7f0(%eax)
80105e6d:	ff ff 
80105e6f:	66 c7 80 12 18 11 80 	movw   $0x0,-0x7feee7ee(%eax)
80105e76:	00 00 
80105e78:	c6 80 14 18 11 80 00 	movb   $0x0,-0x7feee7ec(%eax)
80105e7f:	c6 80 15 18 11 80 f2 	movb   $0xf2,-0x7feee7eb(%eax)
80105e86:	0f b6 88 16 18 11 80 	movzbl -0x7feee7ea(%eax),%ecx
80105e8d:	83 c9 0f             	or     $0xf,%ecx
80105e90:	83 e1 cf             	and    $0xffffffcf,%ecx
80105e93:	83 c9 c0             	or     $0xffffffc0,%ecx
80105e96:	88 88 16 18 11 80    	mov    %cl,-0x7feee7ea(%eax)
80105e9c:	c6 80 17 18 11 80 00 	movb   $0x0,-0x7feee7e9(%eax)
  lgdt(c->gdt, sizeof(c->gdt));
80105ea3:	05 f0 17 11 80       	add    $0x801117f0,%eax
  pd[0] = size-1;
80105ea8:	66 c7 45 f2 2f 00    	movw   $0x2f,-0xe(%ebp)
  pd[1] = (uint)p;
80105eae:	66 89 45 f4          	mov    %ax,-0xc(%ebp)
  pd[2] = (uint)p >> 16;
80105eb2:	c1 e8 10             	shr    $0x10,%eax
80105eb5:	66 89 45 f6          	mov    %ax,-0xa(%ebp)
  asm volatile("lgdt (%0)" : : "r" (pd));
80105eb9:	8d 45 f2             	lea    -0xe(%ebp),%eax
80105ebc:	0f 01 10             	lgdtl  (%eax)
}
...
80105ec8:	a1 a4 54 11 80       	mov    0x801154a4,%eax
80105ecd:	05 00 00 00 80       	add    $0x80000000,%eax
}
...
80105edd:	83 ec 1c             	sub    $0x1c,%esp
80105ee0:	8b 75 08             	mov    0x8(%ebp),%esi
  if(p == 0)
80105ee3:	85 f6                	test   %esi,%esi
80105ee5:	0f 84 dd 00 00 00    	je     80105fc8 <switchuvm+0xf1>
    panic("switchuvm: no process");
  if(p->kstack == 0)
80105eeb:	83 7e 08 00          	cmpl   $0x0,0x8(%esi)
80105eef:	0f 84 e0 00 00 00    	je     80105fd5 <switchuvm+0xfe>
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
80105ef5:	83 7e 04 00          	cmpl   $0x0,0x4(%esi)
80105ef9:	0f 84 e3 00 00 00    	je     80105fe2 <switchuvm+0x10b>
    panic("switchuvm: no pgdir");

  pushcli();
80105eff:	e8 63 dc ff ff       	call   80103b67 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80105f04:	e8 ab d2 ff ff       	call   801031b4 <mycpu>
80105f09:	89 c3                	mov    %eax,%ebx
80105f0b:	e8 a4 d2 ff ff       	call   801031b4 <mycpu>
80105f10:	8d 78 08             	lea    0x8(%eax),%edi
80105f13:	e8 9c d2 ff ff       	call   801031b4 <mycpu>
80105f18:	83 c0 08             	add    $0x8,%eax
80105f1b:	c1 e8 10             	shr    $0x10,%eax
80105f1e:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80105f21:	e8 8e d2 ff ff       	call   801031b4 <mycpu>
80105f26:	83 c0 08             	add    $0x8,%eax
80105f29:	c1 e8 18             	shr    $0x18,%eax
80105f2c:	66 c7 83 98 00 00 00 	movw   $0x67,0x98(%ebx)
80105f33:	67 00 
80105f35:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
80105f3c:	0f b6 4d e4          	movzbl -0x1c(%ebp),%ecx
80105f40:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
80105f46:	0f b6 93 9d 00 00 00 	movzbl 0x9d(%ebx),%edx
80105f4d:	83 e2 f0             	and    $0xfffffff0,%edx
80105f50:	83 ca 19             	or     $0x19,%edx
80105f53:	83 e2 9f             	and    $0xffffff9f,%edx
80105f56:	83 ca 80             	or     $0xffffff80,%edx
80105f59:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80105f5f:	c6 83 9e 00 00 00 40 	movb   $0x40,0x9e(%ebx)
80105f66:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
80105f6c:	e8 43 d2 ff ff       	call   801031b4 <mycpu>
80105f71:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80105f78:	83 e2 ef             	and    $0xffffffef,%edx
80105f7b:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80105f81:	e8 2e d2 ff ff       	call   801031b4 <mycpu>
80105f86:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80105f8c:	8b 5e 08             	mov    0x8(%esi),%ebx
80105f8f:	e8 20 d2 ff ff       	call   801031b4 <mycpu>
80105f94:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80105f9a:	89 58 0c             	mov    %ebx,0xc(%eax)
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80105f9d:	e8 12 d2 ff ff       	call   801031b4 <mycpu>
80105fa2:	66 c7 40 6e ff ff    	movw   $0xffff,0x6e(%eax)
  asm volatile("ltr %0" : : "r" (sel));
80105fa8:	b8 28 00 00 00       	mov    $0x28,%eax
80105fad:	0f 00 d8             	ltr    %ax
  ltr(SEG_TSS << 3);
  lcr3(V2P(p->pgdir));  // switch to process's address space
80105fb0:	8b 46 04             	mov    0x4(%esi),%eax
80105fb3:	05 00 00 00 80       	add    $0x80000000,%eax
  asm volatile("movl %0,%%cr3" : : "r" (val));
80105fb8:	0f 22 d8             	mov    %eax,%cr3
  popcli();
80105fbb:	e8 e4 db ff ff       	call   80103ba4 <popcli>
}
80105fc0:	8d 65 f4             	lea    -0xc(%ebp),%esp
80105fc3:	5b                   	pop    %ebx
80105fc4:	5e                   	pop    %esi
80105fc5:	5f                   	pop    %edi
80105fc6:	5d                   	pop    %ebp
...
80105fcb:	68 12 6e 10 80       	push   $0x80106e12
80105fd0:	e8 73 a3 ff ff       	call   80100348 <panic>
    panic("switchuvm: no kstack");
80105fd5:	83 ec 0c             	sub    $0xc,%esp
80105fd8:	68 28 6e 10 80       	push   $0x80106e28
80105fdd:	e8 66 a3 ff ff       	call   80100348 <panic>
    panic("switchuvm: no pgdir");
80105fe2:	83 ec 0c             	sub    $0xc,%esp
80105fe5:	68 3d 6e 10 80       	push   $0x80106e3d
80105fea:	e8 59 a3 ff ff       	call   80100348 <panic>
...
80105ff4:	8b 75 10             	mov    0x10(%ebp),%esi
  char *mem;

  if(sz >= PGSIZE)
80105ff7:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
80105ffd:	77 4c                	ja     8010604b <inituvm+0x5c>
    panic("inituvm: more than a page");
  mem = kalloc();
80105fff:	e8 b7 c0 ff ff       	call   801020bb <kalloc>
80106004:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
80106006:	83 ec 04             	sub    $0x4,%esp
80106009:	68 00 10 00 00       	push   $0x1000
8010600e:	6a 00                	push   $0x0
80106010:	50                   	push   %eax
80106011:	e8 da dc ff ff       	call   80103cf0 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80106016:	83 c4 08             	add    $0x8,%esp
80106019:	6a 06                	push   $0x6
8010601b:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106021:	50                   	push   %eax
80106022:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106027:	ba 00 00 00 00       	mov    $0x0,%edx
8010602c:	8b 45 08             	mov    0x8(%ebp),%eax
8010602f:	e8 cf fc ff ff       	call   80105d03 <mappages>
  memmove(mem, init, sz);
80106034:	83 c4 0c             	add    $0xc,%esp
80106037:	56                   	push   %esi
80106038:	ff 75 0c             	pushl  0xc(%ebp)
8010603b:	53                   	push   %ebx
8010603c:	e8 2a dd ff ff       	call   80103d6b <memmove>
}
80106041:	83 c4 10             	add    $0x10,%esp
80106044:	8d 65 f8             	lea    -0x8(%ebp),%esp
80106047:	5b                   	pop    %ebx
80106048:	5e                   	pop    %esi
80106049:	5d                   	pop    %ebp
8010604a:	c3                   	ret    
...
8010604e:	68 51 6e 10 80       	push   $0x80106e51
80106053:	e8 f0 a2 ff ff       	call   80100348 <panic>
...
80106061:	8b 7d 18             	mov    0x18(%ebp),%edi
  uint i, pa, n;
  pte_t *pte;

  if((uint) addr % PGSIZE != 0)
80106064:	f7 45 0c ff 0f 00 00 	testl  $0xfff,0xc(%ebp)
8010606b:	75 07                	jne    80106074 <loaduvm+0x1c>
    panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
8010606d:	bb 00 00 00 00       	mov    $0x0,%ebx
80106072:	eb 3c                	jmp    801060b0 <loaduvm+0x58>
    panic("loaduvm: addr must be page aligned");
80106074:	83 ec 0c             	sub    $0xc,%esp
80106077:	68 0c 6f 10 80       	push   $0x80106f0c
8010607c:	e8 c7 a2 ff ff       	call   80100348 <panic>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
      panic("loaduvm: address should exist");
80106081:	83 ec 0c             	sub    $0xc,%esp
80106084:	68 6b 6e 10 80       	push   $0x80106e6b
...
80106096:	03 55 14             	add    0x14(%ebp),%edx
80106099:	52                   	push   %edx
8010609a:	50                   	push   %eax
8010609b:	ff 75 10             	pushl  0x10(%ebp)
8010609e:	e8 d0 b6 ff ff       	call   80101773 <readi>
801060a3:	83 c4 10             	add    $0x10,%esp
801060a6:	39 f0                	cmp    %esi,%eax
801060a8:	75 47                	jne    801060f1 <loaduvm+0x99>
  for(i = 0; i < sz; i += PGSIZE){
801060aa:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801060b0:	39 fb                	cmp    %edi,%ebx
801060b2:	73 30                	jae    801060e4 <loaduvm+0x8c>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
801060b4:	89 da                	mov    %ebx,%edx
801060b6:	03 55 0c             	add    0xc(%ebp),%edx
801060b9:	b9 00 00 00 00       	mov    $0x0,%ecx
801060be:	8b 45 08             	mov    0x8(%ebp),%eax
801060c1:	e8 cd fb ff ff       	call   80105c93 <walkpgdir>
801060c6:	85 c0                	test   %eax,%eax
801060c8:	74 b7                	je     80106081 <loaduvm+0x29>
    pa = PTE_ADDR(*pte);
801060ca:	8b 00                	mov    (%eax),%eax
801060cc:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if(sz - i < PGSIZE)
801060d1:	89 fe                	mov    %edi,%esi
801060d3:	29 de                	sub    %ebx,%esi
801060d5:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
801060db:	76 b1                	jbe    8010608e <loaduvm+0x36>
      n = PGSIZE;
801060dd:	be 00 10 00 00       	mov    $0x1000,%esi
801060e2:	eb aa                	jmp    8010608e <loaduvm+0x36>
      return -1;
  }
  return 0;
801060e4:	b8 00 00 00 00       	mov    $0x0,%eax
}
801060e9:	8d 65 f4             	lea    -0xc(%ebp),%esp
801060ec:	5b                   	pop    %ebx
801060ed:	5e                   	pop    %esi
801060ee:	5f                   	pop    %edi
801060ef:	5d                   	pop    %ebp
...
801060f6:	eb f1                	jmp    801060e9 <loaduvm+0x91>
...
80106101:	8b 7d 0c             	mov    0xc(%ebp),%edi
  pte_t *pte;
  uint a, pa;

  if(newsz >= oldsz)
80106104:	39 7d 10             	cmp    %edi,0x10(%ebp)
80106107:	73 11                	jae    8010611a <deallocuvm+0x22>
    return oldsz;

  a = PGROUNDUP(newsz);
80106109:	8b 45 10             	mov    0x10(%ebp),%eax
8010610c:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
80106112:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a  < oldsz; a += PGSIZE){
80106118:	eb 19                	jmp    80106133 <deallocuvm+0x3b>
    return oldsz;
8010611a:	89 f8                	mov    %edi,%eax
8010611c:	eb 64                	jmp    80106182 <deallocuvm+0x8a>
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
8010611e:	c1 eb 16             	shr    $0x16,%ebx
80106121:	83 c3 01             	add    $0x1,%ebx
80106124:	c1 e3 16             	shl    $0x16,%ebx
80106127:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
  for(; a  < oldsz; a += PGSIZE){
8010612d:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106133:	39 fb                	cmp    %edi,%ebx
80106135:	73 48                	jae    8010617f <deallocuvm+0x87>
    pte = walkpgdir(pgdir, (char*)a, 0);
80106137:	b9 00 00 00 00       	mov    $0x0,%ecx
8010613c:	89 da                	mov    %ebx,%edx
8010613e:	8b 45 08             	mov    0x8(%ebp),%eax
80106141:	e8 4d fb ff ff       	call   80105c93 <walkpgdir>
80106146:	89 c6                	mov    %eax,%esi
    if(!pte)
80106148:	85 c0                	test   %eax,%eax
8010614a:	74 d2                	je     8010611e <deallocuvm+0x26>
    else if((*pte & PTE_P) != 0){
8010614c:	8b 00                	mov    (%eax),%eax
8010614e:	a8 01                	test   $0x1,%al
80106150:	74 db                	je     8010612d <deallocuvm+0x35>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
80106152:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106157:	74 19                	je     80106172 <deallocuvm+0x7a>
        panic("kfree");
      char *v = P2V(pa);
...
80106162:	e8 3d be ff ff       	call   80101fa4 <kfree>
      *pte = 0;
80106167:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
8010616d:	83 c4 10             	add    $0x10,%esp
80106170:	eb bb                	jmp    8010612d <deallocuvm+0x35>
        panic("kfree");
80106172:	83 ec 0c             	sub    $0xc,%esp
80106175:	68 a6 67 10 80       	push   $0x801067a6
8010617a:	e8 c9 a1 ff ff       	call   80100348 <panic>
    }
  }
  return newsz;
8010617f:	8b 45 10             	mov    0x10(%ebp),%eax
}
...
8010618f:	53                   	push   %ebx
80106190:	83 ec 1c             	sub    $0x1c,%esp
80106193:	8b 7d 10             	mov    0x10(%ebp),%edi
  if(newsz >= KERNBASE)
80106196:	89 7d e4             	mov    %edi,-0x1c(%ebp)
80106199:	85 ff                	test   %edi,%edi
8010619b:	0f 88 c1 00 00 00    	js     80106262 <allocuvm+0xd8>
  if(newsz < oldsz)
801061a1:	3b 7d 0c             	cmp    0xc(%ebp),%edi
801061a4:	72 5c                	jb     80106202 <allocuvm+0x78>
  a = PGROUNDUP(oldsz);
801061a6:	8b 45 0c             	mov    0xc(%ebp),%eax
801061a9:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
801061af:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a < newsz; a += PGSIZE){
801061b5:	39 fb                	cmp    %edi,%ebx
801061b7:	0f 83 ac 00 00 00    	jae    80106269 <allocuvm+0xdf>
    mem = kalloc();
801061bd:	e8 f9 be ff ff       	call   801020bb <kalloc>
801061c2:	89 c6                	mov    %eax,%esi
    if(mem == 0){
801061c4:	85 c0                	test   %eax,%eax
801061c6:	74 42                	je     8010620a <allocuvm+0x80>
    memset(mem, 0, PGSIZE);
801061c8:	83 ec 04             	sub    $0x4,%esp
801061cb:	68 00 10 00 00       	push   $0x1000
801061d0:	6a 00                	push   $0x0
801061d2:	50                   	push   %eax
801061d3:	e8 18 db ff ff       	call   80103cf0 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
801061d8:	83 c4 08             	add    $0x8,%esp
801061db:	6a 06                	push   $0x6
801061dd:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
801061e3:	50                   	push   %eax
801061e4:	b9 00 10 00 00       	mov    $0x1000,%ecx
801061e9:	89 da                	mov    %ebx,%edx
801061eb:	8b 45 08             	mov    0x8(%ebp),%eax
801061ee:	e8 10 fb ff ff       	call   80105d03 <mappages>
801061f3:	83 c4 10             	add    $0x10,%esp
801061f6:	85 c0                	test   %eax,%eax
801061f8:	78 38                	js     80106232 <allocuvm+0xa8>
  for(; a < newsz; a += PGSIZE){
801061fa:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106200:	eb b3                	jmp    801061b5 <allocuvm+0x2b>
    return oldsz;
80106202:	8b 45 0c             	mov    0xc(%ebp),%eax
80106205:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106208:	eb 5f                	jmp    80106269 <allocuvm+0xdf>
      cprintf("allocuvm out of memory\n");
8010620a:	83 ec 0c             	sub    $0xc,%esp
8010620d:	68 89 6e 10 80       	push   $0x80106e89
80106212:	e8 f4 a3 ff ff       	call   8010060b <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
80106217:	83 c4 0c             	add    $0xc,%esp
8010621a:	ff 75 0c             	pushl  0xc(%ebp)
8010621d:	57                   	push   %edi
8010621e:	ff 75 08             	pushl  0x8(%ebp)
80106221:	e8 d2 fe ff ff       	call   801060f8 <deallocuvm>
      return 0;
80106226:	83 c4 10             	add    $0x10,%esp
80106229:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
80106230:	eb 37                	jmp    80106269 <allocuvm+0xdf>
      cprintf("allocuvm out of memory (2)\n");
80106232:	83 ec 0c             	sub    $0xc,%esp
80106235:	68 a1 6e 10 80       	push   $0x80106ea1
8010623a:	e8 cc a3 ff ff       	call   8010060b <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
8010623f:	83 c4 0c             	add    $0xc,%esp
80106242:	ff 75 0c             	pushl  0xc(%ebp)
80106245:	57                   	push   %edi
80106246:	ff 75 08             	pushl  0x8(%ebp)
80106249:	e8 aa fe ff ff       	call   801060f8 <deallocuvm>
      kfree(mem);
8010624e:	89 34 24             	mov    %esi,(%esp)
80106251:	e8 4e bd ff ff       	call   80101fa4 <kfree>
      return 0;
80106256:	83 c4 10             	add    $0x10,%esp
80106259:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
80106260:	eb 07                	jmp    80106269 <allocuvm+0xdf>
    return 0;
...
80106279:	8b 75 08             	mov    0x8(%ebp),%esi
  uint i;

  if(pgdir == 0)
8010627c:	85 f6                	test   %esi,%esi
8010627e:	74 1a                	je     8010629a <freevm+0x26>
    panic("freevm: no pgdir");
  deallocuvm(pgdir, KERNBASE, 0);
80106280:	83 ec 04             	sub    $0x4,%esp
80106283:	6a 00                	push   $0x0
80106285:	68 00 00 00 80       	push   $0x80000000
8010628a:	56                   	push   %esi
8010628b:	e8 68 fe ff ff       	call   801060f8 <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
80106290:	83 c4 10             	add    $0x10,%esp
80106293:	bb 00 00 00 00       	mov    $0x0,%ebx
80106298:	eb 10                	jmp    801062aa <freevm+0x36>
    panic("freevm: no pgdir");
8010629a:	83 ec 0c             	sub    $0xc,%esp
8010629d:	68 bd 6e 10 80       	push   $0x80106ebd
801062a2:	e8 a1 a0 ff ff       	call   80100348 <panic>
  for(i = 0; i < NPDENTRIES; i++){
801062a7:	83 c3 01             	add    $0x1,%ebx
801062aa:	81 fb ff 03 00 00    	cmp    $0x3ff,%ebx
801062b0:	77 1f                	ja     801062d1 <freevm+0x5d>
    if(pgdir[i] & PTE_P){
801062b2:	8b 04 9e             	mov    (%esi,%ebx,4),%eax
801062b5:	a8 01                	test   $0x1,%al
801062b7:	74 ee                	je     801062a7 <freevm+0x33>
      char * v = P2V(PTE_ADDR(pgdir[i]));
801062b9:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801062be:	05 00 00 00 80       	add    $0x80000000,%eax
      kfree(v);
801062c3:	83 ec 0c             	sub    $0xc,%esp
801062c6:	50                   	push   %eax
801062c7:	e8 d8 bc ff ff       	call   80101fa4 <kfree>
801062cc:	83 c4 10             	add    $0x10,%esp
801062cf:	eb d6                	jmp    801062a7 <freevm+0x33>
    }
  }
  kfree((char*)pgdir);
801062d1:	83 ec 0c             	sub    $0xc,%esp
801062d4:	56                   	push   %esi
801062d5:	e8 ca bc ff ff       	call   80101fa4 <kfree>
}
...
801062e9:	e8 cd bd ff ff       	call   801020bb <kalloc>
801062ee:	89 c6                	mov    %eax,%esi
801062f0:	85 c0                	test   %eax,%eax
801062f2:	74 55                	je     80106349 <setupkvm+0x65>
  memset(pgdir, 0, PGSIZE);
801062f4:	83 ec 04             	sub    $0x4,%esp
801062f7:	68 00 10 00 00       	push   $0x1000
801062fc:	6a 00                	push   $0x0
801062fe:	50                   	push   %eax
801062ff:	e8 ec d9 ff ff       	call   80103cf0 <memset>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80106304:	83 c4 10             	add    $0x10,%esp
80106307:	bb 20 94 10 80       	mov    $0x80109420,%ebx
8010630c:	81 fb 60 94 10 80    	cmp    $0x80109460,%ebx
80106312:	73 35                	jae    80106349 <setupkvm+0x65>
                (uint)k->phys_start, k->perm) < 0) {
80106314:	8b 43 04             	mov    0x4(%ebx),%eax
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
80106317:	8b 4b 08             	mov    0x8(%ebx),%ecx
8010631a:	29 c1                	sub    %eax,%ecx
8010631c:	83 ec 08             	sub    $0x8,%esp
8010631f:	ff 73 0c             	pushl  0xc(%ebx)
80106322:	50                   	push   %eax
80106323:	8b 13                	mov    (%ebx),%edx
80106325:	89 f0                	mov    %esi,%eax
80106327:	e8 d7 f9 ff ff       	call   80105d03 <mappages>
8010632c:	83 c4 10             	add    $0x10,%esp
8010632f:	85 c0                	test   %eax,%eax
80106331:	78 05                	js     80106338 <setupkvm+0x54>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80106333:	83 c3 10             	add    $0x10,%ebx
80106336:	eb d4                	jmp    8010630c <setupkvm+0x28>
      freevm(pgdir);
80106338:	83 ec 0c             	sub    $0xc,%esp
8010633b:	56                   	push   %esi
8010633c:	e8 33 ff ff ff       	call   80106274 <freevm>
      return 0;
80106341:	83 c4 10             	add    $0x10,%esp
80106344:	be 00 00 00 00       	mov    $0x0,%esi
}
80106349:	89 f0                	mov    %esi,%eax
8010634b:	8d 65 f8             	lea    -0x8(%ebp),%esp
8010634e:	5b                   	pop    %ebx
8010634f:	5e                   	pop    %esi
80106350:	5d                   	pop    %ebp
80106351:	c3                   	ret    
...
80106355:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80106358:	e8 87 ff ff ff       	call   801062e4 <setupkvm>
8010635d:	a3 a4 54 11 80       	mov    %eax,0x801154a4
  switchkvm();
80106362:	e8 5e fb ff ff       	call   80105ec5 <switchkvm>
}
80106367:	c9                   	leave  
80106368:	c3                   	ret    
...
8010637a:	e8 14 f9 ff ff       	call   80105c93 <walkpgdir>
  if(pte == 0)
8010637f:	85 c0                	test   %eax,%eax
80106381:	74 05                	je     80106388 <clearpteu+0x1f>
    panic("clearpteu");
  *pte &= ~PTE_U;
80106383:	83 20 fb             	andl   $0xfffffffb,(%eax)
}
80106386:	c9                   	leave  
80106387:	c3                   	ret    
    panic("clearpteu");
80106388:	83 ec 0c             	sub    $0xc,%esp
8010638b:	68 ce 6e 10 80       	push   $0x80106ece
...
8010639b:	83 ec 1c             	sub    $0x1c,%esp
  ...
  if((d = setupkvm()) == 0)
8010639e:	e8 41 ff ff ff       	call   801062e4 <setupkvm>
801063a3:	89 45 dc             	mov    %eax,-0x24(%ebp)
801063a6:	85 c0                	test   %eax,%eax
801063a8:	0f 84 c4 00 00 00    	je     80106472 <copyuvm+0xdd>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
801063ae:	bf 00 00 00 00       	mov    $0x0,%edi
801063b3:	3b 7d 0c             	cmp    0xc(%ebp),%edi
801063b6:	0f 83 b6 00 00 00    	jae    80106472 <copyuvm+0xdd>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
801063bc:	89 7d e4             	mov    %edi,-0x1c(%ebp)
801063bf:	b9 00 00 00 00       	mov    $0x0,%ecx
801063c4:	89 fa                	mov    %edi,%edx
801063c6:	8b 45 08             	mov    0x8(%ebp),%eax
801063c9:	e8 c5 f8 ff ff       	call   80105c93 <walkpgdir>
801063ce:	85 c0                	test   %eax,%eax
801063d0:	74 65                	je     80106437 <copyuvm+0xa2>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
801063d2:	8b 00                	mov    (%eax),%eax
801063d4:	a8 01                	test   $0x1,%al
801063d6:	74 6c                	je     80106444 <copyuvm+0xaf>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
801063d8:	89 c6                	mov    %eax,%esi
801063da:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    flags = PTE_FLAGS(*pte);
801063e0:	25 ff 0f 00 00       	and    $0xfff,%eax
801063e5:	89 45 e0             	mov    %eax,-0x20(%ebp)
    if((mem = kalloc()) == 0)
801063e8:	e8 ce bc ff ff       	call   801020bb <kalloc>
801063ed:	89 c3                	mov    %eax,%ebx
801063ef:	85 c0                	test   %eax,%eax
801063f1:	74 6a                	je     8010645d <copyuvm+0xc8>
      goto bad;
    memmove(mem, (char*)P2V(pa), PGSIZE);
801063f3:	81 c6 00 00 00 80    	add    $0x80000000,%esi
801063f9:	83 ec 04             	sub    $0x4,%esp
801063fc:	68 00 10 00 00       	push   $0x1000
80106401:	56                   	push   %esi
80106402:	50                   	push   %eax
80106403:	e8 63 d9 ff ff       	call   80103d6b <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
80106408:	83 c4 08             	add    $0x8,%esp
8010640b:	ff 75 e0             	pushl  -0x20(%ebp)
8010640e:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106414:	50                   	push   %eax
80106415:	b9 00 10 00 00       	mov    $0x1000,%ecx
8010641a:	8b 55 e4             	mov    -0x1c(%ebp),%edx
8010641d:	8b 45 dc             	mov    -0x24(%ebp),%eax
80106420:	e8 de f8 ff ff       	call   80105d03 <mappages>
80106425:	83 c4 10             	add    $0x10,%esp
80106428:	85 c0                	test   %eax,%eax
8010642a:	78 25                	js     80106451 <copyuvm+0xbc>
  for(i = 0; i < sz; i += PGSIZE){
8010642c:	81 c7 00 10 00 00    	add    $0x1000,%edi
80106432:	e9 7c ff ff ff       	jmp    801063b3 <copyuvm+0x1e>
      panic("copyuvm: pte should exist");
80106437:	83 ec 0c             	sub    $0xc,%esp
8010643a:	68 d8 6e 10 80       	push   $0x80106ed8
8010643f:	e8 04 9f ff ff       	call   80100348 <panic>
      panic("copyuvm: page not present");
80106444:	83 ec 0c             	sub    $0xc,%esp
80106447:	68 f2 6e 10 80       	push   $0x80106ef2
8010644c:	e8 f7 9e ff ff       	call   80100348 <panic>
      kfree(mem);
80106451:	83 ec 0c             	sub    $0xc,%esp
80106454:	53                   	push   %ebx
80106455:	e8 4a bb ff ff       	call   80101fa4 <kfree>
      goto bad;
...
80106460:	ff 75 dc             	pushl  -0x24(%ebp)
80106463:	e8 0c fe ff ff       	call   80106274 <freevm>
  return 0;
80106468:	83 c4 10             	add    $0x10,%esp
8010646b:	c7 45 dc 00 00 00 00 	movl   $0x0,-0x24(%ebp)
}
...
80106480:	83 ec 08             	sub    $0x8,%esp
  ...
  pte = walkpgdir(pgdir, uva, 0);
80106483:	b9 00 00 00 00       	mov    $0x0,%ecx
80106488:	8b 55 0c             	mov    0xc(%ebp),%edx
8010648b:	8b 45 08             	mov    0x8(%ebp),%eax
8010648e:	e8 00 f8 ff ff       	call   80105c93 <walkpgdir>
  if((*pte & PTE_P) == 0)
80106493:	8b 00                	mov    (%eax),%eax
80106495:	a8 01                	test   $0x1,%al
80106497:	74 10                	je     801064a9 <uva2ka+0x2c>
    return 0;
  if((*pte & PTE_U) == 0)
80106499:	a8 04                	test   $0x4,%al
8010649b:	74 13                	je     801064b0 <uva2ka+0x33>
    return 0;
  return (char*)P2V(PTE_ADDR(*pte));
8010649d:	25 00 f0 ff ff       	and    $0xfffff000,%eax
...
801064ae:	eb f7                	jmp    801064a7 <uva2ka+0x2a>
    return 0;
801064b0:	b8 00 00 00 00       	mov    $0x0,%eax
801064b5:	eb f0                	jmp    801064a7 <uva2ka+0x2a>
...
801064c0:	8b 7d 14             	mov    0x14(%ebp),%edi
  char *buf, *pa0;
  uint n, va0;

  buf = (char*)p;
  while(len > 0){
801064c3:	eb 25                	jmp    801064ea <copyout+0x33>
    if(pa0 == 0)
      return -1;
    n = PGSIZE - (va - va0);
    if(n > len)
...
801064c5:	8b 55 0c             	mov    0xc(%ebp),%edx
801064c8:	29 f2                	sub    %esi,%edx
801064ca:	01 d0                	add    %edx,%eax
801064cc:	83 ec 04             	sub    $0x4,%esp
801064cf:	53                   	push   %ebx
801064d0:	ff 75 10             	pushl  0x10(%ebp)
801064d3:	50                   	push   %eax
801064d4:	e8 92 d8 ff ff       	call   80103d6b <memmove>
    len -= n;
801064d9:	29 df                	sub    %ebx,%edi
    buf += n;
801064db:	01 5d 10             	add    %ebx,0x10(%ebp)
    va = va0 + PGSIZE;
801064de:	8d 86 00 10 00 00    	lea    0x1000(%esi),%eax
801064e4:	89 45 0c             	mov    %eax,0xc(%ebp)
801064e7:	83 c4 10             	add    $0x10,%esp
  while(len > 0){
801064ea:	85 ff                	test   %edi,%edi
801064ec:	74 2f                	je     8010651d <copyout+0x66>
    va0 = (uint)PGROUNDDOWN(va);
801064ee:	8b 75 0c             	mov    0xc(%ebp),%esi
801064f1:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    pa0 = uva2ka(pgdir, (char*)va0);
801064f7:	83 ec 08             	sub    $0x8,%esp
801064fa:	56                   	push   %esi
801064fb:	ff 75 08             	pushl  0x8(%ebp)
801064fe:	e8 7a ff ff ff       	call   8010647d <uva2ka>
    if(pa0 == 0)
80106503:	83 c4 10             	add    $0x10,%esp
80106506:	85 c0                	test   %eax,%eax
80106508:	74 20                	je     8010652a <copyout+0x73>
    n = PGSIZE - (va - va0);
8010650a:	89 f3                	mov    %esi,%ebx
8010650c:	2b 5d 0c             	sub    0xc(%ebp),%ebx
8010650f:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    if(n > len)
80106515:	39 df                	cmp    %ebx,%edi
80106517:	73 ac                	jae    801064c5 <copyout+0xe>
      n = len;
80106519:	89 fb                	mov    %edi,%ebx
8010651b:	eb a8                	jmp    801064c5 <copyout+0xe>
  }
  return 0;
...
8010652f:	eb f1                	jmp    80106522 <copyout+0x6b>
